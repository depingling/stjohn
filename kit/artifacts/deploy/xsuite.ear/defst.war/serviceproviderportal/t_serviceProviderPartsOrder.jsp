            ...
            <tr>
                ...
                <table id="t1" width="100%" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td width="50%" align="right">
                            <span class="shopassetdetailtxt">
                                <b><app:storeMessage key="shop.orderStatus.text.total:"/>&nbsp;</b>
                            </span>
                        </td>
                        <td width="50%" align="left">
                ...
                <table id="t2" width="100%" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="50%" align="left">
                            ...
                            <br>
                            <bean:write name="theOrder" property="shipStateProvinceCd"/>
                            <%} %>
                            <br>
                            <bean:write name="theOrder" property="shipPostalCode"/>
                            <br>
                            <bean:write name="theOrder" property="shipCountryCd"/>
                        </td>
                    </tr>
                    </logic:notEqual>
                </table>
                ...
                <table id="t3" width="100%" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="50%" align="left">
                            ...
                            <% if (appUser.getUserStore().isStateProvinceRequired()) { %>
                            <br>
                            <bean:write name="theOrder" property="billStateProvinceCd"/>
                            <%} %>
                            <br>
                            <bean:write name="theOrder" property="billPostalCode"/>
                            <br>
                            <bean:write name="theOrder" property="billCountryCd"/>
                        </td>
                    </tr>
                    </logic:notEqual>
                </table>
