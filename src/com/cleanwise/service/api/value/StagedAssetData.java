...
/**
 * Title:        StagedAssetData
 * Description:  This is a ValueObject class wrapping the database table CLW_STAGED_ASSET.
 * Purpose:
...
/**
 * <code>StagedAssetData</code> is a ValueObject class wrapping of the database table CLW_STAGED_ASSET.
 */
public class StagedAssetData extends ValueObject implements Cloneable, TableObject
{
    ...
    private String mAssetName;// SQL type:VARCHAR2
    ...
    private int mMatchedAssetId;// SQL type:NUMBER

    /**
     * Constructor.
     */
    public StagedAssetData ()
    {
        mAction = "";
        mAsset = "";
        mStoreName = "";
    ...
    public StagedAssetData(int parm1, int parm2, String parm3, String parm4, int parm5, String parm6, String parm7, String parm8, String parm9, String parm10, String parm11, String parm12, String parm13, String parm14, String parm15, String parm16, String parm17, String parm18, String parm19, String parm20, String parm21, String parm22, String parm23, String parm24, int parm25, String parm26, int parm27, int parm28, String parm29, String parm30, String parm31, byte[] parm32, String parm33, byte[] parm34, String parm35, byte[] parm36, String parm37, String parm38, String parm39, byte[] parm40, String parm41, byte[] parm42, String parm43, byte[] parm44, int parm45)
    {
        ...
        mMatchedAssetId = parm45;

    }

    /**
     * Creates a new StagedAssetData
     *
     * @return
     *  Newly initialized StagedAssetData object.
     */
    public static StagedAssetData createValue ()
    {
        StagedAssetData valueData = new StagedAssetData();
    ...
    public Element toXml(Document doc) {
        Element root =  doc.createElement("StagedAsset");
        
        Element node;

        root.setAttribute("Id", String.valueOf(mStagedAssetId));
    ...
    /**
    * creates a clone of this object, the StagedAssetId field is not cloned.
    *
    * @return StagedAssetData object
    */
    public Object clone(){
        StagedAssetData myClone = new StagedAssetData();
        ...
        myClone.mMatchedAssetId = mMatchedAssetId;
    ...
    public Object getFieldValue(String pFieldName) {
        ...
        if (StagedAssetDataAccess.STAGED_ASSET_ID.equals(pFieldName)) {
            return getStagedAssetId();
        } else if (StagedAssetDataAccess.VERSION_NUMBER.equals(pFieldName)) {
            return getVersionNumber();
        } else if (StagedAssetDataAccess.ACTION.equals(pFieldName)) {
            return getAction();
        } else if (StagedAssetDataAccess.ASSET.equals(pFieldName)) {
            return getAsset();
        } else if (StagedAssetDataAccess.STORE_ID.equals(pFieldName)) {
            return getStoreId();
        } else if (StagedAssetDataAccess.STORE_NAME.equals(pFieldName)) {
            return getStoreName();
        } else if (StagedAssetDataAccess.DIST_SKU.equals(pFieldName)) {
            return getDistSku();
        } else if (StagedAssetDataAccess.MFG_SKU.equals(pFieldName)) {
            return getMfgSku();
        } else if (StagedAssetDataAccess.MANUFACTURER.equals(pFieldName)) {
            return getManufacturer();
        } else if (StagedAssetDataAccess.DISTRIBUTOR.equals(pFieldName)) {
            return getDistributor();
        } else if (StagedAssetDataAccess.PACK.equals(pFieldName)) {
            return getPack();
        } else if (StagedAssetDataAccess.UOM.equals(pFieldName)) {
            return getUom();
        } else if (StagedAssetDataAccess.CATEGORY_NAME.equals(pFieldName)) {
            return getCategoryName();
        } else if (StagedAssetDataAccess.SUB_CAT_1.equals(pFieldName)) {
            return getSubCat1();
        } else if (StagedAssetDataAccess.SUB_CAT_2.equals(pFieldName)) {
            return getSubCat2();
        } else if (StagedAssetDataAccess.SUB_CAT_3.equals(pFieldName)) {
            return getSubCat3();
        } else if (StagedAssetDataAccess.MULTI_PRODUCT_NAME.equals(pFieldName)) {
            return getMultiProductName();
        } else if (StagedAssetDataAccess.ITEM_SIZE.equals(pFieldName)) {
            return getItemSize();
        } else if (StagedAssetDataAccess.LONG_DESCRIPTION.equals(pFieldName)) {
            return getLongDescription();
        } else if (StagedAssetDataAccess.SHORT_DESCRIPTION.equals(pFieldName)) {
            return getShortDescription();
        } else if (StagedAssetDataAccess.PRODUCT_UPC.equals(pFieldName)) {
            return getProductUpc();
        } else if (StagedAssetDataAccess.PACK_UPC.equals(pFieldName)) {
            return getPackUpc();
        } else if (StagedAssetDataAccess.UNSPSC_CODE.equals(pFieldName)) {
            return getUnspscCode();
        } else if (StagedAssetDataAccess.COLOR.equals(pFieldName)) {
            return getColor();
        } else if (StagedAssetDataAccess.SHIPPING_WEIGHT.equals(pFieldName)) {
            return getShippingWeight();
        } else if (StagedAssetDataAccess.WEIGHT_UNIT.equals(pFieldName)) {
            return getWeightUnit();
        } else if (StagedAssetDataAccess.NSN.equals(pFieldName)) {
            return getNsn();
        } else if (StagedAssetDataAccess.SHIPPING_CUBIC_SIZE.equals(pFieldName)) {
            return getShippingCubicSize();
        } else if (StagedAssetDataAccess.HAZMAT.equals(pFieldName)) {
            return getHazmat();
        } else if (StagedAssetDataAccess.CERTIFIED_COMPANIES.equals(pFieldName)) {
            return getCertifiedCompanies();
        } else if (StagedAssetDataAccess.IMAGE.equals(pFieldName)) {
            return getImage();
        } else if (StagedAssetDataAccess.IMAGE_BLOB.equals(pFieldName)) {
            return getImageBlob();
        } else if (StagedAssetDataAccess.MSDS.equals(pFieldName)) {
            return getMsds();
        } else if (StagedAssetDataAccess.MSDS_BLOB.equals(pFieldName)) {
            return getMsdsBlob();
        } else if (StagedAssetDataAccess.SPECIFICATION.equals(pFieldName)) {
            return getSpecification();
        } else if (StagedAssetDataAccess.SPECIFICATION_BLOB.equals(pFieldName)) {
            return getSpecificationBlob();
        } else if (StagedAssetDataAccess.ASSET_NAME.equals(pFieldName)) {
            return getAssetName();
        } else if (StagedAssetDataAccess.MODEL_NUMBER.equals(pFieldName)) {
            return getModelNumber();
        } else if (StagedAssetDataAccess.ASSOC_DOC_1.equals(pFieldName)) {
            return getAssocDoc1();
        } else if (StagedAssetDataAccess.ASSOC_DOC_1_BLOB.equals(pFieldName)) {
            return getAssocDoc1Blob();
        } else if (StagedAssetDataAccess.ASSOC_DOC_2.equals(pFieldName)) {
            return getAssocDoc2();
        } else if (StagedAssetDataAccess.ASSOC_DOC_2_BLOB.equals(pFieldName)) {
            return getAssocDoc2Blob();
        } else if (StagedAssetDataAccess.ASSOC_DOC_3.equals(pFieldName)) {
            return getAssocDoc3();
        } else if (StagedAssetDataAccess.ASSOC_DOC_3_BLOB.equals(pFieldName)) {
            return getAssocDoc3Blob();
        } else if (StagedAssetDataAccess.MATCHED_ASSET_ID.equals(pFieldName)) {
            return getMatchedAssetId();
        } else {
            return null;
        }
    ...
    */
    public String getTable() {
        return StagedAssetDataAccess.CLW_STAGED_ASSET;
    }
     ...
     *
     * @return
     *  int containing the ShippingWeight field.
     */
    ...
    /**
     * Retrieves the AssetName field.
     *
     * @return
     *  String containing the AssetName field.
     */
    ...
    /**
     * Retrieves the MatchedAssetId field.
     *
     * @return
     *  int containing the MatchedAssetId field.
     */
