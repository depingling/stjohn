 ...
 */
abstract class Inbound850Super extends InboundEdiSuper {
  ...
  throws OBOEException
{
    ...
    public OrderRequestData extractN1(Loop inLoop)  throws OBOEException {
        ...
        try {
            ...
            for (int i = 0; i <  numberOfLoopsInVector; i++) {
                ...
                if (de != null){
                  if (de.get().equals("Y ") || de.get().equals("YS")){
  ...
  public void processTransaction() throws Exception {
    for (int i = 0; i < mOrders.size(); i++){
      ...
      getTransactionD().setKeyString("CustomerPoNumber: " + orderD.getCustomerPoNumber());
    }

    ediHandler.appendIntegrationRequests(mOrders);
  }
  //************************Constructor******************************
