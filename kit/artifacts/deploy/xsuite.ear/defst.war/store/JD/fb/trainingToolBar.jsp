...
<jsp:include flush="true" page="<%=t_templatorToolBar%>" >
    ...
    <jsp:param name="display01" value="customTechTips"/>
    <jsp:param name="toolLable01" value="template.jd.fb.menu.techtips"/>
    ...
    <jsp:param name="toolLable02" value="template.jd.fb.menu.cti"/>
    <jsp:param name="toolSecondaryToolBar02" value=""/>

    <jsp:param name="toolLink03" value="<%=toolLink02%>"/>
    <jsp:param name="tabs03" value="trainingToolBar"/>
    <jsp:param name="display03" value="customLms"/>
    <jsp:param name="toolLable03" value="template.jd.fb.menu.lms"/>
