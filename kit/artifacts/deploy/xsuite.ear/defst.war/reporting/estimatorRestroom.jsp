...
int restroomProcessStep = theForm.getRestroomProcessStep();
boolean errorFl = (ae!=null && ae.size()>0)? true:false;
%>
<% if(restroomProcessStep==1) { %>
<tr><td><%@ include file="estimatorProfileRestroomInfo.jsp" %></td></tr>
<tr><td><%@ include file="estimatorRestroomProdInfo.jsp" %></td></tr>
<tr><td><%@ include file="estimatorRestroomAssampInput.jsp" %></td></tr>
<% } else if(restroomProcessStep==2) { %>
<tr><td><%@ include file="estimatorProfileRestroomInfo.jsp" %></td></tr>
<tr><td><%@ include file="estimatorRestroomProdSelect.jsp" %></td></tr>
<tr><td><%@ include file="estimatorRestroomAssampInfo.jsp" %></td></tr>
<% } else if(restroomProcessStep==3) { %>
<tr><td><%@ include file="estimatorProfileRestroomInfo.jsp" %></td></tr>
<tr><td><%@ include file="estimatorRestroomProdInfo.jsp" %></td></tr>
<tr><td><%@ include file="estimatorRestroomProdResult.jsp" %></td></tr>
<tr><td><%@ include file="estimatorRestroomAssampInfo.jsp" %></td></tr>
<% } %>
