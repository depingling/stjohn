...
%>
  ...
  <div id="sitesConfig">
  <html:form styleId="1454" name="CORPORATE_SCHEDULE_FORM"  action="<%=f1sub%>" scope="session" 
  type="com.cleanwise.view.forms.CorporateScheduleMgrForm">


  <table ID=1455 width="769"  class="results">
  <tr><td colspan=2>Search for sites belonging to the accounts configured for this schedule.</td>
</td>
      <tr> <td align="right"><b>Site Name</b></td>
        <td>
          <html:text name="CORPORATE_SCHEDULE_FORM" property="confSearchField" 
          onfocus="javascript:f_check_search();" />
          <html:radio name="CORPORATE_SCHEDULE_FORM" property="confSearchType" 
          value="id" />  ID
          <html:radio name="CORPORATE_SCHEDULE_FORM" property="confSearchType" 
	  ...
	  <tr> <td align="right"><b>Reference Number</b></td>
        <td>
          <html:text name="CORPORATE_SCHEDULE_FORM" property="searchRefNum" 
          onfocus="javascript:f_check_search();" />
          <html:radio name="CORPORATE_SCHEDULE_FORM" property="searchRefNumType" 
      ...
      <tr> 
        ...
        <td><html:text name="CORPORATE_SCHEDULE_FORM" property="confCity"/> </td>
      </tr>

      <tr> 
        <td align="right"><b>State</b></td>
        <td><html:text name="CORPORATE_SCHEDULE_FORM" property="confState"/> </td>
      </tr>
      ...
      <tr> <td>&nbsp;</td>
        <td>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Configured Only:
          <html:checkbox name = 'CORPORATE_SCHEDULE_FORM' property='conifiguredOnlyFl' value='true'/>
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Show Inactive:
          <html:checkbox name = 'CORPORATE_SCHEDULE_FORM' property='confShowInactiveFl' value='true'/>
        </td>
      </tr>
  
    </table>

      <logic:present name="schedule.site.vector">
      <bean:size id="rescount"  name="schedule.site.vector"/>
      ...
      <logic:iterate id="arrele" name="schedule.site.vector" 
        ...
        <tr>
          ...
          <td>
            <html:multibox name="CORPORATE_SCHEDULE_FORM" property="confSelectIds" 
            value="<%=eleid%>" />
          </td>
	  
          <html:hidden name="CORPORATE_SCHEDULE_FORM" property="confDisplayIds" 
          value="<%=eleid%>" />
        </tr>
