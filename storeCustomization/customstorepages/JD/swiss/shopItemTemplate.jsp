    ...
    <table border="0" cellpadding="0" cellspacing="0">
      ...
      <td class="customerltbkground" align="center" valign="top">
       ...
       <td class="text"><div class="itemheadmargin">
        ...
        <%=StringUtils.escapeHtml(item.getProduct().getLongDesc())%>  
       ...
       %>
             <% String documentTypeMsdsLinkFromDb = "/store/shop.do?action=itemDocumentFromDb&path=" + msds; %>                              
		                                           <html:link action="<%=documentTypeMsdsLinkFromDb %>" target="_blank" styleClass="linkButton"><img border="0" src="<%=IMGPath%>/b_document.gif"/>
       ...
       %>
               <% String documentTypeDedLinkFromDb = "/store/shop.do?action=itemDocumentFromDb&path=" + ded; %>
		                                           <html:link action="<%=documentTypeDedLinkFromDb %>" target="_blank" styleClass="linkButton"><img border="0" src="<%=IMGPath%>/b_document.gif"/>
       ...
       %>
                <% String documentTypeSpecLinkFromDb = "/store/shop.do?action=itemDocumentFromDb&path=" + spec; %>
    	 		                                           <html:link action="<%=documentTypeSpecLinkFromDb %>" target="_blank" styleClass="linkButton"><img border="0" src="<%=IMGPath%>/b_document.gif"/>
