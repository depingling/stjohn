...
function viewExcelFormat() {
  var loc = "printerFriendlyOrderGuide.do?action=excelPrint&showMfg=n&showMfgSku=n";
  if ( document.Personalized.elements[0].checked == true ||
       document.Personalized.elements[0].value == "showInfo" ) {
     loc = "printerFriendlyOrderGuidePersonalized.do?action=excelPrintPers&showMfg=n&showMfgSku=n";
  }
