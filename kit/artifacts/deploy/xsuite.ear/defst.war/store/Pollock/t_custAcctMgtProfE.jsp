...
<% // STJ-6294: commenting the following line out, because it results in the display of duplicate errors. 
   // This is because there is an <html:errors> tag in cwTemplate.jsp, and this file is included in that template.
...
<td><bean:write name="USER_DETAIL_FORM" property="detail.emailData.emailAddress"/> 
</td></tr>
