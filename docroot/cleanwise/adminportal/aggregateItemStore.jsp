...
<html:hidden name="ITEM_AGGREGATE_MGR_FORM" property="wizardStep" value="storeselect"/>

<tr><td class="largeheader">Find Store:</td>
       <td colspan="3">
                        <html:text name="ITEM_AGGREGATE_MGR_FORM" property="storeSearchField"/>
       </td>
  </tr>
  <tr> <td>&nbsp;</td>
       <td colspan="3">
         <html:radio name="ITEM_AGGREGATE_MGR_FORM" property="storeSearchType" value="id" />
         ID
         <html:radio name="ITEM_AGGREGATE_MGR_FORM" property="storeSearchType" value="nameBegins" />
         Name(starts with)
         <html:radio name="ITEM_AGGREGATE_MGR_FORM" property="storeSearchType" value="nameContains" />
         Name(contains)
         </td>
  </tr>
  <!-- Group Search -->
  <tr><td><b>Group:</b></td>
       <td colspan="3">
       <html:text name="ITEM_AGGREGATE_MGR_FORM" property="storeSearchGroupId" size="20"/>
       <html:button property="locateGroup" onclick="popLocateFeedGlobal('../adminportal/grouplocate', 'storeSearchGroupId', '');" value="Locate Group"/>
       </td>
  </tr>
  <tr> <td>&nbsp;</td>
       <td colspan="3">
...
<logic:present name="ITEM_AGGREGATE_MGR_FORM" property="stores">
<bean:size id="rescount"  name="ITEM_AGGREGATE_MGR_FORM" property="stores.values"/>
...
<thead>
<tr align=left>
<th><a href="#pgsort" class="tableheader" onclick="this.blur(); return f_sortTable('resTblBdy', 0, false);">Store&nbsp;Id</a></th>
...
<a class="tableheader" href="javascript:SetCheckedGlobal(1,'stores.selected')">[Check&nbsp;All]</a>
<br>
<a class="tableheader" href="javascript:SetCheckedGlobal(0,'stores.selected')">[&nbsp;Clear]</a>
</th>
</tr>
</thead>

<tbody id="resTblBdy">
<logic:iterate id="arrele" name="ITEM_AGGREGATE_MGR_FORM" property="stores.values" indexId="i">
   <tr>
