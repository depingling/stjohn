...
String
 ...
 showSelectCol = "false", //request.getParameter("showSelectCol"),
...
<% if (editCartItems) { %>
  <td class="shopcharthead"><div class="fivemargin">Remove</div></td>
<% } else if (
  inventoryShopping && !quickOrderView && f_showSelectCol ) {  %>
  <td class="shopcharthead"><div class="fivemargin">
<a class=shopchartheadlink href="javascript:f_SetChecked(1,'orderSelectBox')"><app:storeMessage key="shoppingItems.text.checkAll"/></a><br/>
<a class=shopchartheadlink href="javascript:f_SetChecked(0,'orderSelectBox')"><app:storeMessage key="shoppingItems.text.clear"/></a>
</td>
<% }else{ %>
  <td class="shopcharthead">&nbsp;</td>
<% } %>

<% if(false && resaleItemsAllowed && !editCartItems && !quickOrderView) { %>
  <td class="shopcharthead"><div class="fivemargin">
        <font color="red"><app:storeMessage key="shoppingItems.text.reSaleItem"/></font>
    <%if(!resaleItemsAllowedViewOnly){%>
    <br>
        <a class=shopchartheadlink href="javascript:f_SetChecked(1,'reSaleSelectBox')"><app:storeMessage key="shoppingItems.text.checkAll"/></a>
        <a class=shopchartheadlink href="javascript:f_SetChecked(0,'reSaleSelectBox')"><app:storeMessage key="shoppingItems.text.clear"/></a>
    <%}%>
  </div></td>
<% } %>
