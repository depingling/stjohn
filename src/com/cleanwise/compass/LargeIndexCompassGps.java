 ...
 * @author kimchy
 */
public class LargeIndexCompassGps extends AbstractCompassGps {
    ...
    public LargeIndexCompassGps() {

    }

    public LargeIndexCompassGps(Compass compass) {
    ...
    protected void doIndex() throws CompassGpsException {
        ...
        indexCompass.getSearchEngineIndexManager().replaceIndex(compass.getSearchEngineIndexManager(),
