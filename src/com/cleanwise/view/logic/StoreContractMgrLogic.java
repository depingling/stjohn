...
import com.cleanwise.view.forms.StoreContractMgrDetailForm;
import com.cleanwise.view.forms.StoreContractMgrSearchForm;
 ...
 *
 */
public class StoreContractMgrLogic {
    private static final Logger log = Logger.getLogger(StoreContractMgrLogic.class);
    ...
    public static void search(HttpServletRequest request, ActionForm form)
        ...
        StoreContractMgrSearchForm sForm = (StoreContractMgrSearchForm)form;
        ...
        if (null != searchType && "id".equals(searchType) &&
            ...
            if (null != contractData) {
                ...
                null != searchField && !"".equals(searchField)) {
            contracts = contractEjb.getContractDescByName(searchField,
    ...
    public static void sort(HttpServletRequest request, ActionForm form)
        ...
        try {
            ...
            log.info("<================= StoreContractMgrLogic exception : " + e+ "================>" );
        }
    ...
    public static void sortItems(HttpServletRequest request, ActionForm form)
        ...
        HttpSession session = request.getSession();
        StoreContractMgrDetailForm sForm = (StoreContractMgrDetailForm)session.getAttribute(
                "STORE_CONTRACT_DETAIL_FORM");
    ...
    public static void sortCatalogItems(HttpServletRequest request,
        ...
        request.setAttribute("STORE_CONTRACT_DETAIL_FORM", sForm);
    }
    ...
    public static void addContract(HttpServletRequest request, ActionForm form)
        ...
        StoreContractMgrDetailForm contract = (StoreContractMgrDetailForm)form;
        contract = new StoreContractMgrDetailForm();

        HttpSession session = request.getSession();
        session.setAttribute("STORE_CONTRACT_DETAIL_FORM", contract);
    ...
    public static void editContract(HttpServletRequest request,
        ...
        ContractData detail = contractEjb.getContract(Integer.parseInt(
                contractId));
        StoreContractMgrDetailForm detailForm = (StoreContractMgrDetailForm)form;
    ...
    //----------------------------------------------------------------
    private static void loadContractItems (StoreContractMgrDetailForm detailForm,
    ...
    public static ActionErrors updateItems(HttpServletRequest request,
        ...
        StoreContractMgrDetailForm pForm = (StoreContractMgrDetailForm)form;
        HttpSession session = request.getSession();
    ...
    public static ActionErrors removeItems(HttpServletRequest request,
        ...
        ActionErrors lErrors = new ActionErrors();
        HttpSession session = request.getSession();
        StoreContractMgrDetailForm sForm = (StoreContractMgrDetailForm)form;
        ContractData fcd = null;

        if (sForm == null) {
            sForm = (StoreContractMgrDetailForm)session.getAttribute(
                    "STORE_CONTRACT_DETAIL_FORM");
        }
