...
<tr>
<td class="genericerror" align="center" colspan="3"><html:errors/></td>
</tr>
<% } %>
<tr>
...
<% } %>
  ...
  ><img src='<%=b_save%>' border="0"/><app:storeMessage key="global.action.label.save"/></a>
    ...
    <tr>
    <td colspan="10"  class="tableoutline"><img src="<%=cw_spacer%>" HEIGHT="3"></td>
    </tr>
    <tr>
    <td class="shopcharthead" align="center"><app:storeMessage key="shop.og.table.header.maxOrderQty"/></td>
    ...
    <logic:iterate id="item" name="EDIT_ORDER_GUIDE_FORM" property="items"
       ...
       <tr bgcolor="<%=ClwCustomizer.getEvenRowColor(session,(Integer)kkk)%>">
         <td class="text" width=10 align="center">
...
<td>
  ...
  ><img src='<%=b_save%>' border="0"/><app:storeMessage key="global.action.label.save"/></a>
     ...
     <td class="text" align="rigth"><div class="fivemargin">
        <b><app:storeMessage key="shoppingItems.text.total:"/><b>
     </div></td>
...
<table class="tbstd" align="center" cellspacing=0>
  ...
  <tr>
  <td class="shopcharthead" align="center" colspan=10>
  <app:storeMessage key="shop.editOg.text.shoppingCartItems"/></td></tr>
   ...
   <logic:iterate id="item" name="EDIT_ORDER_GUIDE_FORM" property="itemsAvailable"
       ...
       <td class="text" width=10 align="center">
           <logic:greaterThan name="sciD" property="maxOrderQty" value="-1">
             <bean:write name="item" property="maxOrderQty"/>
           </logic:greaterThan>
        </td>
       <td class="text" align="center">
    ...
    <tr>
    <td colspan="10"  class="tableoutline"><img src="<%=cw_spacer%>" HEIGHT="1"></td>
</tr><tr>
