...
<logic:equal name="toolBarTab" value="shoppingcontrol">
        <%display = "shoppingcontrol";%>
</logic:equal>
...
String toolLink0201 = "/"+rootDir+"/userportal/customerAccountManagementShoppingControl.do?action=shopping_control";//new code
String toolLink03 = "";
String toolLink04 = "";
...
String tabs0201="";
String display0201="shoppingcontrol";
String toolLable0201="shop.menu.shoppingcontrol";
String toolSecondaryToolBar0201 = "";
...
<%
  toolLink03 = "/"+rootDir+"/userportal/customerAccountManagementSurvey.do?action=view";
  display03 = "survey";
...
if(appUser.isAuthorizedForFunction(RefCodeNames.APPLICATION_FUNCTIONS.RUNTIME_INVOICE_TAB)) {
  toolLink04 = "/"+rootDir+"/userportal/customerAccountManagementInvoices.do";
  toolSecondaryToolBar04 = "/"+rootDir+"/userportal/customerAccountManagementInvoicesDetail.do?action=view";
  display04 = "invoice";
...
<jsp:include flush='true' page="<%=t_templatorToolBar%>" >
   ...
   <jsp:param name="toolLink0201"  value="<%=toolLink0201%>"/>
   <jsp:param name="tabs0201"  value=""/>
   <jsp:param name="display0201"  value="shoppingcontrol"/>
   <jsp:param name="toolLable0201" value="shop.menu.shoppingcontrol"/>
   <jsp:param name="toolSecondaryToolBar0201" value=""/>
