...
public class ArrayOfMessage  implements java.io.Serializable {
    private com.avalara.avatax.services.address.Message[] message;
     ...
     */
    public ArrayOfMessage(
            com.avalara.avatax.services.address.Message[] message) {
     ...
     * was initialized.
     */
    public com.avalara.avatax.services.address.Message[] getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(com.avalara.avatax.services.address.Message[] message) {
        if (message != null)
        {
            this.message = message;
        }
     ...
     * @return Message
     */
    public com.avalara.avatax.services.address.Message getMessage(int i) {
     ...
     * Message array
     */
    public void setMessage(int i, com.avalara.avatax.services.address.Message _value) {
        this.message[i] = _value;
    }

    public boolean hasClientMetricMessage(int i, com.avalara.avatax.services.address.Message _value)
    {
        boolean result = false;
        ArrayOfMessage addressMessages = new ArrayOfMessage();
        if(this.message != null || this.message.length > 0)
        {
            for (int ii = 0; ii < addressMessages.size(); ii++)
            {
                if(!addressMessages.getMessage(ii).toString().equalsIgnoreCase("clientmetricsrequest"))
                {
                    addressMessages.setMessage(ii,this.message[ii]);
                }
                else
                {
                    result = true;
        ...
        this.message = addressMessages.message;
        return result;
    }
    ...
    /**
     * Determines if two ArrayOfMessage objects are the same. In current implementation,
     * the contents of the {@link Message} objects in each array must be exactly equal, including in text
     * case, for the function to return true.
     *
     * @param obj
     * @return boolean value indicating whether the ArrayOfMessage objects are equal.
     */
    ...
    /**
     * Calculates a unique integer code for this object and its contents
     * based on the {@link java.lang.Object#hashCode} for the {@link Message}
    ...
    /**
     * Get Custom Serializer for use with this object with Axis; this method is used internally by the adapter
     * and not intended to be used by external implementation code.
     *
     * @param mechType
     * @param _javaType
     ...
     * @see org.apache.axis.encoding.ser.BeanSerializer
     */
    ...
    /**
     * Get Custom Deserializer for use with this object with Axis; this method is used internally by the adapter
     * and not intended to be used by external implementation code.
     *
     * @param mechType
     * @param _javaType
     ...
     * @see com.avalara.avatax.services.base.ser.BeanDeserializer
     */
