...
<jsp:include flush="true" page="<%=t_templatorToolBar%>" >
    ...
    <jsp:param name="display01" value="customsupervisortools"/>
    <jsp:param name="toolLable01" value="template.jd.bsc.menu.toolsForSupervisor"/>
    ...
    <jsp:param name="display02" value="customcleanertools"/>
    <jsp:param name="toolLable02" value="template.jd.bsc.menu.toolsForCleaners"/>
