...
function selectCategory(pLevel) {
  document.forms[0].action = "serviceProviderMgtReportCategoryItemSelect.do?action=select&level=" + pLevel;  
...
<TABLE cellSpacing=0 cellPadding=0 width=769 align=center border=0>
  ...
  <jsp:include flush='true' page="f_serviceProviderReportingMgtToolbar.jsp"/>  
  ...
  <TR>
    ...
    <br><br>
      <SPAN class=fivemargin>
		...
		<html:form name="SERVICE_PROVIDER_REPORT_FORM" action="/serviceproviderportal/serviceProviderMgtReportCategoryItemSelect.do?action=next"
        ...
        <TR>
          <TD class=text valign="top" width="151">
            <DIV class=fivemargin>
				...
				<logic:iterate id="selectedSite" name="SERVICE_PROVIDER_REPORT_FORM" property="selectedSiteList"
          ...
          <TD class=text valign=top width=390>
            <DIV class=fivemargin><br>
				<bean:define id="topCategories" name="SERVICE_PROVIDER_REPORT_FORM" property="topCategoryList" />
				<html:select name="SERVICE_PROVIDER_REPORT_FORM" property="selectedTopCategoryId" onchange="return selectCategory(0);">
					<html:option value=""><app:storeMessage  key="admin.select"/></html:option>
			        <html:options collection="topCategories" 
                             				property="catalogCategoryId" labelProperty="catalogCategoryShortDesc" />											
				</html:select><br><br>									

				<logic:iterate id="childCatList" indexId="i" name="SERVICE_PROVIDER_REPORT_FORM" 
					...
					%>	
					<html:select name="SERVICE_PROVIDER_REPORT_FORM" property='<%= "childCategoryId[" + i + "]" %>' onchange="<%=selectString%>">
						<html:option value=""><app:storeMessage  key="admin.select"/></html:option>
				...
				<logic:equal name="SERVICE_PROVIDER_REPORT_FORM" property="reportTypeCd" value="<%=RefCodeNames.CUSTOMER_REPORT_TYPE_CD.VOLUME_BY_ITEM%>">																					
					<bean:size id="itemCount" name="SERVICE_PROVIDER_REPORT_FORM" property="productList" />
					<logic:greaterThan name="itemCount"  value="0">
						<b>Select one or more product(s) below and click submit</b><br><br>
					</logic:greaterThan>																					
					<logic:iterate id="item" indexId="i" name="SERVICE_PROVIDER_REPORT_FORM" 
				...
				<logic:equal name="SERVICE_PROVIDER_REPORT_FORM" property="reportTypeCd" value="<%=RefCodeNames.CUSTOMER_REPORT_TYPE_CD.VOLUME_BY_CATEGORY%>">
					<logic:notEqual name="SERVICE_PROVIDER_REPORT_FORM" property="selectedTopCategoryId" value="">																					
