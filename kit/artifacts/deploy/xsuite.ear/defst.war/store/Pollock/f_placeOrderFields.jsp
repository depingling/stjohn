...
<%}%>
  ...
  <tr>
    ...
    <td class="text" valign="top" align="left" colspan=2>
      ...
      <html:text name="CHECKOUT_FORM" property="comments" size="65" maxlength="255" value="<%=newcomments%>" /><br>
...
<table class="tbstd" width="<%=Constants.TABLEWIDTH%>"
  ...
  <tr>
    ...
    <td align=left>
      ...
      <a href="#" class="linkButton" onclick="setAndSubmit('<%=formId%>','command','placeOrder');"
