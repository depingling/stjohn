...
public class DojoPopupProgrammaticTag extends TagSupport {

    private static String className = "DojoPopupProgrammaticTag";

    private static final String TARGET_SUFF = "Target";
    private static final String UID = "DojoPopupProgrammaticTag.UID";
    ...
    private void writeTo(JspWriter out, MenuItemView menuData) throws IOException {
        ...
        creteTarget(buffer,mainMenuObj);
    ...
    private void creteTarget(StringBuffer buffer, String mainMenuObj) {
        buffer.append("<td id=\"");
    ...
    private StringBuffer createJSFunction(StringBuffer buffer, String menuObj) {
        ...
        if (!Utility.isSet(startupEvent) || ONLOAD.equals(startupEvent)) {
            buffer.insert(buffer.length(), "dojo.addOnLoad(function (){  create" + menuObj + "()});");
        }
        ...
        if (item.getSubItems() != null && !item.getSubItems().isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (menuItem.getSubItems() != null
                    ...
                    menuContent.append("\", onClick:function(){ document.location.href='");
    ...
    public static void setClassName(String className) {
        DojoPopupProgrammaticTag.className = className;
    }
    ...
    public void setOnClick(String var) {
        this.onClick = var;
    }
