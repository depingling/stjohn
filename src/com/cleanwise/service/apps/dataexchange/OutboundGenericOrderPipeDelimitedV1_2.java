...
public class OutboundGenericOrderPipeDelimitedV1_2 extends InterchangeOutboundSuper implements OutboundTransaction{
	private static final Logger log = Logger.getLogger(OutboundGenericOrderPipeDelimitedV1_2.class);
	...
	private static final String VERSION = "1.2";  //the version number
