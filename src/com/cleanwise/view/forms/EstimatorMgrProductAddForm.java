/**
 * Title:        Spending Estimator 
 * Description:  This is the Struts ActionForm class for the estimator add products
 * Purpose:
 ...
 * </ul>
 */
public final class EstimatorMgrProductAddForm extends ActionForm {
  ...
  // -------------------------------------------------------- Instance Variables
    ...
    private LinkedList _retObject = null;
  ...
  // ---------------------------------------------------------------- Properties
    ...
    public void setRetObject(LinkedList pValue){_retObject=pValue;}
    public LinkedList getRetObject() { return _retObject;}
    ...
    public void setSelectedCategoryId(int  v) {this.SelectedCategoryId = v;}
