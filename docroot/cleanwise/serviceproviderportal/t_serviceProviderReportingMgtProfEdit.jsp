...
<html:form name="USER_DETAIL_FORM"
  action="/serviceproviderportal/serviceProviderReportManagementProfileEdit.do"
...
<%
//String allowChangePassw = appUser.getUserAccount().getPropertyValue(RefCodeNames.PROPERTY_TYPE_CD.ALLOW_USER_CHANGE_PASSWORD);
...
<tr>
<td><app:storeMessage key="shop.menu.main.storeProfile"/></td>
<td>
