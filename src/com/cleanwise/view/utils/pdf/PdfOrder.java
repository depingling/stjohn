 ...
 * @author  bstevens
 */
public class PdfOrder extends PdfSuper {
  ...
  public PdfOrder(HttpServletRequest pRequest, String pOrderLocaleCd) {
    super();
