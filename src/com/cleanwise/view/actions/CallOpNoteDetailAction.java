 ...
 * CallNoteDetail or updates an existing CallNoteDetail.
 */
public final class CallOpNoteDetailAction extends ActionSuper {
  ...
  public ActionForward performSub(
    ...
    if("".equals(callId) || "0".equals(callId) ) {
    ...
    try {
      ...
      if (action.equals("add")) {
        CallOpLogic.addCallNote(request, form, callId);
        return (mapping.findForward("display"));
      }

      // Edit an existing callDetail.
      else if (action.equals("edit") || action.equals("view") ) {
        CallOpLogic.editCallNote(request, form, callId, noteId);  
        return (mapping.findForward("display"));
      }
      ...
      // Save the new or updated callDetail.
        ...
        ActionErrors ae = CallOpLogic.saveCallNote(request, form);
        if (ae.size() > 0 ) {
