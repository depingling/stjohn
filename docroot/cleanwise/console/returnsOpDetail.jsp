...
<title>Operations Console: Returns</title>
...
<html:form name="PO_OP_DETAIL_FORM" action="/console/returnsOpDetail.do"
        ...
        <tr valign="top">
                <td colspan="2">
                        <table width="100%">
                                ...
                                <td><b>Web Order#:</b></td>
                                <td>
                        <% String orderLinkHref = new String("orderOpDetail.do?action=view&id=" + orderId);%>
                                <a href="javascript:void(0);" onclick="popOrder('<%=orderLinkHref%>');"><bean:write name="PO_OP_DETAIL_FORM" property="purchaseOrderStatusDescDataView.orderData.orderNum" /></a>
                                        </td>
                                </tr>
                                <tr>
...
<!-- SiteSpecific properties. -->
    ...
    <tr>
          <td colspan="6" align="center">
            <input type="button" onclick="popLink('orderOpNote.do?action=view&orderid=<%=orderId%>');" value="View All Order Detail Notes" >
            ...
            &nbsp;<input type="button" onclick="popPrint('purchaseOrderOpDetail.do?action=print&amp;id=<%=poId%>');" value="Print PO Detail">
            <logic:equal name="mode" value="edit">
              &nbsp;<input type="button" onclick="popPrint('returnsOpDetail.do?action=printReturn&amp;id=<%=returnId%>');" value="Print Return Detail"></td>
            </logic:equal>
          </td>
     </tr>
