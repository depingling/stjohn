...
/**
 *
 * Data to pass to {@link TaxSvcSoap#commitTax} indicating the document that should be committed.
 * <p>
 * A document can be indicated solely by the {@link CommitTaxRequest#getDocId} if it is known.
 * Otherwise the request must specify all of {@link CommitTaxRequest#getCompanyCode},
 * {@link CommitTaxRequest#getDocCode} and
 ...
 */
public class CommitTaxRequest  implements java.io.Serializable {
     ...
     * <br>If docId is specified, this is not needed.     *
     * <p>
     * Implementation for DocCode has been updated. Some seller system generates DocCode at the time of CommitTax.
     * This enables user to provide a new DocCode at the time of CommitTax call and this should overwrite the existing
     * DocCode.
     * </p> 
     * @param docCode
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CommitTaxRequest)) return false;
        CommitTaxRequest other = (CommitTaxRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(CommitTaxRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://avatax.avalara.com/services", "CommitTaxRequest"));
