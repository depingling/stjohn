...
<tr><td colspan="4"><b><b><app:storeMessage key="admin2.site.orderguidedet.label.siteId"/>:</b> <bean:write name="ADMIN2_SITE_ORDER_GUIDE_FORM" property="siteId"/></td></tr>
<tr>
...
<tr>
<td><a ID=1274 class="tableheader" href="admin2OrderGuideDet.do?action=sortitems&sortField=quantity"><app:storeMessage key="admin2.site.orderguidedet.label.quantity"/></td>
<td><a ID=1275 class="tableheader" href="admin2OrderGuideDet.do?action=sortitems&sortField=amount"><app:storeMessage key="admin2.site.orderguidedet.label.extendedPrice"/></td>
<td><a ID=1276 class="tableheader" href="admin2OrderGuideDet.do?action=sortitems&sortField=cwSKU"><app:storeMessage key="admin2.site.orderguidedet.label.sku"/></td>
<td><a ID=1277 class="tableheader" href="admin2OrderGuideDet.do?action=sortitems&sortField=name"><app:storeMessage key="admin2.site.orderguidedet.label.productName"/></td>
<td><a ID=1278 class="tableheader" href="admin2OrderGuideDet.do?action=sortitems&sortField=size"><app:storeMessage key="admin2.site.orderguidedet.label.itemSize"/></td>
<td><a ID=1279 class="tableheader" href="admin2OrderGuideDet.do?action=sortitems&sortField=pack"><app:storeMessage key="admin2.site.orderguidedet.label.pack"/></td>
<td><a ID=1280 class="tableheader" href="admin2OrderGuideDet.do?action=sortitems&sortField=uom"><app:storeMessage key="admin2.site.orderguidedet.label.uom"/></td>
<td><a ID=1281 class="tableheader" href="admin2OrderGuideDet.do?action=sortitems&sortField=manufacturer"><app:storeMessage key="admin2.site.orderguidedet.label.mfg"/></td>
<td><a ID=1282 class="tableheader" href="admin2OrderGuideDet.do?action=sortitems&sortField=manufSKU"></b><app:storeMessage key="admin2.site.orderguidedet.label.mfgSku"/></td>
<td><a ID=1283 class="tableheader" href="admin2OrderGuideDet.do?action=sortitems&sortField=category"><app:storeMessage key="admin2.site.orderguidedet.label.category"/></td>
<td><a ID=1284 class="tableheader" href="admin2OrderGuideDet.do?action=sortitems&sortField=price"><app:storeMessage key="admin2.site.orderguidedet.label.msrp"/></td>


<td class="tableheader">
<a ID=1285 href="javascript:SetChecked(1);"><app:storeMessage key="admin2.label.selectCheckAll"/></a>
<a ID=1286 href="javascript:SetChecked(0);"><app:storeMessage key="admin2.label.clear"/></a>
<br>
Select</td>
</tr>
