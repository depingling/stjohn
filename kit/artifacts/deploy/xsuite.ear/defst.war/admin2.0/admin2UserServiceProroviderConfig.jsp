...
<div id="distConfig">
    ...
    <html:form styleId="ADMIN2_USER_SERVICE_PROVIDER_CONFIG"
            ...
            <logic:greaterThan name="rescount" value="0">
                ...
                <table width="100%" class="admin2_table_sortable">
                    ...
                    <thead>
                        ...
                        <th class="stpTH"><a class="tableheader" href="#pgsort" onclick="this.blur(); return f_sortTable('resSvcProCfgBody', 0, false);"><app:storeMessage key="admin2.user.config.svcpro.resulttable.text.serviceProviderId"/></a></th>
                        <th class="stpTH"><a class="tableheader" href="#pgsort" onclick="this.blur(); return f_sortTable('resSvcProCfgBody', 1, false);"><app:storeMessage key="admin2.user.config.svcpro.resulttable.text.name"/></a></th>
                        <th class="stpTH"><a class="tableheader" href="#pgsort" onclick="this.blur(); return f_sortTable('resSvcProCfgBody', 2, false);"><app:storeMessage key="admin2.user.config.svcpro.resulttable.text.address1"/></a></th>
                        <th class="stpTH"><a class="tableheader" href="#pgsort" onclick="this.blur(); return f_sortTable('resSvcProCfgBody', 3, false);"><app:storeMessage key="admin2.user.config.svcpro.resulttable.text.city"/></a></th>
                        <th class="stpTH"><a class="tableheader" href="#pgsort" onclick="this.blur(); return f_sortTable('resSvcProCfgBody', 4, false);"><app:storeMessage key="admin2.user.config.svcpro.resulttable.text.state"/></a></th>
                        <th class="stpTH"><a class="tableheader" href="#pgsort" onclick="this.blur(); return f_sortTable('resSvcProCfgBody', 5, false);"><app:storeMessage key="admin2.user.config.svcpro.resulttable.text.status"/></a></th>
                        <th class="stpTH"><a class="tableheader" href="#pgsort"><app:storeMessage key="global.action.label.select"/></a></th>

                        </tr>

                    </thead>

                    <tbody id="resSvcProCfgBody">
                    ...
                    <td>
                        <html:submit property="action">
                            <app:storeMessage  key="admin2.button.saveUserServiceProviders"/>
                        </html:submit>
                    </td>
