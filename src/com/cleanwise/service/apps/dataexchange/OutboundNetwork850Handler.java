 ...
 *
 */
public class OutboundNetwork850Handler extends InterchangeOutboundSuper implements OutboundTransaction{
	private static final Category log = Category.getInstance(OutboundNetwork850Handler.class);
	...
	public void setTransactionsToProcess(OutboundEDIRequestDataVector transactionstoproc) {
		...
		while(keysIt.hasNext()){
			...
			if(TYPE_CSV.equals(key)){
				currentBuilder = new OutboundNetwork850CsvTabPurchaseOrder();
