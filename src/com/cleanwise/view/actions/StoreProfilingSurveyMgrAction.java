/*
 * StoreProfilingSurveyAction.java
 *
...
import com.cleanwise.view.logic.StoreProfilingMgrLogic;
import com.cleanwise.view.forms.*;
/**
 *
 * @author  bstevens
 */
public class StoreProfilingSurveyMgrAction extends ActionSuper {
    ...
    throws IOException, ServletException {
        ...
        try {
            ...
            if (action.equals(initStr)) {
                StoreProfilingMgrLogic.init(request,form);
            }else if (action.equals(viewStr)) {
                ae = StoreProfilingMgrLogic.getSurveyDetail(request,form,false,false);
            }else if (action.equals(createStr)) {
                StoreProfilingMgrLogic.setProfile(form, 
                    ProfileViewContainer.getProfileViewContainer(
                        StoreProfilingMgrLogic.createEmptySurvey(request)));
            }else if (action.equals(updateStr)) {
                ae = StoreProfilingMgrLogic.updateSurvey(request,form);
            }else{
                StoreProfilingMgrLogic.init(request,form); 
            }
