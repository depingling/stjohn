...
<"toolLable01" value="shop.menu.details"/>
...
<jsp:include flush='true' page="<%=t_templatorToolBar%>" >
   ...
   <jsp:param name="toolLable01" value="shop.menu.details"/>
   ...
   <jsp:param name="color02" value="#003063"/>
   <jsp:param name="color03" value="#00659C"/>
