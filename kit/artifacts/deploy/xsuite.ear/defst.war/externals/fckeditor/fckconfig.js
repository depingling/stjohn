...
FCKConfig.ToolbarSets["NewXpedx"] = [
        ['Style','FontFormat','FontName','FontSize'],
        ['TextColor','BGColor'],
        '/',
...
FCKConfig.ToolbarSets["NewXpedxShort"] = [
...
FCKConfig.ToolbarSets["NewXpedxMiddle"] = [
        ['Style', 'FontFormat'],'/',
        ...
        ['Link','Unlink'], ['Cut','Copy','Paste','PasteText','PasteWord'], ['Print','SpellCheck'],
] ;
