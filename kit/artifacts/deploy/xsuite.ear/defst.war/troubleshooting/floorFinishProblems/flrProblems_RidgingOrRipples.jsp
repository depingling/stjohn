...
<span class="subheaders">
  ...
  <tr><!-- question -->
    ...
    <td class="text"><b>
Why did ripples and raised lines dry in the finish?</b></td>
  </tr>
  <tr><!-- horizontal space -->
  ...
  <tr><!-- answer -->
    ...
    <td class="text">
	<p>Ridges or ripples in the dried floor finish appear as noticeable raised lines in the finish and is due to poor leveling of the finish for one of several reasons.  Ridging or ripples are almost always caused by a procedural error in the daily maintenance so try to pinpoint what has caused the problem and train everyone on how to avoid it.  Since this problem can escalate labor and chemical costs it is cost effective to correct the procedure that created the problem.</p>
	The following can cause ridging or ripples:
	   <ul class="text">
	    ...
	    <li class="troubleshootingbullet"><span class="text"><a href="#4"><span class="subheaders">Not completely removing a restorer or dust mop treatment before applying the</span></a></span></li>
	    <li class="troubleshootingbullet"><span class="text"><a href="#5"><span class="subheaders">Old finish on the floor or dried stripper/emulsified finish still on the floor</span></a></span></li>
	    <li class="troubleshootingbullet"><span class="text"><a href="#6"><span class="subheaders">Recoating too soon</span></a></span></li>
            <li class="troubleshootingbullet"><span class="text"><a href="#7"><span class="subheaders">Using a fan to help dry the finish</span></a></span></li>
	   </ul><br>
     </td>
   </tr>
   <tr><!-- horizontal rule -->
...
Always use clean mops specifically designed for finish to apply the finish.</p>
             <ul class="text">
...
<tr><!-- horizontal rule -->
   ...
   <tr>
     ...
     <td><br>
         <ul class="text">
	  <li class="troubleshootingbullet"><span class="text"><a name="5"><span class="subheaders">Old finish on the floor or dried stripper/emulsified finish still on the floor</span></a>
             ...
             Make sure to really flood the floor with the stripping solution to prevent dry back, which is the stripper solution mixed with the emulsified finish, and make sure to keep the floor wet at all times.  If the floor appears to be drying during the dwell time then add more stripping solution to the floor.
...
<tr><!-- horizontal rule -->
   ...
   <tr>
     ...
     <td><br>
         <ul class="text">
	  <li class="troubleshootingbullet"><span class="text"><a name="7"><span class="subheaders">Using a fan to help dry the finish</span></a>
             <br><b>How to Fix:</b><br>The problem can only be fixed by removing the effected finish.  If the floor was stripped and the problem appeared right away then another strip must be done.  If the problem appeared on the last coat then scrub with a general purpose cleaner using a green or blue floor pad and then apply new finish.

<p>If the floor was only scrubbed and the problem appeared when reapplying the finish, then scrub with a general purpose cleaner using a green or blue floor pad and apply new finish.</p>
             <p><b>How to Prevent:</b><br>You can use a fan to help speed the drying time of the finish but you should always wait at least fifteen minutes before turning on the fan.  Never aim the fan directly at the finish and make sure that you will not be blowing any debris or dust onto the finish.</p>
             </span></li>
          </ul><br>
	</td>
       </tr>
