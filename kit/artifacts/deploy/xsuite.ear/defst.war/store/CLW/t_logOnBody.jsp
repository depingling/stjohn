...
<div class="bodyalt">
  ...
  <html:form action="userportal/logon.do" focus="j_username" onsubmit="return validate(this)">
    ...
    <table align="center" border="0" cellspacing="0" cellpadding="0" width="422">
      ...
      <tr>
        <td width="7"><img src="../<%=ip%>images/cw_loginleftlogo.gif" WIDTH="7" HEIGHT="53"></td>
        <td align="left"  width="408">
        <table align="left" border="0" cellspacing="0" cellpadding="0">
        <tr>
           <!--<td><img src="../<%=ip%>images/cw_loginlogo.gif" WIDTH="260" HEIGHT="53"></td>-->
           <td><img src='../<%=ip%>images/<app:custom pageElement="pages.logo1.image"/>' WIDTH="260" HEIGHT="53"/></td>
           <td class="text"><app:storeMessage key="logo.slogan"/></td>
        </tr>
        </table>
        </td>
        <td width="7"><img src="../<%=ip%>images/cw_loginrightlogo.gif" WIDTH="7" HEIGHT="53"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="7"><img src="../<%=ip%>images/cw_loginbl.gif" WIDTH="7" HEIGHT="17"></td>
        <td class="changeshippingdk" width="408"><img src="../<%=ip%>images/spacer.gif" height="17" width="1"></td>
        <td width="7"><img src="../<%=ip%>images/cw_loginbr.gif" WIDTH="7" HEIGHT="17"></td>
      </tr>
      <tr>
