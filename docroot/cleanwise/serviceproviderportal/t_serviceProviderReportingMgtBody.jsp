...
<html:form name="SERVICE_PROVIDER_REPORT_FORM" action="/serviceproviderportal/serviceProviderReporting.do?action=next"
...
<a href="serviceProviderReporting.do?action=next&reportTypeCd=<%=rep.getReportName()%>">
<%=xlateReportname%>
</a>
