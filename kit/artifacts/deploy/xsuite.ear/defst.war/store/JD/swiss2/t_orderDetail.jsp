...
<%@ page import="com.cleanwise.view.taglibs.I18nStatusTag" %>
...
<td>
  ...
  <%String orderSource = orderStatusDetail.getOrderDetail().getOrderSourceCd();
  %>
  <app:i18nStatus refCodeName="<%=orderSource%>" refCodeGroup="refcode.ORDER_SOURCE_CD" />
  </td>
        </tr>
...
<logic:equal name="<%=Constants.APP_USER%>" property="showPrice" value="true">
  <td class="shopcharthead" align="center"><div><app:storeMessage key="shoppingItems.text.price"/></div></td><%colCount++;%>
</logic:equal>
<td class="shopcharthead"><div><app:storeMessage key="shoppingItems.text.qty"/></td><%colCount++;%>
<logic:equal name="<%=Constants.APP_USER%>" property="showPrice" value="true">
  <td class="shopcharthead" align="center"><div><app:storeMessage key="shoppingItems.text.extendedPrice"/></td><%colCount++;%>
</logic:equal>
 ...
 <tr bgcolor="<%=ClwCustomizer.getEvenRowColor(session,(Integer)oidx)%>">
  <logic:equal name="ORDER_OP_DETAIL_FORM" property="orderHasInventoryItem" value="true">
    ...
    <td>&nbsp;</td>
        ...
        <td>
        <app:i18nStatus refCodeName="<%=actioncd%>" refCodeGroup="refcode.ORDER_ITEM_DETAIL_ACTION_CD" />
        <%if(actiondate != null){
...
<td>
  <%String oStatus = ShopTool.xlateStatus(orderStatusDetail);
    oStatus = ShopTool.i18nStatus(oStatus,request);
  %>
<%=oStatus%>
