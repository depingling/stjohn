 ...
 *
 */
public class DistrPerfByAccountJDReport  implements GenericReportMulti {

    /** Creates a new instance of DistributorInvoiceProfitReport */
    public DistrPerfByAccountJDReport() {
    }
 ...
 //   protected static final String UNIT_DECLINE = "Unit Decline %%";
    ...
    protected static final String[] COL_WIDTH = new String[]{"35","25","26","12","12","9","10","10","11","10","11","11"};
    ...
    protected HashMap createReportStyleDescriptor(){
       ...
       */
        ...
        GenericReportStyleView colSite = new GenericReportStyleView("COL_SITE","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",false, null,null,COL_WIDTH[0],0 );
        GenericReportStyleView colBranch = new GenericReportStyleView("COL_BRANCH","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",false, null,null,COL_WIDTH[1],0 );
        GenericReportStyleView colDSR = new GenericReportStyleView("COL_DSR","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",false, null,null,COL_WIDTH[2],0 );

        GenericReportStyleView colCurSales = new GenericReportStyleView("COL_CUR_SALES",null,null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[3],0 );
        GenericReportStyleView colPriSales = new GenericReportStyleView("COL_PRI_SALES",null,null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[4],0 );
        GenericReportStyleView colProcOfTot = new GenericReportStyleView("COL_PROC_TOT",null,null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[5],0 );
        GenericReportStyleView colSalesGrPr = new GenericReportStyleView("COL_SALES_GR_PR",null,null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[6],0 );
...
//    protected String getQuerySql(String begDateStr, String endDateStr, int storeId, String pRegionS) throws Exception {
    protected String getQuerySql(Map pParams) throws Exception {
      ...
      String sql=
          "  (select  ACCOUNT_DIM_ID  ACCOUNT, sum("+PRICE_COL+") SUM_PRICE, sum("+QTY_COL+") SUM_QTY, sum("+COST_COL+") SUM_COST, 0 PRIOR_SUM_PRICE  , 0 PRIOR_SUM_QTY, 0 PRIOR_SUM_COST \n" +
