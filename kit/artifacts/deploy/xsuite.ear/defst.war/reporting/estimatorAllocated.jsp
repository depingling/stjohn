...
int processStep = theForm.getAllocatedProcessStep();
...
<tr><td><%@ include file="estimatorAllocCategInput.jsp" %></td></tr>
<% } else if(
  processStep==3
) { %>
<tr><td><%@ include file="estimatorProfilePaperPlusInfo.jsp" %></td></tr>
<tr><td><%@ include file="estimatorAllocCategInfo.jsp" %></td></tr>
<% } %>
