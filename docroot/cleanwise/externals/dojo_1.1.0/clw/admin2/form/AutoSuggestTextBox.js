if(!dojo._hasResource["clw.admin2.form.AutoSuggestTextBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
    dojo._hasResource["clw.admin2.form.AutoSuggestTextBox"] = true;
    dojo.provide("clw.admin2.form.AutoSuggestTextBox");

    dojo.require("dijit.form.TextBox");
    dojo.requireLocalization("clw.admin2.form", "AutoSuggestTextBox", null, "ROOT", "");

    dojo.declare(
            "clw.admin2.form.AutoSuggestTextBoxMixin",
            null,
    {
    // item: Object
    ...
    //input field name
        ...
        _onKeyPress: function(/*Event*/ evt){
            ...
            switch(evt.keyCode){
                ...
                // are selected
                    ...
                    }else if(!this._isShowingNow && this.onEnterKeyPress!=null){
                        return new this.onEnterKeyPress;
                    }  else {
                        this.setDisplayedValue(this.getDisplayedValue());
                    }
                // default case:
        ...
        _startSearch: function(/*String*/ key){
            if(!this._popupWidget){
                ...
                this._popupWidget = new clw.admin2.form.AutoSuggestTextBoxMenu({
    ...
    dojo.declare(
            "clw.admin2.form.AutoSuggestTextBoxMenu",
...

    {
        ...
        postMixInProperties: function() {
            ...
            if(!this.viewModel){
                this.viewModel = new clw.admin2.form.ListModel();
            }

            if (this.viewModel instanceof clw.admin2.form.TableModel) {
            ...
            this._messages = dojo.i18n.getLocalization("clw.admin2.form", "AutoSuggestTextBox", this.lang);
        },
    ...
    // stubs
        ...
        _createOption:function(/*Object*/ item, labelFunc){
            ...
            var menuitem;
            if (this.viewModel instanceof clw.admin2.form.ListModel) {
                menuitem = dojo.doc.createElement("li");
                dijit.setWaiRole(menuitem, "option");
                menuitem.appendChild(dojo.doc.createTextNode(labelObject.value));
            } else if (this.viewModel instanceof clw.admin2.form.TableModel) {
        ...
        createOptions: function(results, dataObject, labelFunc){
            ...
            } else if(this.viewModel instanceof clw.admin2.form.ListModel){
    ...
    dojo.declare(
            "clw.admin2.form.AutoSuggestTextBox",
            [dijit.form.TextBox, clw.admin2.form.AutoSuggestTextBoxMixin],
    {
    //	summary:
    ...
    //		reference will also "be a" _FormWidget.
        ...
        postMixInProperties: function(){
            // this.inherited(arguments); // ??
            clw.admin2.form.AutoSuggestTextBoxMixin.prototype.postMixInProperties.apply(this, arguments);
            dijit.form.TextBox.prototype.postMixInProperties.apply(this, arguments);
        },

        postCreate: function(){
            clw.admin2.form.AutoSuggestTextBoxMixin.prototype._postCreate.apply(this, arguments);
        ...
        setAttribute: function(/*String*/ attr, /*anything*/ value){
            ...
            clw.admin2.form.AutoSuggestTextBoxMixin.prototype._setAttribute.apply(this, arguments);
        }

    }
            );

    dojo.declare("clw.admin2.form.TableModel", null, {});

    dojo.declare("clw.admin2.form.ListModel", null, {} );
