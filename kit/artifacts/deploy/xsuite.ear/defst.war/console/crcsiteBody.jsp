...
function f_tcb() {
    document.CRC_SITE_SEARCH_FORM.searchType[1].checked='true';
}
...
<div class="text">
  ...
  <html:form name="CRC_SITE_SEARCH_FORM" action="console/crcsite.do"
    scope="session" type="com.cleanwise.view.forms.SiteMgrSearchForm"
focus="searchField"  >

<tr> <td align="right"><b>Find Site</b></td>
<% 
OrderOpDetailForm orderForm = (OrderOpDetailForm) session.getAttribute("ORDER_OP_DETAIL_FORM");
String siteName = "";
if(orderForm!=null){
  OrderStatusDescData orderStatusDescD = orderForm.getOrderStatusDetail();
  if(orderStatusDescD!=null) {
    OrderData orderD = orderStatusDescD.getOrderDetail();
    if(orderD!=null && orderD.getOrderSiteName()!=null) {
       siteName = orderD.getOrderSiteName();
    }
  }
}
%>
<td colspan="4">
<html:text name="CRC_SITE_SEARCH_FORM" property="searchField" value='<%=siteName%>'
    onfocus="javascript: f_tcb();"
/>
<html:radio name="CRC_SITE_SEARCH_FORM" property="searchType"
    value="id" />  ID
<html:radio name="CRC_SITE_SEARCH_FORM" property="searchType"
...
<tr>
   <td align="right"><b>Account(s)</b></td>
       ...
       <html:text size='50' onkeypress="<%=onKeyPress%>" name="CRC_SITE_SEARCH_FORM"   property="accountIdList" />
...
<tr>
   ...
   <td><html:text name="CRC_SITE_SEARCH_FORM" property="city"/>
</td>
<td align="right"><b>County</b></td>
<td><html:text name="CRC_SITE_SEARCH_FORM" property="county"/></td>
</tr>
<tr>
   <td align="right"><b>State</b></td>
   <td><html:text name="CRC_SITE_SEARCH_FORM" property="state"/> </td>
<td align="right"><b>Zip</b></td>
<td><html:text name="CRC_SITE_SEARCH_FORM" property="postalCode"/>
</tr>
...
<logic:lessThan name="arrele" property="targetFacilityRank" 
  value="<%=com.cleanwise.service.api.util.Utility.TARGET_FACILITY_THRESHOLD.toString()%>">
<tr class="rowb">
</logic:lessThan>
...
<a href="crcsiteDetail.do?action=sitedetail&searchType=id&searchField=<%=eleid%>">
