 ...
 */
public final class OrderOpItemSearchAction extends ActionSuper {
  ...
  public ActionForward performSub(
    ...
    try {
      ...
      if (action.equals("view")) {
        OrderOpLogic.getOrderItemList(request, form, orderId, erpPoNum);
        return (mapping.findForward("display"));
      }             
    
      else if (action.equals("sortitems")) {
        OrderOpLogic.sortItemList(request, form);
        return (mapping.findForward("display"));
      }
