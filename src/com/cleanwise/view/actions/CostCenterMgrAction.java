 ...
 */
/*
public final class CostCenterMgrAction
        extends ActionBase {
...
/*
    public ActionForward performAction(ActionMapping mapping, ActionForm form,
        ...
        if (action.equals("init")) {
            ...
            CostCenterMgrLogic.search(request, form);
            
            return (mapping.findForward("success"));
        } else if (action.equals("reset_item_cost_centers")) {
            CostCenterMgrLogic.resetCostCenters(request, form);
            
            return (mapping.findForward("success"));
        } else if (action.equals(viewallStr) || action.equals("viewall")) {
            CostCenterMgrLogic.getAll(request, form);
            ...
            ActionErrors ae = CostCenterMgrLogic.updateCostCenter(request,
                    form);
            ...
            ActionErrors ae = CostCenterMgrLogic.updateBudgets(request,
                    form);
            ...
            ActionErrors ae = CostCenterMgrLogic.delete(request, form);
            ...
            CostCenterMgrLogic.updateCategoryCostCenter(request, form);
