...
<table width="769"  class="mainbody"> <%-- Header table. --%>
  <tr>
...
<td>
<bean:write name="WORKFLOW_DETAIL_FORM" property="id"/>
</td>
<td><b>Workflow Name:</b></td>
<td>
<html:text name="WORKFLOW_DETAIL_FORM" property="name"/>
...
%>
<bean:write name="WORKFLOW_DETAIL_FORM" property="typeCd"/>
<% } else { %>
...
%>
<html:select name="WORKFLOW_DETAIL_FORM" property="typeCd">
<% if (typelen > 1) { %>
...
<td>
<html:select name="WORKFLOW_DETAIL_FORM" property="statusCd">
<html:option value=""><app:storeMessage  key="admin.select"/></html:option>
...
<% if (!wid.equals("0")) { %>
<%
  String loc = "javascript:window.location='accountWorkflowSites.do?action=sites&workflowId=" +
    wid + "' ";
%>
