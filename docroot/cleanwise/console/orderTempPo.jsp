...
<html:form name="ORDER_TEMP_PO_FORM" action="/console/orderTempPo.do?action=select"
	type="com.cleanwise.view.forms.OrderOpTemporaryPoForm">
	...
	<tr>
		<td colspan="4">
			<bean:define id="distList" name="ORDER_TEMP_PO_FORM" property="distList" />		
			<html:select name="ORDER_TEMP_PO_FORM" property="distIdS" onchange="if(this.value !='') { return document.forms[0].submit();} ">
