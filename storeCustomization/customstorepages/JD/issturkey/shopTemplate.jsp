    ...
    <td colspan="2" height="30px" valign="center">
        <logic:equal name="SHOP_FORM" property="categoryPathSize" value="0">
            <logic:equal name="SHOP_FORM" property="navigationFlag" value="true">
            	<logic:notEqual name="SHOP_FORM" property="multiLevelCategoryExists" value="true">
...
<tr>
    ...
    <td colspan="2" align="right"><a href="#" class="linkButton" onclick="viewPrinterFriendly();">
        <img src='<%=IMGPath + "/b_print.gif"%>' border="0"/><app:storeMessage key="global.label.printerFriendly"/>
    </a>
...
<td>
  ...
  <img src="<%=IMGPath%>/cw_spacer.gif" height="1">
    ...
    <%if (viewAddInvCart) {%>
        <td>
          <a href="#" class="linkButton" onclick="setAndSubmit('items','command','sc_addToModInvCart');"><img src="<%=add_img%>" border="0"/><app:storeMessage key="global.label.addToInventoryCart"/></a>
        </td>
    <%} else {%>
        <td>
          <a href="#" class="linkButton" onclick="setAndSubmit('items','command','addToCart');"><img src='<%=add_img%>' border="0"/><app:storeMessage key="global.label.addToCart"/></a>
        </td>
    <%}%>
     <td>
