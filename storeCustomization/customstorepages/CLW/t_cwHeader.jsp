...
<td align="right" colspan="4">
    <table cellpadding="0" cellspacing="0" class="headernavtable" style="border-collapse: collapse;">
        <td align="right">
            <a class="headernavlinkstart" href="../userportal/customerhome.do?hp_action=init"><app:custom
                    pageElement="pages.home.button"/></a>
        </td>
        <td align="right">
            <a class="headernavlinkstart" href="../userportal/customerAccountManagement.do"><app:storeMessage
                    key="shop.header.text.accountManagement"/></a>
        </td>
        <%
        ...
        <td align="right">
            <a class="headernavlinkstart"
               href="../userportal/msbnotes.do">
                <app:storeMessage key="shop.header.text.notes"/></a>
        </td>
        <%
            }
        %>
        <td align="right">
            <a class="headernavlinkstart"
               href="../userportal/templator.do?display=t_contactUsBody.jsp&tabs=contactUsToolBar"><app:storeMessage
                    key="shop.header.text.contactUs"/></a>
        </td>
        <%
        ...
        <logic:equal name="<%=Constants.CW_LOGOUT_ENABLED%>" value="true">
            ...
            <td align="right">
                <a class="headernavlinkstart" href="../store/shop.do?action=catalog"><app:storeMessage
                        key="shop.header.text.search"/></a>
            </td>
            <% } %>
            <td align="right">
                <a class="headernavlink" href="../userportal/logoff.do"><app:storeMessage
                        key="shop.header.text.logOut"/></a>
            </td>
        </logic:equal>
        <logic:equal name="<%=Constants.CW_LOGOUT_ENABLED%>" value="false">
            <td align="right">
                <a class="headernavlink" href="../store/shop.do?action=catalog"><app:storeMessage
                        key="shop.header.text.search"/></a>
            </td>
        </logic:equal>
