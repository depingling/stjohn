...
*/
public class Inbound855
{
/** constructor for class Inbound855
...
*/
public Inbound855(String inFileName)
             ...
             if (table != null)
               {
                 ...
                 extractSegmentBAKfromTableHeader(table);
...
/** extract data from segment BAK that is part of the TableHeader
...
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentBAKfromTableHeader(Table inTable)
  throws OBOEException
{
  ...
  if (de != null)
    de.get();
  de = segment.getDataElement(6);  // 326 Request Reference Number
  if (de != null)
    de.get();
  de = segment.getDataElement(7);  // 367 Contract Number
  if (de != null)
    de.get();
  ...
  if (de != null)
    de.get();
  de = segment.getDataElement(10);  // 640 Transaction Type Code
  if (de != null)
    de.get();
  }
...
public void extractSegmentCSHfromTableHeader(Table inTable)
  throws OBOEException
{
  Segment segment = inTable.getSegment("CSH");
  if (segment == null)
    return;
  DataElement de;
  ...
  for (int i = 0; i <  numberInVector; i++)
   {
     ...
     extractSegmentLDTfromTableDetailLoopPO1(loop);
     ...
     extractLoopACKfromTableDetailLoopPO1(loop);
     extractSegmentMANfromTableDetailLoopPO1(loop);
     extractSegmentAMTfromTableDetailLoopPO1(loop);
...
public void extractLoopSACfromTableDetailLoopPO1(Loop inLoop)  throws OBOEException
{
  ...
  for (int i = 0; i <  numberInVector; i++)
   ...
   if (loop == null) return;
      ...
      extractSegmentCURfromTableDetailLoopPO1LoopSAC(loop);
    }
  }
...
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentCURfromTableDetailLoopPO1LoopSAC(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.getSegment("CUR");
  if (segment == null)
    return;
...
/** extract data from segment LDT that is part of the TableDetailLoopPO1
*<br>Lead Time used 
*<br>To specify lead time for availability of products and services
* @param inLoop Loop containing this segment
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentLDTfromTableDetailLoopPO1(Loop inLoop)  throws OBOEException
{
  Segment segment;
  int numberOfSegmentsInVector = inLoop.getCount("LDT");
  for (int i = 0; i <  numberOfSegmentsInVector; i++)
    {
       segment = inLoop.getSegment("LDT", i);
       if (segment == null)
         return;
       DataElement de;
       de = segment.getDataElement(1);       // 345 Lead Time Code
...
/** extract data from loop ACK that is part of TableDetailLoopPO1
*<br>Line Item Acknowledgment used 
* @param inLoop loop containing this loop
*@throws OBOEException - most likely loop not found
*/
public void extractLoopACKfromTableDetailLoopPO1(Loop inLoop)  throws OBOEException
{
  Loop loop;
  ...
  for (int i = 0; i <  numberInVector; i++)
   ...
   if (loop == null) return;
      extractSegmentACKfromTableDetailLoopPO1LoopACK(loop);
      extractSegmentDTMfromTableDetailLoopPO1LoopACK(loop);
    }
  }
/** extract data from segment ACK that is part of the TableDetailLoopPO1LoopACK
*<br>Line Item Acknowledgment used 
*<br>To acknowledge the ordered quantities and specify the ready date for a specific line item
* @param inLoop Loop containing this segment
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentACKfromTableDetailLoopPO1LoopACK(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.getSegment("ACK");
  if (segment == null)
    return;
  DataElement de;
  ...
  if (de != null)
    de.get();
  de = segment.getDataElement(27);  // 559 Agency Qualifier Code
  if (de != null)
    de.get();
  de = segment.getDataElement(28);  // 822 Source Subqualifier
  if (de != null)
    de.get();
  de = segment.getDataElement(29);  // 1271 Industry Code
  if (de != null)
    de.get();
  }
/** extract data from segment DTM that is part of the TableDetailLoopPO1LoopACK
*<br>Date/Time Reference used 
*<br>To specify pertinent dates and times
* @param inLoop Loop containing this segment
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentDTMfromTableDetailLoopPO1LoopACK(Loop inLoop)  throws OBOEException
{
...
/** extract data from segment AMT that is part of the TableDetailLoopPO1
*<br>Monetary Amount used 
*<br>To indicate the total monetary amount
* @param inLoop Loop containing this segment
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentAMTfromTableDetailLoopPO1(Loop inLoop)  throws OBOEException
{
...
public void extractLoopN9fromTableDetailLoopPO1(Loop inLoop)  throws OBOEException
{
  ...
  for (int i = 0; i <  numberInVector; i++)
   ...
   if (loop == null) return;
      ...
      extractSegmentMSGfromTableDetailLoopPO1LoopN9(loop);
    }
  }
...
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentMSGfromTableDetailLoopPO1LoopN9(Loop inLoop)  throws OBOEException
{
  Segment segment;
  int numberOfSegmentsInVector = inLoop.getCount("MSG");
  for (int i = 0; i <  numberOfSegmentsInVector; i++)
...
public void extractLoopN1fromTableDetailLoopPO1(Loop inLoop)  throws OBOEException
{
  ...
  for (int i = 0; i <  numberInVector; i++)
   ...
   if (loop == null) return;
      ...
      extractSegmentQTY_2fromTableDetailLoopPO1LoopN1(loop);
...
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentQTY_2fromTableDetailLoopPO1LoopN1(Loop inLoop)  throws OBOEException
{
  Segment segment;
...
public void extractLoopSLNfromTableDetailLoopPO1(Loop inLoop)  throws OBOEException
{
  ...
  for (int i = 0; i <  numberInVector; i++)
   ...
   if (loop == null) return;
      ...
      extractSegmentMSG_2fromTableDetailLoopPO1LoopSLN(loop);
      ...
      extractSegmentCTPfromTableDetailLoopPO1LoopSLN(loop);
      extractSegmentPAMfromTableDetailLoopPO1LoopSLN(loop);
      extractSegmentACK_2fromTableDetailLoopPO1LoopSLN(loop);
      extractLoopSAC_2fromTableDetailLoopPO1LoopSLN(loop);
      extractSegmentDTM_4fromTableDetailLoopPO1LoopSLN(loop);
      ...
      extractLoopQTY_3fromTableDetailLoopPO1LoopSLN(loop);
...
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentMSG_2fromTableDetailLoopPO1LoopSLN(Loop inLoop)  throws OBOEException
{
  Segment segment;
  int numberOfSegmentsInVector = inLoop.getCount("MSG");
  for (int i = 0; i <  numberOfSegmentsInVector; i++)
...
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentCTPfromTableDetailLoopPO1LoopSLN(Loop inLoop)  throws OBOEException
{
  Segment segment;
  int numberOfSegmentsInVector = inLoop.getCount("CTP");
  for (int i = 0; i <  numberOfSegmentsInVector; i++)
...
/** extract data from segment ACK that is part of the TableDetailLoopPO1LoopSLN
*<br>Line Item Acknowledgment used 
*<br>To acknowledge the ordered quantities and specify the ready date for a specific line item
* @param inLoop Loop containing this segment
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentACK_2fromTableDetailLoopPO1LoopSLN(Loop inLoop)  throws OBOEException
{
  Segment segment;
  int numberOfSegmentsInVector = inLoop.getCount("ACK");
  for (int i = 0; i <  numberOfSegmentsInVector; i++)
    {
       segment = inLoop.getSegment("ACK", i);
       if (segment == null)
         return;
       DataElement de;
       de = segment.getDataElement(1);       // 668 Line Item Status Code
...
*@throws OBOEException - most likely segment not found
*/
public void extractSegmentDTM_4fromTableDetailLoopPO1LoopSLN(Loop inLoop)  throws OBOEException
{
  Segment segment;
  int numberOfSegmentsInVector = inLoop.getCount("DTM");
  for (int i = 0; i <  numberOfSegmentsInVector; i++)
...
*@throws OBOEException - most likely loop not found
*/
public void extractLoopQTY_3fromTableDetailLoopPO1LoopSLN(Loop inLoop)  throws OBOEException
{
  Loop loop;
  int numberInVector = inLoop.getCount("QTY");
  for (int i = 0; i <  numberInVector; i++)
