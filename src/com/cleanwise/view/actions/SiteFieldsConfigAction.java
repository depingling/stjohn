 ...
 */
public final class SiteFieldsConfigAction extends ActionSuper {
    ...
    public ActionForward performSub(ActionMapping mapping,
        ...
        try {
            if (action.equals("init")) {
                AccountConfigLogic.fetchSiteFields(request, form);
                return (mapping.findForward("success"));
            }
            else if (action.equals(saveStr)) {
                AccountConfigLogic.saveSiteFields(request, form);
                return (mapping.findForward("success"));
            }
        }
        catch (Exception e) {
