...
<%
	...
	String action = "/" + portal + "/orderOpItemDetail.do";
...
<html:form name="ORDER_OP_ITEM_DETAIL_FORM" action="<%=action%>"
...
<td><b>Action CD</b></td>
<td class="resultscolumna"><a href="orderOpItemDetail.do?action=sortitemdetails&sortField=date"><b>Action Date</b></a></td>
</tr>
