 ...
 */
public final class CustAcctMgtReportCategoryItemSelectAction extends ActionSuper {
  ...
  public ActionForward performSub(
	  ...
	  if (action.equals("init")) {
	      ActionErrors ae = CustAcctMgtReportLogic.initCategoryItemSelect(request, form);
              if (ae.size() > 0) {
              ...
              ActionErrors ae = CustAcctMgtReportLogic.initSubCategoryOrItem(request, form);
              if (ae.size() > 0) {
                  saveErrors(request, ae);
                  return (mapping.findForward("display"));
              }
