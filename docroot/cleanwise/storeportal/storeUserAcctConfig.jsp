  ...
  <div id="acctConfig">
    <html:form styleId="1381" name="STORE_ADMIN_USER_FORM"  action="<%=f1sub%>" scope="session" 
      ...
      <table ID=1382 width="769" class="results">
        ...
        <tr> <td>&nbsp;</td>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Show Configured Only:
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <html:submit property="action">Configure All Accounts
          </html:submit>
          <html:submit property="action">Configure All Sites
          </html:submit>
          </td>
        </tr>
        <tr> <td>&nbsp;</td>
          ...
          Remove Site Associations When Remove Account Association
            <html:checkbox name = 'STORE_ADMIN_USER_FORM' property='removeSiteAssocFl' value='true'/>
          </td>
        </tr>
      ...
      <td>
        <html:submit property="action">
          <app:storeMessage  key="admin.button.saveUserAccounts"/>
        </html:submit>
      </td>
    </tr>
