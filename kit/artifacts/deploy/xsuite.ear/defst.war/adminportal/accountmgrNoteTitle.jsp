...
<html:form action="/adminportal/accountmgrNote.do" focus="skuTempl" >
...
%>
<tr>
<td class="tableheader"><a href='accountmgrNote.do?action=sortNotes&field=noteTitle'>Note Title</a></td>
<td class="tableheader"><a href='accountmgrNote.do?action=sortNotes&field=modifyDate'>Modify Date</a></td>
<td class="tableheader"><a href='accountmgrNote.do?action=sortNotes&field=searchRating'>Search Rating</a></td>
