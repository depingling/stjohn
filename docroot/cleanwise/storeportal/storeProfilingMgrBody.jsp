...
<table width="769" cellspacing="0" border="0"  class="mainbody">
  <html:form action="storeportal/storeProfilingMgr.do"
    type="com.cleanwise.view.forms.StoreProfilingMgrSearchForm">
...
<jsp:include flush='true' page="storeProfilingFoundInc.jsp">
        <jsp:param name="detailHref" value="storeProfilingSurveyMgr.do" />
</jsp:include>
