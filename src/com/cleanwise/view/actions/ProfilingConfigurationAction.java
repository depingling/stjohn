 ...
 * @author  bstevens
 */
public class ProfilingConfigurationAction extends ActionSuper {
    ...
    throws IOException, ServletException {
        ...
        try {
            ...
            if (action.equals(initStr)) {
                ...
                ae = ProfilingMgrLogic.getConfig(request, form);
            }else if (action.equals(updateStr)){
                ae = ProfilingMgrLogic.updateConfig(request, form);
            }else {
                ProfilingMgrLogic.init(request, form);
            }
