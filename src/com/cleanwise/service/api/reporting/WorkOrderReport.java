...
/**
 */
public class WorkOrderReport implements GenericReportMulti {


    private static String className = "WorkOrderReport";
...
//--AND cc.short_desc LIKE '%'
    ...
    private GenericReportColumnViewVector getWorkOrderTotalsReportHeader() {
        ...
        header.add(ReportingUtils.createGenericReportColumnView("java.lang.String", "Add Time", 0, 255, "VARCHAR2"));
        ...
        header.add(ReportingUtils.createGenericReportColumnView("java.sql.Timestamp", "Quoted Start Date", 0, 0, "DATE"));
        header.add(ReportingUtils.createGenericReportColumnView("java.sql.Timestamp", "Quoted Finish Date", 0, 0, "DATE"));
