 ...
 *
 */
public class DistrPerfByAccountJDGrowthReport  extends DistrPerfByAccountJDReport implements GenericReportMulti {
  ...
  String title = "Performance by Account with growth" ;
  return title;
 }
