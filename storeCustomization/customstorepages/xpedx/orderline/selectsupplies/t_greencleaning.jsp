...
<tr>
<td>
<jsp:include flush='true' page='<%=ClwCustomizer.getStoreFilePath(request,"f_greenCleaningToolbar.jsp")%>'/>

</td>
</tr>
</table>

<% String msgs=ClwCustomizer.getStoreFilePath(request,"f_shopping_msgs.jsp"); %>
<jsp:include flush='true' page="<%=msgs%>"/>

<table width="98%" class="tbstd" align="center"
...
<table  cellpadding="0" cellspacing="0" align="center" width="100%">
  ...
  <td class="shopcharthead" align="center">
   ...
   <td class="shopcharthead" align="center">
      <logic:notEqual name="<%=Constants.APP_USER%>" property="userStore.storeType.value" value="<%=RefCodeNames.STORE_TYPE_CD.MLA%>">
            <app:storeMessage key="shoppingItems.text.spl"/>
      </logic:notEqual>
          <logic:equal name="<%=Constants.APP_USER%>" property="userStore.storeType.value" value="<%=RefCodeNames.STORE_TYPE_CD.MLA%>">
          &nbsp;
          </logic:equal>
   </td>
  </tr>
  ...
  <logic:iterate id="item" name="SHOP_FORM" property="cartItems"
   ...
   type="com.cleanwise.service.api.value.ShoppingCartItemData">
     ...
     <td class="text" align="center">
       ...
       %>
     <%String itemLink = "shop.do?action=item&source=greencleaning&itemId="+itemId;%>
