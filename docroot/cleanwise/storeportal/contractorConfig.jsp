...
<div class="text"><logic:present name="list.bsc.sites">
		...
		<thead>
			<tr align=left>
				...
				<th class="tt"><a href="#pgsort"
					...
					title="-- Sort by Account">Account</a></th>
				<th class="tt"><a href="#pgsort"
					onclick="this.blur(); return f_sortTable('resTblBdy', 3, false);"
					title="-- Sort by Address">Address</a></th>
				<th class="tt"><a href="#pgsort"
					onclick="this.blur(); return f_sortTable('resTblBdy', 4, false);"
					title="-- Sort by City">City</a></th>
				<th class="tt"><a href="#pgsort"
					onclick="this.blur(); return f_sortTable('resTblBdy', 5, false);"
					title="-- Sort by State">State</a></th>
				<th class="tt"><a href="#pgsort"
					onclick="this.blur(); return f_sortTable('resTblBdy', 6, false);"
					title="-- Sort by Zip">Zip</a></th>
				<th class="tt"><a href="#pgsort"
					onclick="this.blur(); return f_sortTable('resTblBdy', 7, false);"
		...
		<tbody id="resTblBdy">
			<logic:iterate id="arrele" name="list.bsc.sites"
				...
				<tr>
					...
					<td><bean:write name="arrele" property="name" /> </a></td>
