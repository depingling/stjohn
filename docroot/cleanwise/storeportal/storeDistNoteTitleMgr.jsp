...
<table ID=773 cellspacing="0" border="0" width="769"  class="mainbody">
<tr>
...
<html:form styleId="774" action="/storeportal/distnotemgr.do" focus="keyWord" >
<bean:define id="distId" name="STORE_DIST_NOTE_MGR_FORM" property="busEntityId"/>
<html:hidden  name="STORE_DIST_NOTE_MGR_FORM" property="busEntityId" value="<%=distId.toString()%>"/>
</tr>
<tr>
<td colspan='2'><b>Topic:</b>
<bean:write name="STORE_DIST_NOTE_MGR_FORM" property="topicName"/>&nbsp;&nbsp;&nbsp;
<a ID=775 href="distnotemgr.do?action=selectTopic">[Change Topic]</a>
</td>
</tr>
<tr>
<td colspan='2'><b>Key Words:</b>
<html:text name="STORE_DIST_NOTE_MGR_FORM" size='50' property="keyWord"/>&nbsp;&nbsp;&nbsp;
<b>Include Note Text:</b>
<html:checkbox name="STORE_DIST_NOTE_MGR_FORM" property="textAlsoFl"/>
</td>
</tr>
<tr>
<td colspan='2'>
...
<table ID=776 cellspacing="0" border="0" width="769"  class="results">
<%
  NoteViewVector notes = theForm.getNoteList();
  if(notes!=null && notes.size()>0) {
%>
<tr>
<td class="tableheader"><a ID=777 href='distnotemgr.do?action=sortNotes&field=noteTitle'>Note Title</a></td>
<td class="tableheader"><a ID=778 href='distnotemgr.do?action=sortNotes&field=modifyDate'>Modify Date</a></td>
<td class="tableheader"><a ID=779 href='distnotemgr.do?action=sortNotes&field=searchRating'>Search Rating</a></td>
...
%>
<tr>
<td><a ID=780 href="<%=noteLink%>"><%=noteTitle%></a> </td>
<td><%=modDateS%></td>
<td><%=rating%></td>
<td><%=kwListS%></td>
<td><html:multibox name="STORE_DIST_NOTE_MGR_FORM" property="selectorBox" value="<%=noteIdS%>" /></td>
</tr>
<%}%>
<tr>
