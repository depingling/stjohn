 ...
 %>
  ...
  <%
      if (theForm != null && theForm.getLocateSiteFl()) {
          ...
          // ref num search fields
          String noShowRefNumFieldS = request.getParameter("noShowRefNumField");
          boolean noShowRefNumField = Utility.isTrue(noShowRefNumFieldS);
...
var dml=document.forms['locateStoreSiteForm'];
...
<html:form  styleId="locateStoreSiteForm" action="<%=jspFormAction%>"  scope="session">
<div class="rptmid">
Find Sites
<table ID=392 width="750"  border="0"  class="mainbody">
  ...
  <%prop=jspFormNestProperty+".maxSitesToReturn";%>
  <html:hidden property="<%=prop%>" value="<%=maxSites%>"/>
  ...
  <tr> <td align="right">
	  ...
	  <td><html:text styleId="mainField" property="<%=prop%>" onkeypress="return submitenter(this,event)"/>
        ...
        (starts with) <html:radio property="<%=prop%>" value="nameContains" />
        (contains) </td>
  </tr>
  <% }%>
 <tr>
