...
String cw_shopsecondaryproduct = ClwI18nUtil.getMessage(request,"shop.menu.uniccoFullContract",null);
...
switch (tabi) {
  ...
  case 8:
    ...
    img_row2 = ClwI18nUtil.getMessage(request,"shop.heading.shopUniccoFullContract",null);
    break;
...
<!-- pickup images -->
<%
String cw_shopUniccoFullContract = ClwI18nUtil.getMessage(request,"shop.heading.shopUniccoFullContract",null);
...
String toolLable02 = "shop.menu.uniccoFullContract";
...
<% } else { %>
  ...
  <% if(theForm!=null) { %>
    <% if(theForm.getShopMethod()==Constants.SHOP_BY_CATALOG) { %>
      <td class="subHeader"><%=cw_shopUniccoFullContract%></td>
      <td class="subHeader" align="right">
        <img src="<%=cw_spacer%>" border="0" height="25" WIDTH="1">
      </td>
    <% } else { %>
