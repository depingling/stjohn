...
<tr>
<td><b><app:storeMessage key="shop.checkout.text.poNumber"/></b></td>
<td>
...
<jsp:include flush="true" page='<%=ClwCustomizer.getStoreFilePath(request,"f_item_table_headers.jsp")%>' />
...
<% } %>
  ...
  <% } %>
    ...
    <td width=10 align="center">
      <logic:greaterThan name="scartItem" property="maxOrderQty" value="-1">
        <bean:write name="scartItem" property="maxOrderQty"/>
      </logic:greaterThan>
    </td>
...
%>
     ...
     <td class="text"><div class="fivemargin">
       <bean:write name="scartItem" property="product.size"/>&nbsp;
     </div></td>
     <td class="text"><div class="fivemargin">
     ...
     <td class="text"><div class="fivemargin">
       <bean:write name="scartItem" property="product.color"/>&nbsp;
     </div></td>
...
<jsp:include flush="true" page='<%=ClwCustomizer.getStoreFilePath(request,"f_order_summary.jsp")%>' />
