  ...
  throws OBOEException
{
  ...
  TransactionSet ts = TransactionSetFactory.buildTransactionSet("850");
  ...
  buildSegmentBEGforTableHeader(table);
  ...
  // for (i = 0; i < multipletimes; i++)
  buildSegmentTC2forTableHeader(table);
  // for (i = 0; i < multipletimes; i++)
  ...
  // for (i = 0; i < multipletimes; i++)
  buildLoopSPIforTableHeader(table);
  // for (i = 0; i < multipletimes; i++)
...
/** builds segment BEG that is part of the TableHeader
...
* @param inTable table containing this segment
* @return segment object BEG
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentBEGforTableHeader(Table inTable)
  throws OBOEException
{
 ...
 de.set("");
  ...
  //de.set("");//not required
  de = (DataElement) segment.buildDE(7);  // 587 Acknowledgment Type
  //de.set("");//not required
  de = (DataElement) segment.buildDE(8);  // 1019 Invoice Type Code
  //de.set("");//not required
  de = (DataElement) segment.buildDE(9);  // 1166 Contract Type Code
  //de.set("");//not required
  de = (DataElement) segment.buildDE(10);  // 1232 Purchase Category
  //de.set("");//not required
  de = (DataElement) segment.buildDE(11);  // 786 Security Level Code
  //de.set("");//not required
  de = (DataElement) segment.buildDE(12);  // 640 Transaction Type Code
  //de.set("");//not required
/* segment.useDefault(); */
  return segment;
  }
...
/** builds segment TC2 that is part of the TableHeader
*<br>Commodity used 
...
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentTC2forTableHeader(Table inTable)
  throws OBOEException
{
  Segment segment = inTable.createSegment("TC2");
  inTable.addSegment(segment);
  DataElement de;
...
/** builds segment PCT that is part of the TableHeader
*<br>Percent Amounts used 
*<br>To qualify percent amounts and supply percent amounts
* @param inTable table containing this segment
* @return segment object PCT
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentPCTforTableHeader(Table inTable)
  throws OBOEException
{
  Segment segment = inTable.createSegment("PCT");
  inTable.addSegment(segment);
  DataElement de;
  de = (DataElement) segment.buildDE(1);  // 1004 Percent Qualifier
 de.set("");
  de = (DataElement) segment.buildDE(2);  // 954 Percent
 de.set("");
/* segment.useDefault(); */
  return segment;
  }
...
/** builds loop AMT that is part of the TableHeader
*<br>Monetary Amount used 
* @param inTable table containing this segment
* @return loop object AMT
* @throws OBOEException - most likely segment not found
*/
public Loop buildLoopAMTforTableHeader(Table inTable)
  throws OBOEException
{
  Loop loop = inTable.createLoop("AMT");
  inTable.addLoop(loop);
  buildSegmentAMTforTableHeaderAMT(loop);
  buildSegmentREFforTableHeaderAMT(loop);
  buildSegmentDTMforTableHeaderAMT(loop);
  buildSegmentPCTforTableHeaderAMT(loop);
  buildLoopFA1forTableHeaderAMT(loop);
  return loop;
  }
/** builds segment AMT that is part of the TableHeaderAMT
*<br>Monetary Amount used 
...
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentAMTforTableHeaderAMT(Loop inLoop)  throws OBOEException
{
...
/** builds segment REF that is part of the TableHeaderAMT
*<br>Reference Identification used 
*<br>To specify identifying information
* @param inLoop loop containing this segment
* @return segment object REF
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentREFforTableHeaderAMT(Loop inLoop)  throws OBOEException
{
...
/** builds segment DTM that is part of the TableHeaderAMT
*<br>Date/Time Reference used 
*<br>To specify pertinent dates and times
* @param inLoop loop containing this segment
* @return segment object DTM
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentDTMforTableHeaderAMT(Loop inLoop)  throws OBOEException
{
...
/** builds segment PCT that is part of the TableHeaderAMT
*<br>Percent Amounts used 
*<br>To qualify percent amounts and supply percent amounts
* @param inLoop loop containing this segment
* @return segment object PCT
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentPCTforTableHeaderAMT(Loop inLoop)  throws OBOEException
{
...
/** builds loop FA1 that is part of the TableHeaderAMT
*<br>Type of Financial Accounting Data used 
* @param inLoop loop
* @return loop object FA1
* @throws OBOEException - most likely segment not found
*/
public Loop buildLoopFA1forTableHeaderAMT(Loop inLoop)  throws OBOEException
{
  Loop loop = inLoop.createLoop("FA1");
  inLoop.addLoop(loop);
  buildSegmentFA1forTableHeaderAMTFA1(loop);
  buildSegmentFA2forTableHeaderAMTFA1(loop);
  return loop;
  }
/** builds segment FA1 that is part of the TableHeaderAMTFA1
*<br>Type of Financial Accounting Data used 
...
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentFA1forTableHeaderAMTFA1(Loop inLoop)  throws OBOEException
{
...
/** builds segment FA2 that is part of the TableHeaderAMTFA1
...
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentFA2forTableHeaderAMTFA1(Loop inLoop)  throws OBOEException
{
...
/** builds loop SPI that is part of the TableHeader
*<br>Specification Identifier used 
* @param inTable table containing this segment
* @return loop object SPI
* @throws OBOEException - most likely segment not found
*/
public Loop buildLoopSPIforTableHeader(Table inTable)
  throws OBOEException
{
  Loop loop = inTable.createLoop("SPI");
  inTable.addLoop(loop);
  buildSegmentSPIforTableHeaderSPI(loop);
  buildSegmentREFforTableHeaderSPI(loop);
  buildSegmentDTMforTableHeaderSPI(loop);
  buildSegmentMSGforTableHeaderSPI(loop);
  buildLoopN1forTableHeaderSPI(loop);
  buildLoopCB1forTableHeaderSPI(loop);
  return loop;
  }
/** builds segment SPI that is part of the TableHeaderSPI
*<br>Specification Identifier used 
*<br>To provide a description of the included specification or technical data items
* @param inLoop loop containing this segment
* @return segment object SPI
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentSPIforTableHeaderSPI(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("SPI");
  inLoop.addSegment(segment);
  DataElement de;
  de = (DataElement) segment.buildDE(1);  // 786 Security Level Code
 de.set("");
  de = (DataElement) segment.buildDE(2);  // 128 Reference Identification Qualifier
  //de.set("");//not required
  de = (DataElement) segment.buildDE(3);  // 127 Reference Identification
  //de.set("");//not required
  de = (DataElement) segment.buildDE(4);  // 790 Entity Title
  //de.set("");//not required
  de = (DataElement) segment.buildDE(5);  // 791 Entity Purpose
  //de.set("");//not required
  de = (DataElement) segment.buildDE(6);  // 792 Entity Status Code
  //de.set("");//not required
  de = (DataElement) segment.buildDE(7);  // 353 Transaction Set Purpose Code
  //de.set("");//not required
  de = (DataElement) segment.buildDE(8);  // 755 Report Type Code
  //de.set("");//not required
  de = (DataElement) segment.buildDE(9);  // 786 Security Level Code
  //de.set("");//not required
  de = (DataElement) segment.buildDE(10);  // 559 Agency Qualifier Code
  //de.set("");//not required
  de = (DataElement) segment.buildDE(11);  // 822 Source Subqualifier
  //de.set("");//not required
  de = (DataElement) segment.buildDE(12);  // 554 Assigned Number
  //de.set("");//not required
  de = (DataElement) segment.buildDE(13);  // 1322 Certification Type Code
  //de.set("");//not required
  de = (DataElement) segment.buildDE(14);  // 1401 Proposal Data Detail Identifier Code
  //de.set("");//not required
  de = (DataElement) segment.buildDE(15);  // 1005 Hierarchical Structure Code
  //de.set("");//not required
/* segment.useDefault(); */
  return segment;
  }
/** builds segment REF that is part of the TableHeaderSPI
*<br>Reference Identification used 
*<br>To specify identifying information
* @param inLoop loop containing this segment
* @return segment object REF
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentREFforTableHeaderSPI(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("REF");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment DTM that is part of the TableHeaderSPI
*<br>Date/Time Reference used 
*<br>To specify pertinent dates and times
* @param inLoop loop containing this segment
* @return segment object DTM
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentDTMforTableHeaderSPI(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("DTM");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment MSG that is part of the TableHeaderSPI
*<br>Message Text used 
*<br>To provide a free-form format that allows the transmission of text information
* @param inLoop loop containing this segment
* @return segment object MSG
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentMSGforTableHeaderSPI(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("MSG");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds loop N1 that is part of the TableHeaderSPI
*<br>Name used 
* @param inLoop loop
* @return loop object N1
* @throws OBOEException - most likely segment not found
*/
public Loop buildLoopN1forTableHeaderSPI(Loop inLoop)  throws OBOEException
{
  Loop loop = inLoop.createLoop("N1");
  inLoop.addLoop(loop);
  buildSegmentN1forTableHeaderSPIN1(loop);
  buildSegmentN2forTableHeaderSPIN1(loop);
  buildSegmentN3forTableHeaderSPIN1(loop);
  buildSegmentN4forTableHeaderSPIN1(loop);
  buildSegmentREFforTableHeaderSPIN1(loop);
  buildSegmentG61forTableHeaderSPIN1(loop);
  buildSegmentMSGforTableHeaderSPIN1(loop);
  return loop;
  }
/** builds segment N1 that is part of the TableHeaderSPIN1
*<br>Name used 
*<br>To identify a party by type of organization, name, and code
* @param inLoop loop containing this segment
* @return segment object N1
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentN1forTableHeaderSPIN1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("N1");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment N2 that is part of the TableHeaderSPIN1
*<br>Additional Name Information used 
*<br>To specify additional names or those longer than 35 characters in length
* @param inLoop loop containing this segment
* @return segment object N2
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentN2forTableHeaderSPIN1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("N2");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment N3 that is part of the TableHeaderSPIN1
*<br>Address Information used 
*<br>To specify the location of the named party
* @param inLoop loop containing this segment
* @return segment object N3
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentN3forTableHeaderSPIN1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("N3");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment N4 that is part of the TableHeaderSPIN1
*<br>Geographic Location used 
*<br>To specify the geographic place of the named party
* @param inLoop loop containing this segment
* @return segment object N4
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentN4forTableHeaderSPIN1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("N4");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment REF that is part of the TableHeaderSPIN1
*<br>Reference Identification used 
*<br>To specify identifying information
* @param inLoop loop containing this segment
* @return segment object REF
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentREFforTableHeaderSPIN1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("REF");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment G61 that is part of the TableHeaderSPIN1
*<br>Contact used 
*<br>To identify a person or office to whom communications should be directed
* @param inLoop loop containing this segment
* @return segment object G61
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentG61forTableHeaderSPIN1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("G61");
  inLoop.addSegment(segment);
  DataElement de;
  de = (DataElement) segment.buildDE(1);  // 366 Contact Function Code
 de.set("");
 ...
 de.set("");
  ...
  de = (DataElement) segment.buildDE(4);  // 364 Communication Number
  //de.set("");//not required
  de = (DataElement) segment.buildDE(5);  // 443 Contact Inquiry Reference
  //de.set("");//not required
/* segment.useDefault(); */
  return segment;
  }
/** builds segment MSG that is part of the TableHeaderSPIN1
*<br>Message Text used 
*<br>To provide a free-form format that allows the transmission of text information
* @param inLoop loop containing this segment
* @return segment object MSG
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentMSGforTableHeaderSPIN1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("MSG");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds loop CB1 that is part of the TableHeaderSPI
*<br>Contract and Cost Accounting Standards Data used 
* @param inLoop loop
* @return loop object CB1
* @throws OBOEException - most likely segment not found
*/
public Loop buildLoopCB1forTableHeaderSPI(Loop inLoop)  throws OBOEException
{
  Loop loop = inLoop.createLoop("CB1");
  inLoop.addLoop(loop);
  buildSegmentCB1forTableHeaderSPICB1(loop);
  buildSegmentREFforTableHeaderSPICB1(loop);
  buildSegmentDTMforTableHeaderSPICB1(loop);
  buildSegmentLDTforTableHeaderSPICB1(loop);
  buildSegmentMSGforTableHeaderSPICB1(loop);
  return loop;
  }
/** builds segment CB1 that is part of the TableHeaderSPICB1
*<br>Contract and Cost Accounting Standards Data used 
*<br>To specify contract and cost accounting standards data
* @param inLoop loop containing this segment
* @return segment object CB1
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentCB1forTableHeaderSPICB1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("CB1");
  inLoop.addSegment(segment);
  DataElement de;
  de = (DataElement) segment.buildDE(1);  // 1309 Acquisition Data Code
 de.set("");
  de = (DataElement) segment.buildDE(2);  // 1310 Financing Type Code
  //de.set("");//not required
/* segment.useDefault(); */
  return segment;
  }
/** builds segment REF that is part of the TableHeaderSPICB1
*<br>Reference Identification used 
*<br>To specify identifying information
* @param inLoop loop containing this segment
* @return segment object REF
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentREFforTableHeaderSPICB1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("REF");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment DTM that is part of the TableHeaderSPICB1
*<br>Date/Time Reference used 
*<br>To specify pertinent dates and times
* @param inLoop loop containing this segment
* @return segment object DTM
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentDTMforTableHeaderSPICB1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("DTM");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment LDT that is part of the TableHeaderSPICB1
*<br>Lead Time used 
*<br>To specify lead time for availability of products and services
* @param inLoop loop containing this segment
* @return segment object LDT
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentLDTforTableHeaderSPICB1(Loop inLoop)  throws OBOEException
{
...
/** builds segment MSG that is part of the TableHeaderSPICB1
*<br>Message Text used 
*<br>To provide a free-form format that allows the transmission of text information
* @param inLoop loop containing this segment
* @return segment object MSG
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentMSGforTableHeaderSPICB1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("MSG");
  inLoop.addSegment(segment);
  DataElement de;
  ...
  throws OBOEException
{
  ...
  buildSegmentCN1forTableDetailPO1(loop);
  buildSegmentPO3forTableDetailPO1(loop);
  buildLoopCTPforTableDetailPO1(loop);
  ...
  buildSegmentIT3forTableDetailPO1(loop);
  buildSegmentDTMforTableDetailPO1(loop);
  buildSegmentTC2forTableDetailPO1(loop);
  ...
  buildSegmentPCTforTableDetailPO1(loop);
  buildSegmentMANforTableDetailPO1(loop);
  buildSegmentMSGforTableDetailPO1(loop);
  buildSegmentSPIforTableDetailPO1(loop);
  ...
  buildSegmentLSforTableDetailPO1(loop);
  buildLoopLDTforTableDetailPO1(loop);
  buildSegmentLEforTableDetailPO1(loop);
  buildLoopN9forTableDetailPO1(loop);
  buildLoopN1forTableDetailPO1(loop);
  buildLoopSLNforTableDetailPO1(loop);
  buildLoopAMTforTableDetailPO1(loop);
  buildLoopLMforTableDetailPO1(loop);
  return loop;
  }
...
/** builds segment CN1 that is part of the TableDetailPO1
*<br>Contract Information used 
*<br>To specify basic data about the contract or contract line item
* @param inLoop loop containing this segment
* @return segment object CN1
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentCN1forTableDetailPO1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("CN1");
  inLoop.addSegment(segment);
  DataElement de;
  de = (DataElement) segment.buildDE(1);  // 1166 Contract Type Code
 de.set("");
  de = (DataElement) segment.buildDE(2);  // 782 Monetary Amount
  //de.set("");//not required
  de = (DataElement) segment.buildDE(3);  // 332 Percent
  //de.set("");//not required
  de = (DataElement) segment.buildDE(4);  // 127 Reference Identification
  //de.set("");//not required
  de = (DataElement) segment.buildDE(5);  // 338 Terms Discount Percent
  //de.set("");//not required
  de = (DataElement) segment.buildDE(6);  // 799 Version Identifier
  //de.set("");//not required
/* segment.useDefault(); */
  return segment;
  }
...
/** builds loop CTP that is part of the TableDetailPO1
*<br>Pricing Information used 
* @param inLoop loop
* @return loop object CTP
* @throws OBOEException - most likely segment not found
*/
public Loop buildLoopCTPforTableDetailPO1(Loop inLoop)  throws OBOEException
{
  Loop loop = inLoop.createLoop("CTP");
  inLoop.addLoop(loop);
  buildSegmentCTPforTableDetailPO1CTP(loop);
  buildSegmentCURforTableDetailPO1CTP(loop);
  return loop;
  }
/** builds segment CTP that is part of the TableDetailPO1CTP
*<br>Pricing Information used 
*<br>To specify pricing information
* @param inLoop loop containing this segment
* @return segment object CTP
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentCTPforTableDetailPO1CTP(Loop inLoop)  throws OBOEException
{
...
/** builds segment CUR that is part of the TableDetailPO1CTP
*<br>Currency used 
*<br>To specify the currency (dollars, pounds, francs, etc.) used in a transaction
* @param inLoop loop containing this segment
* @return segment object CUR
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentCURforTableDetailPO1CTP(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("CUR");
  inLoop.addSegment(segment);
  DataElement de;
...
public Loop buildLoopSACforTableDetailPO1(Loop inLoop)  throws OBOEException
{
  ...
  buildSegmentCTPforTableDetailPO1SAC(loop);
  return loop;
  }
...
/** builds segment CTP that is part of the TableDetailPO1SAC
*<br>Pricing Information used 
*<br>To specify pricing information
* @param inLoop loop containing this segment
* @return segment object CTP
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentCTPforTableDetailPO1SAC(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("CTP");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment IT3 that is part of the TableDetailPO1
...
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentIT3forTableDetailPO1(Loop inLoop)  throws OBOEException
{
...
/** builds segment TC2 that is part of the TableDetailPO1
*<br>Commodity used 
*<br>To identify a commodity or a group of commodities or a tariff page commodity
* @param inLoop loop containing this segment
* @return segment object TC2
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentTC2forTableDetailPO1(Loop inLoop)  throws OBOEException
{
...
/** builds segment PCT that is part of the TableDetailPO1
*<br>Percent Amounts used 
*<br>To qualify percent amounts and supply percent amounts
* @param inLoop loop containing this segment
* @return segment object PCT
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentPCTforTableDetailPO1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("PCT");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment MSG that is part of the TableDetailPO1
*<br>Message Text used 
*<br>To provide a free-form format that allows the transmission of text information
* @param inLoop loop containing this segment
* @return segment object MSG
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentMSGforTableDetailPO1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("MSG");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment SPI that is part of the TableDetailPO1
*<br>Specification Identifier used 
*<br>To provide a description of the included specification or technical data items
* @param inLoop loop containing this segment
* @return segment object SPI
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentSPIforTableDetailPO1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("SPI");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment LS that is part of the TableDetailPO1
*<br>Loop Header used 
*<br>To indicate that the next segment begins a loop
* @param inLoop loop containing this segment
* @return segment object LS
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentLSforTableDetailPO1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("LS");
  inLoop.addSegment(segment);
  DataElement de;
  de = (DataElement) segment.buildDE(1);  // 447 Loop Identifier Code
 de.set("");
/* segment.useDefault(); */
  return segment;
  }
/** builds loop LDT that is part of the TableDetailPO1
*<br>Lead Time used 
* @param inLoop loop
* @return loop object LDT
* @throws OBOEException - most likely segment not found
*/
public Loop buildLoopLDTforTableDetailPO1(Loop inLoop)  throws OBOEException
{
  Loop loop = inLoop.createLoop("LDT");
  inLoop.addLoop(loop);
  buildSegmentLDTforTableDetailPO1LDT(loop);
  buildSegmentQTYforTableDetailPO1LDT(loop);
  buildSegmentMSGforTableDetailPO1LDT(loop);
  buildSegmentREFforTableDetailPO1LDT(loop);
  buildLoopLMforTableDetailPO1LDT(loop);
  return loop;
  }
/** builds segment LDT that is part of the TableDetailPO1LDT
*<br>Lead Time used 
*<br>To specify lead time for availability of products and services
* @param inLoop loop containing this segment
* @return segment object LDT
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentLDTforTableDetailPO1LDT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("LDT");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment QTY that is part of the TableDetailPO1LDT
*<br>Quantity used 
*<br>To specify quantity information
* @param inLoop loop containing this segment
* @return segment object QTY
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentQTYforTableDetailPO1LDT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("QTY");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment MSG that is part of the TableDetailPO1LDT
*<br>Message Text used 
*<br>To provide a free-form format that allows the transmission of text information
* @param inLoop loop containing this segment
* @return segment object MSG
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentMSGforTableDetailPO1LDT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("MSG");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment REF that is part of the TableDetailPO1LDT
*<br>Reference Identification used 
*<br>To specify identifying information
* @param inLoop loop containing this segment
* @return segment object REF
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentREFforTableDetailPO1LDT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("REF");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds loop LM that is part of the TableDetailPO1LDT
*<br>Code Source Information used 
* @param inLoop loop
* @return loop object LM
* @throws OBOEException - most likely segment not found
*/
public Loop buildLoopLMforTableDetailPO1LDT(Loop inLoop)  throws OBOEException
{
  Loop loop = inLoop.createLoop("LM");
  inLoop.addLoop(loop);
  buildSegmentLMforTableDetailPO1LDTLM(loop);
  buildSegmentLQforTableDetailPO1LDTLM(loop);
  return loop;
  }
/** builds segment LM that is part of the TableDetailPO1LDTLM
*<br>Code Source Information used 
*<br>To transmit standard code list identification information
* @param inLoop loop containing this segment
* @return segment object LM
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentLMforTableDetailPO1LDTLM(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("LM");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment LQ that is part of the TableDetailPO1LDTLM
*<br>Industry Code used 
*<br>Code to transmit standard industry codes
* @param inLoop loop containing this segment
* @return segment object LQ
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentLQforTableDetailPO1LDTLM(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("LQ");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment LE that is part of the TableDetailPO1
*<br>Loop Trailer used 
*<br>To indicate that the loop immediately preceding this segment is complete
* @param inLoop loop containing this segment
* @return segment object LE
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentLEforTableDetailPO1(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("LE");
  inLoop.addSegment(segment);
  DataElement de;
  de = (DataElement) segment.buildDE(1);  // 447 Loop Identifier Code
 de.set("");
...
public Loop buildLoopN9forTableDetailPO1(Loop inLoop)  throws OBOEException
{
  ...
  buildSegmentMEAforTableDetailPO1N9(loop);
...
/** builds segment MEA that is part of the TableDetailPO1N9
*<br>Measurements used 
*<br>To specify physical measurements or counts, including dimensions, tolerances, variances, and weights  (See Figures Appendix for example of use of C001)
* @param inLoop loop containing this segment
* @return segment object MEA
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentMEAforTableDetailPO1N9(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("MEA");
  inLoop.addSegment(segment);
  DataElement de;
...
public Loop buildLoopN1forTableDetailPO1(Loop inLoop)  throws OBOEException
{
  ...
  buildLoopLDTforTableDetailPO1N1(loop);
  return loop;
  }
...
/** builds loop LDT that is part of the TableDetailPO1N1
*<br>Lead Time used 
* @param inLoop loop
* @return loop object LDT
* @throws OBOEException - most likely segment not found
*/
public Loop buildLoopLDTforTableDetailPO1N1(Loop inLoop)  throws OBOEException
{
  Loop loop = inLoop.createLoop("LDT");
  inLoop.addLoop(loop);
  buildSegmentLDTforTableDetailPO1N1LDT(loop);
  buildSegmentMANforTableDetailPO1N1LDT(loop);
  buildSegmentQTYforTableDetailPO1N1LDT(loop);
  buildSegmentMSGforTableDetailPO1N1LDT(loop);
  buildSegmentREFforTableDetailPO1N1LDT(loop);
  return loop;
  }
/** builds segment LDT that is part of the TableDetailPO1N1LDT
*<br>Lead Time used 
*<br>To specify lead time for availability of products and services
* @param inLoop loop containing this segment
* @return segment object LDT
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentLDTforTableDetailPO1N1LDT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("LDT");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment MAN that is part of the TableDetailPO1N1LDT
*<br>Marks and Numbers used 
*<br>To indicate identifying marks and numbers for shipping containers
* @param inLoop loop containing this segment
* @return segment object MAN
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentMANforTableDetailPO1N1LDT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("MAN");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment QTY that is part of the TableDetailPO1N1LDT
*<br>Quantity used 
*<br>To specify quantity information
* @param inLoop loop containing this segment
* @return segment object QTY
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentQTYforTableDetailPO1N1LDT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("QTY");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment MSG that is part of the TableDetailPO1N1LDT
*<br>Message Text used 
*<br>To provide a free-form format that allows the transmission of text information
* @param inLoop loop containing this segment
* @return segment object MSG
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentMSGforTableDetailPO1N1LDT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("MSG");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment REF that is part of the TableDetailPO1N1LDT
*<br>Reference Identification used 
*<br>To specify identifying information
* @param inLoop loop containing this segment
* @return segment object REF
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentREFforTableDetailPO1N1LDT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("REF");
  inLoop.addSegment(segment);
  DataElement de;
...
public Loop buildLoopSLNforTableDetailPO1(Loop inLoop)  throws OBOEException
{
  ...
  buildSegmentTC2forTableDetailPO1SLN(loop);
...
/** builds segment TC2 that is part of the TableDetailPO1SLN
*<br>Commodity used 
*<br>To identify a commodity or a group of commodities or a tariff page commodity
* @param inLoop loop containing this segment
* @return segment object TC2
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentTC2forTableDetailPO1SLN(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("TC2");
  inLoop.addSegment(segment);
  DataElement de;
...
public Loop buildLoopSACforTableDetailPO1SLN(Loop inLoop)  throws OBOEException
{
  ...
  buildSegmentCTPforTableDetailPO1SLNSAC(loop);
  return loop;
  }
...
/** builds segment CTP that is part of the TableDetailPO1SLNSAC
*<br>Pricing Information used 
*<br>To specify pricing information
* @param inLoop loop containing this segment
* @return segment object CTP
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentCTPforTableDetailPO1SLNSAC(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("CTP");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds loop AMT that is part of the TableDetailPO1
*<br>Monetary Amount used 
* @param inLoop loop
* @return loop object AMT
* @throws OBOEException - most likely segment not found
*/
public Loop buildLoopAMTforTableDetailPO1(Loop inLoop)  throws OBOEException
{
  Loop loop = inLoop.createLoop("AMT");
  inLoop.addLoop(loop);
  buildSegmentAMTforTableDetailPO1AMT(loop);
  buildSegmentREFforTableDetailPO1AMT(loop);
  buildSegmentPCTforTableDetailPO1AMT(loop);
  return loop;
  }
/** builds segment AMT that is part of the TableDetailPO1AMT
*<br>Monetary Amount used 
*<br>To indicate the total monetary amount
* @param inLoop loop containing this segment
* @return segment object AMT
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentAMTforTableDetailPO1AMT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("AMT");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment REF that is part of the TableDetailPO1AMT
*<br>Reference Identification used 
*<br>To specify identifying information
* @param inLoop loop containing this segment
* @return segment object REF
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentREFforTableDetailPO1AMT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("REF");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment PCT that is part of the TableDetailPO1AMT
*<br>Percent Amounts used 
*<br>To qualify percent amounts and supply percent amounts
* @param inLoop loop containing this segment
* @return segment object PCT
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentPCTforTableDetailPO1AMT(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("PCT");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds loop LM that is part of the TableDetailPO1
*<br>Code Source Information used 
* @param inLoop loop
* @return loop object LM
* @throws OBOEException - most likely segment not found
*/
public Loop buildLoopLMforTableDetailPO1(Loop inLoop)  throws OBOEException
{
  Loop loop = inLoop.createLoop("LM");
  inLoop.addLoop(loop);
  buildSegmentLMforTableDetailPO1LM(loop);
  buildSegmentLQforTableDetailPO1LM(loop);
  return loop;
  }
/** builds segment LM that is part of the TableDetailPO1LM
*<br>Code Source Information used 
*<br>To transmit standard code list identification information
* @param inLoop loop containing this segment
* @return segment object LM
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentLMforTableDetailPO1LM(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("LM");
  inLoop.addSegment(segment);
  DataElement de;
...
/** builds segment LQ that is part of the TableDetailPO1LM
*<br>Industry Code used 
*<br>Code to transmit standard industry codes
* @param inLoop loop containing this segment
* @return segment object LQ
* @throws OBOEException - most likely segment not found
*/
public Segment buildSegmentLQforTableDetailPO1LM(Loop inLoop)  throws OBOEException
{
  Segment segment = inLoop.createSegment("LQ");
  inLoop.addSegment(segment);
  DataElement de;
