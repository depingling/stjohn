...
<jsp:include flush='true' page="<%=t_templatorToolBar%>" >
   ...
   <jsp:param name="tabs01"  value="proceduresToolBar"/>
   <jsp:param name="display01"  value="procedures"/>
   <jsp:param name="toolLable01" value="template.jd.bsc.menu.procedures"/>
