...
<span class="wkrule">
If&nbsp;User&nbsp;Order&nbsp;Total&nbsp;>=<br>
<html:text name="STORE_WORKFLOW_DETAIL_FORM" property="totalValue" size="5"/>
within these number of days: &nbsp;
<html:text name="STORE_WORKFLOW_DETAIL_FORM" property="totalExp" size="5"/>
<br>
Then&nbsp;
