...
import com.cleanwise.view.logic.ItemMgrLocateLogic;
 ...
 *@created    Feb 04, 2002
 */
public final class ItemMgrLocateAction extends ActionSuper {
	...
	String createStr = getMessage(mr,request,"admin.button.create");
        ...
        try {
            ...
            if (action.equals("init")) {
                ItemMgrLocateLogic.init(request, form);
                return (mapping.findForward("success"));
            }
            else if (action.equals(searchStr)) {
                ItemMgrLocateLogic.searchForItem(request,form);
                return (mapping.findForward("success"));
            }
            else if (action.equals("sort")) {
                ItemMgrLocateLogic.sort(request, form);
                return (mapping.findForward("success"));
            }
            else {
                ItemMgrLocateLogic.init(request, form);
