...
<table ID=1228 cellspacing="0" border="0" width="769"  class="mainbody">
<tr>
<td><b>Site&nbsp;Id:</b></td>
...
<html:form styleId="1229" action="/storeportal/sitenote.do">
...
<table ID=1230 cellspacing="0" border="0" width="769"  class="results">
<% 
...
<% 
 for(Iterator iter = topics.iterator(); iter.hasNext();) {
   ...
   if(topicId!=topicToEditId) {
     String topicLink = "sitenote.do?action=loadTopic&topicId="+propD.getPropertyId();
     String delLink = "sitenote.do?action=deleteTopic&topicId="+propD.getPropertyId();
     String editLink = "sitenote.do?action=editTopic&topicToEditId="+propD.getPropertyId();
     String topicName = propD.getValue();
     String topicIdS = ""+topicId;
   
%>
<tr>
<td><a ID=1231 href="<%=topicLink%>"><%=topicName%></a> </td>
<td><a ID=1232 href="<%=editLink%>">[Edit]</a>&nbsp;<a ID=1233 href="<%=delLink%>">[Delete]</a> </td>
</tr>
<%} else {%>
<tr>
