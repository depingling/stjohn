...
<table width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>
            <html:form name="USER_WORK_ORDER_NOTE_MGR_FORM" action="/userportal/userWorkOrderNote.do" scope="session">
                ...
                <html:hidden property="display" value="t_userWorkOrderNoteDetail"/>
