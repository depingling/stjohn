...
<tr>
  ...
  <tr><td>&nbsp;</td></tr>
  <logic:present name="CHECKOUT_FORM" property="warningMessages">
  <bean:size id="messageCount" name="CHECKOUT_FORM" property="warningMessages"/>
  <logic:greaterThan name="messageCount" value="0">
	  <tr>
	    <td colspan="3" style="font-weight: bold"><font color="red">
	    <logic:iterate id="warningMessage" name="CHECKOUT_FORM" property="warningMessages" >
            <bean:write name="warningMessage"/><br>
        </logic:iterate>
	    </font>
	    </td>
	  </tr>
