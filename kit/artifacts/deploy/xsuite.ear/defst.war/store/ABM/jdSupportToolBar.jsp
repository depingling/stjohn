...
<bean:define id="toolLink01"  value=""/>
<bean:define id="toolLable01" value=""/>
<bean:define id="toolSecondaryToolBar01" value=""/>

<bean:define id="toolLink02"  value=""/>
<bean:define id="toolLable02" value=""/>
...
<bean:define id="headerLabel" value="template.jd.bsc.heading.jdSupport"/>
