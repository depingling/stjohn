...
<head>
<title>Operations Store Admin Home: PurchaseOrders</title>
...
<html:form name="PO_OP_DETAIL_FORM" action="/storeportal/storePurchaseOrderMgrOpDetail.do"
        ...
        <tr valign="top">
                <td colspan="2">
                        <table width="100%">
                            <tr valign="top">
                                <td><b>Web Order#:</b></td>
                                <td><bean:write name="PO_OP_DETAIL_FORM" property="purchaseOrderStatusDescDataView.orderData.orderNum" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><b>ERP Order#:</b></td>
                                <td><bean:write name="PO_OP_DETAIL_FORM" property="purchaseOrderStatusDescDataView.orderData.erpOrderNum" filter="true"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><b>Method:</b></td>
                                <td><bean:write name="PO_OP_DETAIL_FORM" property="purchaseOrderStatusDescDataView.orderData.orderSourceCd" filter="true"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><bean:write name="PO_OP_DETAIL_FORM" property="purchaseOrderStatusDescDataView.orderData.orderContactEmail" filter="true"/></td>
                            </tr>
...
<td colspan='2' class="order_status_addr"> 
  ...
  <table ID=311>
<%
	OrderAddOnChargeDataVector charges = purchaseOrderStatusDescDataView.getOrderAddOnChargeDataVector();	
	BigDecimal totalCharges = new BigDecimal(0);
	if(charges!=null) {
		for(Iterator iter = charges.iterator(); iter.hasNext(); ) {
		
			OrderAddOnChargeData addOnCharge = (OrderAddOnChargeData)iter.next();
			String name = addOnCharge.getDistFeeChargeCd();
			String value = addOnCharge.getAmount().toString();
			totalCharges = totalCharges.add(addOnCharge.getAmount());
%>
<tr>
<td><b> <%=name%>: </b></td>
<td> <%=value%> </td>
...
<i18n:formatCurrency value="<%=orderTotal%>" locale="<%=Locale.US%>"/>
    ...
    <tr>
          <td colspan="6" align="center">
            <input type="button" onclick="popLink('storeOrderOpNote.do?action=view&orderid=<%=orderId%>&src=po');" value="View All Order Detail Notes" >
        ...
        &nbsp;<input type="button" onclick="popPrint('storePurchaseOrderMgrOpDetail.do?action=print');" value="Print PO Detail"></td>
          </td>
        </tr>
        </table>
<table border="0" cellpadding="1" cellspacing="0" width="769" class="mainbody">
        ...
        <td colspan="2">
                    ...
                    <td>&nbsp;</td>
                        ...
                        <bean:define id="taxTotal"  name="PO_OP_DETAIL_FORM" property="purchaseOrderStatusDescDataView.purchaseOrderData.taxTotal"/>
                                        <i18n:formatCurrency value="<%=taxTotal%>" locale="<%=Locale.US%>"/>
                                </td>
                                </tr>
								</logic:present>
                <tr>
                        ...
                        <bean:define id="purchaseOrderTotal"  name="PO_OP_DETAIL_FORM" property="purchaseOrderStatusDescDataView.purchaseOrderData.purchaseOrderTotal"/>
										...
										<%
										BigDecimal poTotal = ((BigDecimal)purchaseOrderTotal).add(totalCharges);
										%>
										<i18n:formatCurrency value="<%=poTotal%>" locale="<%=Locale.US%>"/>
                                </td>
                                </tr>
                        </table>
                </td>
