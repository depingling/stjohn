...
<%String submitUrl =submitBase+"?action=showDoc";%>
  ...
  <tr>
  <td colspan="6" class="msdscharthead"><div class="fivemargin">
  ...
  <logic:iterate id="item" name="MSDS_FORM" property="cartItems"
   indexId="kkk" type="com.cleanwise.service.api.value.ShoppingCartItemData">
     ...
     <% if(theForm.isCategoryChanged(((Integer)kkk).intValue())) { %>
       <tr>
       <td class="shopcategory" colspan = "6"><bean:write name="item" property="categoryPath"/></td>
       </tr>
     <% } %>
     <% } %>
...
%>                                    
 ...
 %>
  ...
  <tr>
  <td colspan="6" class="msdscharthead" align="center">&nbsp</td>
  </tr>
</table>
</td></tr>
<tr><td>  
<table align="center" border="0" cellpadding="0" cellspacing="0" width="98%">
  ...
  <td class="smalltext" valign="up" width="70%">
   ...
   <tr><td><jsp:include flush='true' page='<%=ClwCustomizer.getStoreFilePath(request,"t_msdsMsdsList.jsp")%>'/></td></tr>
   <tr><td>&nbsp;</td></tr>
   <tr><td><jsp:include flush='true' page='<%=ClwCustomizer.getStoreFilePath(request,"t_msdsSpecList.jsp")%>'/></td></tr>
   <tr><td>&nbsp;</td></tr>
   <tr><td><jsp:include flush='true' page='<%=ClwCustomizer.getStoreFilePath(request,"t_msdsDedList.jsp")%>'/></td></tr>
   </table>
  </td>
  </tr>
</table>
