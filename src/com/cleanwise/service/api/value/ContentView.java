...
/**
 * <code>ContentView</code> is a ViewObject class for UI.
 */
public class ContentView
extends ValueObject
{
   
    private static final long serialVersionUID = -4194704968286227807L;
     ...
     * Constructor. 
     */
    public ContentView(int parm1, int parm2, int parm3, String parm4, Date parm5, String parm6, String parm7, String parm8, Date parm9, Date parm10, String parm11, String parm12, String parm13, String parm14, Date parm15, String parm16, String parm17, String parm18, int parm19)
    {
        mBusEntityId = parm1;
        mContentId = parm2;
        mItemId = parm3;
     ...
     *
     * @return
     *  Newly initialized ContentView object.
     */
    public static ContentView createValue () 
    {
        ContentView valueView = new ContentView();
     ...
     *
     * @return
     *  The String representation of this ContentView object
     */
    public String toString()
    {
        return "[" + "BusEntityId=" + mBusEntityId + ", ContentId=" + mContentId + ", ItemId=" + mItemId + ", AddBy=" + mAddBy + ", AddDate=" + mAddDate + ", ContentStatusCd=" + mContentStatusCd + ", ContentTypeCd=" + mContentTypeCd + ", ContentUsageCd=" + mContentUsageCd + ", EffDate=" + mEffDate + ", ExpDate=" + mExpDate + ", LanguageCd=" + mLanguageCd + ", LocaleCd=" + mLocaleCd + ", LongDesc=" + mLongDesc + ", ModBy=" + mModBy + ", ModDate=" + mModDate + ", Path=" + mPath + ", ShortDesc=" + mShortDesc + ", SourceCd=" + mSourceCd + ", Version=" + mVersion + "]";
    }
    ...
    */
    public ContentView copy()  {
      ContentView obj = new ContentView();
