/*
 * PdfPurchaseOrderMyFax1.java
 *
 * Created on February 20, 2009, 5:36 PM
 */

package com.cleanwise.service.apps.dataexchange;
//import com.cleanwise.view.utils.DisplayListSort; // SVC
 ...
 *proprietary objects, and uses them to construct a purchase order document.
 * @author  bstevens
 */
public class PdfPurchaseOrderMyFax1 extends PdfSuperMyFax1 {
  ...
  */
  ...
  m1.append(", Conf # " + p850.getOrderD().getOrderNum());
    ...
    String pErpPoNumber, int pPageNumber,Locale pLocale, PdfPoStruct p850)
    throws DocumentException {
    ...
    throws IOException{
        ...
        for(int i=0,len=p850s.size();i<len;i++){
            ...
            PdfPurchaseOrderMyFax1.PdfPoStruct po =
            new PdfPurchaseOrderMyFax1.PdfPoStruct
                (ediReq.getOrderD(),
    ...
    throws IOException{
        ...
        lpo.add(new PdfPurchaseOrderMyFax1.PdfPoStruct
                (pOrderData,
    ...
    throws IOException{
        ...
        try{
            ...
            for (int j=0,len2=p850s.size();j<len2;j++){
                ...
                DisplayListSortMyFax.sort(l850.getOrderItemDV(),"erpPoLineNum");
                ...
                //creates the trailer
                Table trailer = makePoTrailer(document,lErpPoNumber, pageNumber,lLocale,l850);
                ...
                if (writer.fitsPage(trailer)){
                    ...
                    trailer = makePoTrailer(document,lErpPoNumber, pageNumber,lLocale,l850);
                    document.add(trailer);
                }
