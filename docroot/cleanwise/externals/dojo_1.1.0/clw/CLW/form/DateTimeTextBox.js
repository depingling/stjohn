if(!dojo._hasResource["clw.CLW.form.DateTimeTextBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["clw.CLW.form.DateTimeTextBox"] = true;
 dojo.provide("clw.CLW.form.DateTimeTextBox");
    ...
    dojo.declare("clw.CLW.form.DateTimeTextBox",
            dijit._Widget, {
        ...
        postCreate: function() {
            ...
            if (this.targetNodeIds &&
                ...
                if (this.targetNodeIds.length > 1) {
                    console.warn("[clw.CLW.form.DateTimeTextBox.postCreate] => Multiple targets found.Targets: " + this.targetNodeIds)
                    console.warn("[clw.CLW.form.DateTimeTextBox.postCreate] => Targets will be corrected to : " + this.targetNodeIds[0])
        ...
        _onKeyPress: function(/*Event*/e) {
            if (clw.CLW.form.DateTimeTextBox.superclass._onKeyPress.apply(this, arguments)) {
