...
<html:form name="PROFILING_MGR_FORM" action="adminportal/sitemgrProfilingDetail.do" type="com.cleanwise.view.forms.ProfilingMgrSurveyForm">
<tr><td colspan="6" align="center">&nbsp;</td></tr>
<tr>
        <td><b>Survey Id:</b></td>
        <td><bean:write name="PROFILING_MGR_FORM" property="profile.profileView.profileData.profileId"/></td>
        <td><b>Survey Name:</b></td>
        <td colspan="2"><bean:write name="PROFILING_MGR_FORM" property="profile.profileView.profileData.shortDesc"/></td>
        <td><b>Help Text:</b></td>
        <td colspan="2"><bean:write name="PROFILING_MGR_FORM" property="profile.profileView.profileData.helpText"/></td>
</tr>
<tr>
        <td colspan="6">
           <table>
                ...
                %>
                <app:ProfilingSurvey form="PROFILING_MGR_FORM" name="profile" renderHiddenNumberDependants="10"
