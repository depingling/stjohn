...
<html:form action="/adminportal/distNoteMgr.do" enctype="multipart/form-data">
...
<tr>
<td><b>Title: </b>
<html:text size='80' name="DIST_NOTE_MGR_FORM" property="note.note.title"/></td>
</tr>
<% } %>
<% 
...
<td><html:multibox name="DIST_NOTE_MGR_FORM" property="selectorBox" value="<%=noteTextIdS%>" /></td>
</tr>
<tr><td colspan='3'>&nbsp</td>
</tr>
<% } else { %>
<tr><td colspan='3'>
<html:textarea cols='80' rows='10' name="DIST_NOTE_MGR_FORM" property="paragraph.noteText"/>
</td>
</tr>
<% } %>
<% }} %>
...
<td><html:multibox name="DIST_NOTE_MGR_FORM" property="attachSelectBox" value="<%=fileName%>" /></td>
</tr>
...
<tr><td colspan='3'>
<b>Add Attachment: </b>
       <html:file name="DIST_NOTE_MGR_FORM" property="attachFile" size="80"/>
