...
<% if (!f_paymetricsCC) {
 ...
 %>
  <td>
    <a href="#" class="linkButton" onclick="setAndSubmit('CHECKOUT_FORM','command','<%=placeOrderAction%>');"
...
<td>
    <a href="#" class="linkButton" onclick="setAndSubmit('CHECKOUT_FORM','command','orderSelected');"
    ><img src='<%=IMGPath + "/b_placeorder.gif"%>' border="0"/><app:storeMessage key="global.label.orderSelected"/></a>
    <a href="#" class="linkButton" onclick="setAndSubmit('CHECKOUT_FORM','command','placeOrderForAll');"
    ><img src='<%=IMGPath + "/b_placeorder.gif"%>' border="0"/><app:storeMessage key="global.label.placeOrderForAll"/></a>
</td>
<%
  } else {
