...
<html:form name="ORDER_OP_DETAIL_FORM" action="/console/orderOpDetailPrint.do"
        ...
        <tr>
                <td colspan="6">&nbsp;
                        <bean:define id="orderId" name="ORDER_OP_DETAIL_FORM" property="orderStatusDetail.orderDetail.orderId" />
                </td>
        </tr>
        ...
        <tr valign="top">
                <td colspan="2">
                        <table width="100%">
                                <tr valign="top">
                                <td><b>Web Order#:</b></td>
                                <td><bean:write name="ORDER_OP_DETAIL_FORM" property="orderStatusDetail.orderDetail.orderNum" filter="true"/>
                                        </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                <td><b>Method:</b></td>
                                <td><bean:write name="ORDER_OP_DETAIL_FORM" property="orderStatusDetail.orderDetail.orderSourceCd" filter="true"/>
                                </td>
                                </tr>
                                <tr>
...
<logic:present name="ORDER_OP_DETAIL_FORM" property="orderStatusDetail.referenceNumList" >
<logic:iterate id="refele" name="ORDER_OP_DETAIL_FORM" property="orderStatusDetail.referenceNumList" scope="session" type="com.cleanwise.service.api.value.OrderPropertyData">
<tr>
...
<jsp:include flush='true' page="f_orderCharges.jsp">
  <jsp:param name="allowEdits" value="false" />
      ...
      <td colspan="6">
                <%int index = 1;%>
        <logic:iterate id="note" indexId="i" name="ORDER_OP_DETAIL_FORM" property="orderPropertyList" scope="session" type="com.cleanwise.service.api.value.OrderPropertyData">
...
<tr>
<td><b>Line&nbsp;#</b></td>
<td class="resultscolumna"><b><a href="orderOpDetail.do?action=sortitems&sortField=distOrderNum">Dist Order#</b></td>
<td><b><a href="orderOpDetail.do?action=sortitems&sortField=outboundPoNum">
Outbound PO#</b></td>
<td class="resultscolumna"><b><a href="orderOpDetail.do?action=sortitems&sortField=cwSKU">CW SKU#</b></td>
<td><b><a href="orderOpDetail.do?action=sortitems&sortField=distSKU">Dist SKU#</b></td>
<td class="resultscolumna"><b>Dist Name</b></td>
<td><b><a href="orderOpDetail.do?action=sortitems&sortField=name">Product Name</b></td>
...
<logic:iterate id="itemele" indexId="i" name="ORDER_OP_DETAIL_FORM" property="orderItemDescList" scope="session" type="com.cleanwise.service.api.value.OrderItemDescData">
 ...
 <% String linkHref = new String("orderOpItemDetail.do?action=view&id=" + key);%>
