...
String checkoutFormUrl = ShopTool.getCheckoutFormUrl(request);
checkoutFormUrl=checkoutFormUrl.replace("HTTP_CONTENT_CHARSET=iso-8859-1","HTTP_CONTENT_CHARSET=UTF-8");
%>
