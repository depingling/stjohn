...
public class OutboundRMSOrderlineXpedxPurchaseOrder extends InterchangeOutboundSuper implements OutboundTransaction{
    ...
    public OutboundRMSOrderlineXpedxPurchaseOrder(){
    ...
    throws Exception {
        ...
        String locationCode = "";
        if(currOutboundReq.getDistributorCompanyCode()!=null){
        ...
        if(currOutboundReq.getOrderCreditCard()!=null){
        	String ccType  = currOutboundReq.getOrderCreditCard().getCreditCardType();
        	//Card name/type
        	el = orderEl.addElement("CARDNAME"); // Visa</CARDNAME>
        	setText(el,ccType);

        	String ccNum = currOutboundReq.getCreditCardNumber();
        	//Card number
        	el = orderEl.addElement("RCTNCCRD"); // XXXX XXXX XXXX XXXX</RCTNCCRD>
        	setText(el,ccNum);

        	String ccExpDate = currOutboundReq.getCreditCardExpDate();
        	//Card expiry date
        	el = orderEl.addElement("EXPNDATE"); // 04/02</ccExpDate>
        	setText(el,ccExpDate);

        	el = orderEl.addElement("PYMTTYPE"); // 6</PYMTTYPE>
        	setText(el,"6");

        	el = orderEl.addElement("ACTION"); // 1</ACTION>
        	setText(el,"1");
        }
...
log.info("OutboundRMSOrderlineXpedxPurchaseOrder XXXXXXXXXXXXXXXXXXXXXX no account properties found");
        }
