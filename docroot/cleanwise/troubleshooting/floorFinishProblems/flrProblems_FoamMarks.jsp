...
<span class="subheaders">
  ...
  <tr><!-- question -->
    ...
    <td class="text"><b>Why did foam dry in my finish and how do I fix it?</b></td>
  </tr>
  <tr><!-- horizontal space -->
  ...
  <tr><!-- answer -->
    ...
    <td class="text">
	<p>Foam marks on the floor literally appear as dried foam or small circles in the finish.  This is similar to fish eyes, where craters appear in the finish, but is not as severe.  Foam marks are almost always caused by a procedural error in the daily maintenance so try to pinpoint what has caused the foam marks and train everyone on how to avoid it.  Since this problem can escalate labor and chemical costs it is cost effective to correct the procedure that created the problem.</p>
	The following can cause foam marks:
	   <ul class="text">
	    ...
	    <li class="troubleshootingbullet"><span class="text"><a href="#5"><span class="subheaders">Old finish left on the floor or dried back finish still on the floor</span></a></span></li>
   ...
   <tr>
     ...
     <td><br>
	  ...
	  <li class="troubleshootingbullet"><span class="text"><a name="4"><span class="subheaders">Not completely removing a restorer or dust mop treatment before applying the finish</span></a>
             ...
             <p>Make sure to use a green or blue floor pad when scrubbing the floor.  Red floor pads are not aggressive enough.  In addition, make sure to flip or change the pad often.</p>
             <table align="right"><tr><td align="right" class="text"><div class="searchmargin"><a href="#">[<img src="/<%=storeDir%>/<%=ip%>images/cw_greentop.gif" border="0" WIDTH="6" HEIGHT="6">]&nbsp;Top</a></div></td></tr></table></span></li>
          </ul><br>
	</td>
       </tr>
<tr><!-- horizontal rule -->
   ...
   <tr>
     ...
     <td><br>
         <ul class="text">
	  <li class="troubleshootingbullet"><span class="text"><a name="5"><span class="subheaders">Old finish left on the floor or dried back finish still on the floor</span></a>
		...
		<ol>
                 ...
                 <li class="troubleshootingbullet"><span class="text">Use the recommended dwell time</span></li>
              ...
              Make sure to really flood the floor with the stripping solution to prevent dry back and make sure to keep the floor wet at all times.  If the floor appears to be drying during the dwell time then add more stripping solution to the floor.
