                                ...
                                <div class="left clearfix">
    	    	    	         <logic:present name="userShopForm" property="cartItems">
								   ...
								   <p class="right">
                                    ...
                                    <html:form styleId="shoppingFormId" action="userportal/esw/shopping.do">
	                                ...
	                                <a href="javascript:setFieldsAndSubmitForm('shoppingFormId','operationId','clearQty')" class="blueBtnMed" onclick="return true"><span><app:storeMessage key="global.action.label.clearQuantities" /></span></a>
<%--
                                      <span class="selectNav"><app:storeMessage key="productCatalog.label.select" /> 
                                    <a href="#" class="all"><app:storeMessage key="productCatalog.label.all" /></a> 
                                    <span>|</span> 
                                    <a href="#" class="none"><app:storeMessage key="productCatalog.label.none" /></a>
                                    </span>
 --%>				     <% 
                                    	if (showCorporateOrder && isCorporateOrderOpen) {
					
				     %>			                                      
	                                <a href="javascript:setFieldsAndSubmitForm('shoppingFormId','operationId','addCatalogItemsToCorporateOrder')" class="blueBtnMed" onclick="return true"><span><app:storeMessage key="global.action.label.addToCorporateOrder" /></span></a>
						
				   <%
					} else { 
				   %> 
                                        <a href="javascript:submitForm('shoppingFormId')" class="blueBtnMed" >
	                                        <span><app:storeMessage key="global.action.label.addToShoppingCart" /></span>
                                        </a>
				   <%   }   %>	
                                        <a href="javascript:setFieldsAndSubmitForm('shoppingFormId','operationId','addToExistingShoppingList')" class="blueBtnMed" >
								     ...
								     <%  
										...
										<div class="twoColBox">
											<% if (userShopForm.getAppUser().getUserAccount().isSupportsBudget()) { %>
												...
												<% 
													String catePath = item.getCategoryPathWithLinksForNewUI(request);
												%>
												  <h3><%= catePath%></h3>
												</div>
										 ...
										 <table class="order">
											...
											<%String  catalogItemKeyParam = request.getParameter("catalogItemKey");%>
											<%String catalogItemKey = ""; //((item.getProduct().isItemGroup()&& Utility.isSet(catalogItemKeyParam)) ? "&catalogItemKey="+request.getParameter("catalogItemKey") : "") ;%>
											<%String itemLink = "../../userportal/esw/shopping.do?operation="+operation+"&source=catalog"+catalogItemKey+"&itemId="+itemId  ;%>
