...
public class MobileInfo {
	...
	public static final String skyfire = "skyfire";
     ...
     */
    public MobileInfo(String userAgent, String httpAccept) {
    	this.userAgent = (userAgent != null) ? userAgent.toLowerCase() : "";
    	this.httpAccept = (httpAccept != null) ? httpAccept.toLowerCase() : "";
    }
    public MobileInfo(HttpServletRequest request) {
    	userAgent = request.getHeader("User-Agent");
    	userAgent = (userAgent != null) ? userAgent.toLowerCase() : "";
    	httpAccept = request.getHeader("Accept");
    	httpAccept = (httpAccept != null) ? httpAccept.toLowerCase() : "";
    ...
    public boolean detectSkyfireBrowser() {
        if (userAgent.indexOf(skyfire) >=0) {
			return true;
		}
        return false;
    }
