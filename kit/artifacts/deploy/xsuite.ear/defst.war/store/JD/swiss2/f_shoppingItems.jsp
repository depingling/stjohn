...
%>
  ...
  <%
  showDistInventory = ShopTool.getShowDistInventoryCode(request);
...
%>
        ...
        <%-- checkoutForm.setDiscountAmtPerDist(discountPerDist); --%>
    ...
    <tr>
      ...
      <td class="freighttext">
            <logic:equal name="impliedD" property="freightCriteriaTypeCd" value="<%=RefCodeNames.FREIGHT_CRITERIA_TYPE_CD.ESTIMATE%>">
                ...
                <%=ClwI18nUtil.getPriceShopping(request,handlingAmount,"&nbsp;")%></logic:notEqual>
      </td>
      <td colspan="<%=COL_COUNT-4%>" class="freighttext">&nbsp;</td>
    </tr><%} // checking not equals ZERO%>
    </logic:iterate>
    <%  }
...
%>        <tr>
            ...
            <td class="freighttext">
                ...
                <logic:notEqual name="fuelSurchargeCriteria" property="freightCriteriaTypeCd" value="<%=RefCodeNames.FREIGHT_CRITERIA_TYPE_CD.ESTIMATE%>">
                    <logic:present name="fuelSurchargeCriteria" property="handlingAmount">
                        <%=ClwI18nUtil.getPriceShopping(request, fuelSurchargeAmt, "&nbsp;")%>
                    </logic:present>
                    <logic:notPresent name="fuelSurchargeCriteria" property="handlingAmount">
...
if (Utility.isSet(itemTotal)) {
	Double itemsAmt = new Double(itemTotal); 
%>

	<tr>
  		<td colspan="<%=COL_COUNT%>" class="tableoutline">
  			<img src="/images/cw_spacer.gif" height="3">
  		</td>
  	</tr>
	<tr>
		<td colspan="<%=COL_COUNT-1%>" class="text" align="right">
			<div class="fivemargin">
			    <b><app:storeMessage key="shoppingCart.text.totalExcludingVOC"/></b>
