 ...
 * </ul>
 */
public final class StoreOrderDetailForm extends StorePortalBaseForm {
    ...
    private String mTotalTaxCostStr="";
    ...
    private String _fuelSurchargeStr = null;
    private String _smallOrderFeeStr = null;
    private String _discountStr = null;
    ...
    private boolean mSimpleServiceFlag=false;
    ...
    private String _mNewOrderDate = new String("");
    private boolean _showCancelButton = false;
    private String _mWorkflowInd = new String("");
    private Collection _mWorkflowIndList = null;
    private Collection _mOrderStatusList = null;
    private String _mOrderStatus = new String("");
    private boolean _mApplyBudget = true;
    private boolean _mReBillOrder = false;
    private Collection _mOrderItemStatusList = null;
    private Collection _mPoItemStatusList = null;
    private String _mSiteId = new String("");

    private String _mOrderItemIdToView;

    // ----------------------------------------------------- Properties

    public Collection getPoItemStatusList() {
        return _mPoItemStatusList;
    }
    public void setPoItemStatusList(Collection pPoItemStatusList) {
        this._mPoItemStatusList = pPoItemStatusList;
    }

    public Collection getOrderItemStatusList() {
        return _mOrderItemStatusList;
    }
    public void setOrderItemStatusList(Collection pOrderItemStatusList) {
        this._mOrderItemStatusList = pOrderItemStatusList;
    }

    public boolean getApplyBudget() {
        return (this._mApplyBudget);
    }
    public void setApplyBudget(boolean pApplyBudget) {
        this._mApplyBudget = pApplyBudget;
    }

    public boolean getReBillOrder() {
        return (this._mReBillOrder);
    }
    public void setReBillOrder(boolean pReBillOrder) {
        this._mReBillOrder = pReBillOrder;
    }
    ...
    public void setOrderStatus(String pOrderStatus){
        this._mOrderStatus = pOrderStatus;
    }

    public Collection getOrderStatusList() {
        return _mOrderStatusList;
    }
    public void setOrderStatusList(Collection pOrderStatusList) {
        this._mOrderStatusList = pOrderStatusList;
    }

    public Collection getWorkflowIndList() {
        return _mWorkflowIndList;
    }
    public void setWorkflowIndList(Collection pWorkflowIndList) {
        this._mWorkflowIndList = pWorkflowIndList;
    }

    public String getWorkflowInd(){
        return _mWorkflowInd;
    }
    public void setWorkflowInd(String pWorkflowInd){
        this._mWorkflowInd = pWorkflowInd;
    }

    /**
     * Return the _mNewOrderDate object
     */
    public String getNewOrderDate() {
        return (this._mNewOrderDate);
    }

    /**
     * Set the _mNewOrderDate  object
     */
    public void setNewOrderDate(String pVal) {
        this._mNewOrderDate = pVal;
    }

    /**
     * Return the _showCancelButton object
     */
    ...
    /**
     * Set the _showCancelButton  object
     */
    public void setShowCancelButton(boolean pVal) {
        this._showCancelButton = pVal;
    }
    ...
    public void calculateTotalAmount() {
        ...
        if (_discountAmt != null) {
            double discount = _discountAmt.doubleValue();
            recalct = recalct.add(new BigDecimal((discount > 0) ? -discount : discount));
        }
    ...
    public String getTotalTaxCostStr() {
        return mTotalTaxCostStr;
    }

    public void setTotalTaxCostStr(String totalTaxCostStr) {
        this.mTotalTaxCostStr = totalTaxCostStr;
    }
    ...
    public void reset(ActionMapping mapping, HttpServletRequest request) {
      this._bypassOrderRouting = false;
        ...
        for ( int i = 0; null != this._mOrderItemDescList &&
                  i < this._mOrderItemDescList.size(); i++ )	    {
          OrderItemDescData oid = (OrderItemDescData) this._mOrderItemDescList.get(i);
          oid.setReSale(false);
          oid.setTaxExempt(false);
        }
        this._mApplyBudget = false;
        this._mReBillOrder = false;
  ...
  public void setSimpleServiceFlag(boolean simpleServiceFlag) {
        this.mSimpleServiceFlag = simpleServiceFlag;
    }


    public boolean getSimpleServiceFlag() {
        return mSimpleServiceFlag;
    }
        ...
        public String toString() {
            ...
            if ( mDistName.length() > 1 && mAllowChangeToShipping ) {
                ...
                if ( null != mDistShipOpt ) {
                    ...
                    s+= " <a href=storeOrderDetail.do?action=update_shipping&id="
    ...
    public DistSummary getDistSummary() {
        ...
        for ( int i = 0; null != oiList && i < oiList.size(); i++ )   {
            ...
            if (!oid.getOrderItem().getOrderItemStatusCd().equals(RefCodeNames.ORDER_ITEM_STATUS_CD.CANCELLED)) {
  ...
  public String getResultMessage() {
    ...
    public void setSmallOrderFeeStr(String smallOrderFeeStr) {
        this._smallOrderFeeStr = smallOrderFeeStr;
    }

    public String getSmallOrderFeeStr() {
        return _smallOrderFeeStr;
    }

    public void setFuelSurchargeStr(String fuelSurchargeStr) {
        this._fuelSurchargeStr = fuelSurchargeStr;
    }

    public String getFuelSurchargeStr() {
        return _fuelSurchargeStr;
    }

    public void setDiscountAmt(BigDecimal discount) {
        _discountAmt = discount;
    }
	...
	public String getOrderItemIdToView() {
		return _mOrderItemIdToView;
	}
	public void setOrderItemIdToView(String orderItemIdToView) {
		_mOrderItemIdToView = orderItemIdToView;
	}
