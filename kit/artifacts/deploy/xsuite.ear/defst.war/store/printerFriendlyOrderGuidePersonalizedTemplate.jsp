      ...
      <tr>
        ...
        <div style="background-color: white; border: solid 1px black; width: 325px; padding: 10px;">
          <table border="0" cellpadding="0" cellspacing="0" width="300" align="CENTER">
            ...
            <tr>
              <td align="left">
                <b>Phone:</b> <%=theForm.getAppUser().getUserAccount().getOrderPhone().getPhoneNum()%> 8:30am-6:30pm EST
              </td>
            </tr>
            <% } %>
            <tr>
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="620" align="CENTER">
      ...
      <tr height=25>
        ...
        <td class="text" width="45%" align="left" style="border-bottom: solid 1px black;">&nbsp;
           <%=theForm.getAppUser().getUserAccount().getBusEntity().getShortDesc()%>
        </td>
        ...
        <td class="text" colspan=4 width="34%" align="left" style="border-bottom: solid 1px black;">&nbsp;
           <%=theForm.getAppUser().getSite().getBusEntity().getShortDesc()%>
        </td>
      </tr>
      <tr height=25>
        <td class="text" align="left" colspan=1>Address 1:</td>
        <td class="text" colspan=6 width="85%" align="left" style="border-bottom: solid 1px black;">&nbsp;
           <%=theForm.getAppUser().getSite().getSiteAddress().getAddress1()%>
        </td>
      </tr>
<% if ( theForm.getAppUser().getSite().getSiteAddress().getAddress2() != null ) { %>
      <tr height=25>
        <td class="text" align="left" colspan=1>Address 2:</td>
        <td class="text" colspan=6 width="85%" align="left" style="border-bottom: solid 1px black;">&nbsp;
           <%=theForm.getAppUser().getSite().getSiteAddress().getAddress2()%>
        </td>
      </tr>
<% } %>
<% if ( theForm.getAppUser().getSite().getSiteAddress().getAddress3() != null ) { %>
      <tr height=25>
        <td class="text" align="left" colspan=1>Address 3:</td>
        <td class="text" colspan=6 width="85%" align="left" style="border-bottom: solid 1px black;">&nbsp;
           <%=theForm.getAppUser().getSite().getSiteAddress().getAddress3()%>
        </td>
      </tr>
<% } %>
      <tr height=25>
        ...
        <td class="text" width="45%" align="left" style="border-bottom: solid 1px black;">&nbsp;
           <%=theForm.getAppUser().getSite().getSiteAddress().getCity()%>
        </td>
        <% if (theForm.getAppUser().getUserStore().isStateProvinceRequired()) { %>
        <td class="text" width="6%" align="left">State:
        </td>
        <td class="text" colspan=1 width="9%" align="left" style="border-bottom: solid 1px black;">&nbsp;
           <%=
           theForm.getAppUser().getSite().getSiteAddress().getStateProvinceCd() != null ?
           theForm.getAppUser().getSite().getSiteAddress().getStateProvinceCd() :
           ""
           %>
        </td>
        <%} %>
        ...
        <td class="text" colspan=2 width="14%" align="left" style="border-bottom: solid 1px black;">&nbsp;
           <%=theForm.getAppUser().getSite().getSiteAddress().getPostalCode()%>
        </td>
      </tr>
      <tr height=25>
