...
<div class="text">
<table ID=708 width="<%=Constants.TABLEWIDTH%>" class="results" color="gray"> <tr>

<td width=150 class="tableheader">
<a ID=709 href="storeDeliverySchedules.do?action=sort&sortField=sl_site_name">Name</a>
</td>
<td class="tableheader" width=50>
<a ID=710 href="storeDeliverySchedules.do?action=sort&sortField=sl_site_status_cd">Site Status</a>
</td>
<td width=100 class="tableheader">
<a ID=711 href="storeDeliverySchedules.do?action=sort&sortField=sl_curr_sched">Current Schedule</a>
</td>
<td width=100 class="tableheader">
<a ID=712 href="storeDeliverySchedules.do?action=sort&sortField=sl_city">City</a>
</td><td width=50 class="tableheader">
<a ID=713 href="storeDeliverySchedules.do?action=sort&sortField=sl_state">State</a>
</td><td width=50 class="tableheader">
<a ID=714 href="storeDeliverySchedules.do?action=sort&sortField=sl_postal_code">Postal Code</a>
</td><td width=100 class="tableheader">
<a ID=715 href="storeDeliverySchedules.do?action=sort&sortField=sl_county">County</a>
</td></tr>
...
<form ID=716 action="storeDeliverySchedules.do" name="SD_<%=sds.getSiteId()%>" method="GET">
...
<option> none </option>
<option
<% if ( sds.getSiteScheduleType().startsWith("Any")) { %>
SELECTED
<% } %>
> Any Week </option>
<option
