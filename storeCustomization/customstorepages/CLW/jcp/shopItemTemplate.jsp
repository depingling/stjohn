...
function setAndSubmit(fid, vv, value) {
  var aaal = document.getElementsByName(vv);
  for ( var i = 0; i < 1; i++ ) {
    var aaa = aaal[i];
    aaa.value = value;
    aaa.form.submit();
...
%>
<html:form styleId="og_item" action="<%=addToCartUrl%>">
...
<!--  -->
  <logic:equal name="SHOP_FORM" property="allowPurchase" value="true">
    ...
    <logic:equal name="SHOP_FORM" property="allowPurchase" value="true">
     <jsp:include flush="true" page="<%=ClwCustomizer.getStoreFilePath(request,\"f_addtocart_buttons.jsp\")%>">
        ...
        <jsp:param name="formId" value="og_item"/>
        <jsp:param name="shopAction" value="toCart"/>
        <jsp:param name="invShopAction" value="toInvCart"/>
     </jsp:include>
        <td>
  ...
  <logic:notEqual name="shoppingCart" property="newItemsQty" value="0">
   ...
   <tr><td colspan="11" class="tableoutline"><img src="<%=IMGPath%>/cw_spacer.gif" height="1"></td></tr>
  </logic:equal>
<!-- -->
    <tr>
    <td >
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      ...
      <td class="customerltbkground" align="center" valign="top">
       ...
       <div class="itemheadmargin">
       <% 
       String storageType = theForm.getMsdsStorageTypeCd();
       if ((storageType == null) || storageType.trim().equals("")) {
              storageType = RefCodeNames.BINARY_DATA_STORAGE_TYPE.DATABASE; //Default
       }
       if (storageType.trim().equals(RefCodeNames.BINARY_DATA_STORAGE_TYPE.DATABASE)) { //old code
...
<td>
  ...
  <tr>
  <td colspan="11" class="tableoutline"><img src="<%=IMGPath%>/cw_spacer.gif" height="1"></td></tr>
...
--%>
  ...
  <!--------- -------->
  <%--
  <tr><td colspan="11" class="tableoutline"><img src="<%=IMGPath%>/cw_spacer.gif" height="3"></td></tr>
  <tr>
    <logic:equal name="SHOP_FORM" property="allowPurchase" value="true">
    <td colspan="11">
