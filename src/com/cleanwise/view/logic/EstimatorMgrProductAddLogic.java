...
/**
 * <code>EstimatorMgrProductAddLogic</code> implements the logic needed to
 * add items to spending estimator product.
 *
 * @author yuriy
 */
public class EstimatorMgrProductAddLogic {
  ...
  public static void init(HttpServletRequest request,
			  EstimatorMgrProductAddForm pForm)
    throws Exception
  {
    HttpSession session = request.getSession();
    //EstimatorMgrForm estimatorMgrForm = (EstimatorMgrForm) session.getAttribute("ESTIMATOR_MGR_FORM");
    ...
    CatalogData superCatalog = catalogInfEjb.getCatalog(4);
  ...
  */
    ...
    throws Exception
  {
    ...
    IdVector filterIds = new IdVector();
    pForm.setFilterIds(filterIds);
    ...
    //Create page list
    ProductDataVector productDV = catalogInfEjb.getProductCollection(itemIds);
