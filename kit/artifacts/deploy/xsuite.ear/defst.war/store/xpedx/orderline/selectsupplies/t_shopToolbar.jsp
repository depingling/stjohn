...
<% String longRow1 =
  ...
  "<img src="+cw_shopsecondaryleftPath+" WIDTH=\"11\" HEIGHT=\"20\">"+
  "<a href=\"shop.do?action=guide\" class=\""+guideCl+"\">"+
  cw_shopsecondaryguide+
  "</a>"+
  "<img src="+cw_shopsecondaryupspacerPath+" WIDTH=\"8\" HEIGHT=\"20\">"+
  ...
  "</a>"+
  "<img src="+cw_shopsecondarydownspacerPath+" WIDTH=\"8\" HEIGHT=\"20\">"+
  "<img src="+cw_shopsecondarydownspacerPath+" WIDTH=\"8\" HEIGHT=\"20\">"+
...
<% } else if ( tabi == 3 || tabi == 31 || tabi == 32 ) { %>
  ...
  <td class="subHeader" align="right">
    ...
    <img src="<%=cw_spacer%>" border="0" height="1" WIDTH="5">
