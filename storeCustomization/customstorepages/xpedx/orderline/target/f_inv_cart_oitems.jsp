...
<td width=10 align="center">
    <html:text name="<%=jspFormName%>" size="3" property='<%= "cartLine[" + IDX + "].inventoryQtyOnHandString"%>'/>
<%colIdx++;%>
</td>
<td width=10 align="center">
  <%colIdx++;%>
  <logic:greaterThan name="sciD" property="maxOrderQty" value="-1">
    <bean:write name="sciD" property="maxOrderQty"/>
  </logic:greaterThan>
</td>
<td align="center">-<%colIdx++;%></td> <%-- qty --%>
...
<%-- } else { %>  <td colspan="3">     N/A  <%colIdx+=3;%></td>   --%><% } %>
