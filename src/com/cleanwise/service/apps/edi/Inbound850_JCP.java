...
public class Inbound850_JCP extends Inbound850Super {
	private static final Logger log = Logger.getLogger(Inbound850_JCP.class);
...
public void extractHeaderN1(Table inTable)  throws OBOEException {
    ...
    public void extract() throws OBOEException {
        ...
        //if (currOrder.getOrderRequestedShipDate() != null)
        //	currOrder.setCustomerComments("Customer Requested Delivery Date " + currOrder.getOrderRequestedShipDate());
    }
