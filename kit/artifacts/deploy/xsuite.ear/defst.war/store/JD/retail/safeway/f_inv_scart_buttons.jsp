...
<td>
	...
	<a class="linkButton" style="font-size:12px" onclick="actionMultiSubmit('submitQty','saveInventoryCart');" href="#">
...
<td><a href="#" class="linkButton" style="font-size:12px" onclick="actionMultiSubmit('submitQty','removeInvSelected');">
    <img src='<%=IPTH + "/b_remove.gif"%>' border="0"/>
    <app:storeMessage key="global.label.removeSelected"/>
</a>
</td>
<td>
    <a href="#" class="linkButton" style="font-size:12px" onclick="actionMultiSubmit('submitQty','removeInvAll');">
        <img src='<%=IPTH + "/b_remove.gif"%>' border="0"/>
