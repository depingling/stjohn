...
if ( null != cfg && cfg.equals("store" ) ) {
 actionStr="storeportal/storeStoreUIConfig.do";
} else {
 actionStr="storeportal/storeAccountUIConfig.do";
}
%>
...
<logic:present name="STORE_UI_CONFIG_FORM" property="localeCd">
<bean:define id="localeCd" type="java.lang.String" name="STORE_UI_CONFIG_FORM" property="localeCd"/>
<html:hidden name="STORE_UI_CONFIG_FORM" property="localeCd" value="<%=localeCd%>"/>
</logic:present>
