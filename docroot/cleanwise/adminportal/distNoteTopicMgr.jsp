...
<td><bean:write name="DIST_NOTE_MGR_FORM" property="busEntityId"/></td>
 <td><b>Name:</b></td>
<td>
<td><bean:write name="DIST_NOTE_MGR_FORM" property="busEntityName"/></td>
</td>
<html:form action="/adminportal/distNoteMgr.do" focus="skuTempl" >
<bean:define id="theId"  name="DIST_NOTE_MGR_FORM" property="busEntityId"/>
<html:hidden  name="DIST_NOTE_MGR_FORM" property="busEntityId" value="<%=theId.toString()%>"/>
</tr>
</table>
...
%>
<tr>
<td class="tableheader">Select Distributor Note Topic</td>
<td>&nbsp;</td>
</tr>
<% 
 for(Iterator iter = topics.iterator(); iter.hasNext();) {
   ...
   if(topicId!=topicToEditId) {
     String topicLink = "distNoteMgr.do?action=loadTopic&topicId="+propD.getPropertyId();
     String delLink = "distNoteMgr.do?action=deleteTopic&topicId="+propD.getPropertyId();
     String editLink = "distNoteMgr.do?action=editTopic&topicToEditId="+propD.getPropertyId();
...
<%} else {%>
<tr>
<td><html:text name="DIST_NOTE_MGR_FORM" property="topicToEdit.value"/> </td>
...
<% if(topicToEditId==0) { %>
<tr><td colsan = '2'>
<html:text  name="DIST_NOTE_MGR_FORM" property="topicName"/>
