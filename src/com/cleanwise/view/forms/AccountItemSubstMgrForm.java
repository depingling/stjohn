 ...
 * Description:  This is the Struts ActionForm class for the account item substitution page.
 * Purpose:
...
/**
 * Form bean for the add/remove account item substitutions page.
 */
public final class AccountItemSubstMgrForm extends ActionForm {
    //general fields
    private int _accountId = 0;
    private int _accountCatalogId = 0;
    ...
    //Result fields
    private AccountItemSubstViewVector _substitutions = null;
    ...
    private HashMap _uomConversionFactors = new HashMap();
    //
    ...
    //public int getCatalogId() {return _catalogId;}
     ...
     public void setAccountCatalogId(int pValue) {_accountCatalogId=pValue;}
     public int getAccountCatalogId() {return _accountCatalogId;}
...
//    public ContractDataVector getContracts() {return _contracts;}
    ...
    public void setSubstOnlyFlag(boolean pValue) {_substOnlyFlag=pValue;}
    public boolean isSubstOnlyFlag(){return _substOnlyFlag;}
  ...
  //To substitute
    ...
    //Result fields
    public void setSubstitutions(AccountItemSubstViewVector pValue) {_substitutions=pValue;}
    public AccountItemSubstViewVector getSubstitutions(){return _substitutions;}
    ...
    public HashMap getUomConversionFactors(){return _uomConversionFactors;}
    public void setUomConversionFactors(HashMap pValue){_uomConversionFactors=pValue;}
    public void setUomConversionFactor(int pIndex, String pValue){
      Integer indexI = new Integer(pIndex);
      _uomConversionFactors.put(indexI,pValue);
    }
    public String getUomConversionFactor(int pIndex) {
      Integer indexI = new Integer(pIndex);
      if(!_uomConversionFactors.containsKey(indexI)) return "";
      return (String) _uomConversionFactors.get(indexI);
    }
