...
public class DomainAdmConfigurationForm  extends StorePortalBaseForm {
    ...
    private String _configSearchType = "nameContains";
    private String _configType = "";
    private boolean _configuredOnly = false;
    private String[] _selectIds = null;
    private String[] _displayIds = null;
    private String[] _selectDefaultStoreIds = null;
    private String[] _displayDefaultStoreIds = null;
    ...
    public void setSelectDefaultStoreIds (String[] pValue) {_selectDefaultStoreIds = pValue; }
    public String[] getSelectDefaultStoreIds() {return _selectDefaultStoreIds;}

    public void setDisplayDefaultStoreIds (String[] pValue) {_displayDefaultStoreIds = pValue;}
    public String[] getDisplayDefaultStoreIds() {return _displayDefaultStoreIds;}    

    public void setDefaultStoreId(String pValue) { _defaultStoreId = pValue; }
    public String getDefaultStoreId() { return _defaultStoreId; }
...
////////////////////////
    ...
    public void setDomainData(DomainData newDomainData) {this.domainData = newDomainData;}

//    public PropertyData getSiteProp(int propIdx) {
//      PropertyDataVector v = getDomainData().getDataFieldProperties();
