...
<td class="<%=style%>"><b><a href="storePurchaseOrderMgrOpDetail.do?action=sortitems&sortField=erpPoLineNum">Line#</b></td>
<% style = ((colInd++)%2)==0?"resultscolumna":"resultscolumnb"; %>
<td class="<%=style%>"><b>Dist Order#</b></td>
<% style = ((colInd++)%2)==0?"resultscolumna":"resultscolumnb"; %>
<td class="<%=style%>"><b><a href="storePurchaseOrderMgrOpDetail.do?action=sortitems&sortField=cwSKU">CW SKU#</b></td>
<% style = ((colInd++)%2)==0?"resultscolumna":"resultscolumnb"; %>
<td class="<%=style%>"><b><a href="storePurchaseOrderMgrOpDetail.do?action=sortitems&sortField=distSKU">Dist SKU#</b></td>
<% style = ((colInd++)%2)==0?"resultscolumna":"resultscolumnb"; %>
<td class="<%=style%>"><b><a href="storePurchaseOrderMgrOpDetail.do?action=sortitems&sortField=name">Product Name</b></td>
<% style = ((colInd++)%2)==0?"resultscolumna":"resultscolumnb"; %>
...
<logic:iterate id="itemele" indexId="i" name="PO_OP_DETAIL_FORM" property="purchaseOrderItemDescList" scope="session" type="com.cleanwise.service.api.value.OrderItemDescData">
 ...
 <% String linkHref = new String("storeOrderOpItemDetail.do?action=view&id=" + key  + "&fromPage=purchaseOrder");%>
...
<% style = ((colInd++)%2)==0?"resultscolumna":"resultscolumnb"; %>
<td class="<%=style%>"><input type="button" class="smallbutton" onclick="popLink('storeOrderOpNote.do?action=view&type=item&itemid=<%=key%>&src=po');" value="View"></td>
</logic:equal>
...
<% style = ((colInd++)%2)==0?"resultscolumna":"resultscolumnb"; %>
<td class="<%=style%>"><input type="button" class="smallbutton" onclick="popLink('storeOrderOpNote.do?action=add&type=item&itemid=<%=key%>&src=po');" value="Add"></td>
