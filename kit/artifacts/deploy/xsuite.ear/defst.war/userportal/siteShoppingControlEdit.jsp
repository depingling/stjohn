...
String cs = ClwCustomizer.getStoreFilePath(request, "t_siteShoppingControlEdit.jsp");
String tabs = ClwCustomizer.getStoreFilePath(request, "f_custAcctMgtToolbar.jsp");

%>

<bean:define id="toolBarTab" type="java.lang.String"  value="shoppingcontrol" toScope="request"/>
