...
<td class="shopcharthead">    &nbsp;</td>
  ...
  <td class="shopcharthead" align="center"><app:storeMessage key="shop.og.table.header.manuf"/></td>
  <td class="shopcharthead" align="center"><app:storeMessage key="shop.og.table.header.manufSkuNum"/></td>
...
<tr>
<td>
<a  class="linkButton" style="font-size:12px" href="shop.do?action=clear">
<img src="<%=IMGPath%>/b_clearqty.gif" border="0"/><app:storeMessage key="global.label.clearQuantities"/></a>
</td>
<td>
  <a class="linkButton" style="font-size:12px" onclick="actionMultiSubmit('BBBBBBB', 'og_recalc');" href="#"
...
<td>
  <a href="../store/scheduledCart.do?action=showScheduledCart" 
    class="linkButton"><img src='<%=ClwCustomizer.getSIP(request,"b_viewcart.gif")%>'
...
<tr>
  ...
  <logic:equal name="SHOP_FORM" property="allowPurchase" value="true">
    <% String add_img = IMGPath + "/b_addtocart.gif"; %>
      <a class="linkButton" style="font-size:12px" onclick="actionMultiSubmit('BBBBBBB', 'og_addToCart');" href="#" 
