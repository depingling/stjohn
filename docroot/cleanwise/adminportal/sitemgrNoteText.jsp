...
<html:form action="/adminportal/sitemgrNote.do" enctype="multipart/form-data">
...
<% 
  ...
  String titleLink = "sitemgrNote.do?action=editTitle&noteId="+noteD.getNoteId();
%>
...
<%
  if(noteTextD.getNoteTextId()!=paragraphToEditId) {
    ...
    String noteLink = "sitemgrNote.do?action=editNote&noteTextId="+noteTextD.getNoteTextId();
%>
<tr>
<td><%=noteText%></td>
...
<%
  for(Iterator iter = noteAttachDV.iterator(); iter.hasNext(); ) {
    ...
    String href = "sitemgrNote.do?action=attachment&noteId="+noteD.getNoteId()+"&file="+fileName;
%>
