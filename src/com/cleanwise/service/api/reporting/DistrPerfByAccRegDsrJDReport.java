 ...
 *
 */
public class DistrPerfByAccRegDsrJDReport extends DistrPerfByAccountJDReport implements GenericReportMulti {
...
protected GenericReportColumnViewVector getReportHeader() {
  ...
  protected String getQuerySqlForCurrentY(String subSelect) {
     String sql =
         " select  c.ACCOUNT , c.REGION, c.DSR_ID, c.SUM_PRICE, c.SUM_QTY, c.SUM_COST, \n" +
   ...
   protected String getQuerySqlForPriorY(String subSelect) {
     String sql =
         " select  b.ACCOUNT , b.REGION, b.DSR_ID, c.SUM_PRICE, c.SUM_QTY, c.SUM_COST, \n" +
         "         b.PRIOR_SUM_PRICE, b.PRIOR_SUM_QTY, b.PRIOR_SUM_COST  \n" +
         " from  \n" +
         subSelect +
         " where c.account(+)   = b.account  \n" +
    ...
    protected String getQuerySql(Map pParams) throws Exception {
     ...
     String sql=
          ...
          filterCond +
          "    ) \n" +
          "  group by ACCOUNT, REGION, DSR_ID ) c , \n" +
          "  (select  ACCOUNT, REGION, DSR_ID, \n"+
          ...
          filterCond +
          "    ) \n" +
          "  group by ACCOUNT, REGION, DSR_ID ) b  \n" ;
