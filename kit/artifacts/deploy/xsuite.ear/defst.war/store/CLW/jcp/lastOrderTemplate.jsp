...
<html:form styleId='lot' action="/store/lastOrder.do?action=lastOrderSubmit">
  ...
  <tr>
  <td colspan="11" class="tableoutline"><img src="/images/cw_spacer.gif" height="3"></td>  </tr>
  </tr>
  <!-- page contral bar -->
  <logic:equal name="<%=Constants.APP_USER%>" property="allowPurchase" value="true">
    ...
    <tr>
      <jsp:include flush="true" page="<%=ClwCustomizer.getStoreFilePath(request,\"f_addtocart_buttons.jsp\")%>">
        ...
        <jsp:param name="formId" value="lot"/>
        <jsp:param name="shopAction" value="addToCart"/>
        <jsp:param name="invShopAction" value="lot_addToModInvCart"/>
     </jsp:include>
        <td>
  ...
  <tr>
  <!-- Column heanders -->
  <td colspan="11" class="tableoutline"><img src="/images/cw_spacer.gif" height="1"></td>  </tr>
  </tr>
  <tr>
  ...
  <logic:iterate id="item" name="LAST_ORDER_FORM" property="cartItems"
   indexId="IDX"   type="com.cleanwise.service.api.value.ShoppingCartItemData">
     ...
     <% if(theForm.isCategoryChanged(((Integer)IDX).intValue())) { %>
       <tr>
       <td class="shopcategory" colspan = "11"><bean:write name="item" property="categoryPath"/></td>
       </tr>
     <% } %>
     <% } %>
