 ...
 * </ul>
 */
public final class ContractItemLocateForm extends ActionForm {
  ...
  // -------------------------------------------------------- Instance Variables
    ...
    AssetViewVector _assetSearchResult=new AssetViewVector();
    private ServiceViewVector _services=new  ServiceViewVector();
  // ---------------------------------------------------------------- Properties
    ...
    public ServiceViewVector getServices() {
        return _services;
    }
    public void setServices(ServiceViewVector services) {
