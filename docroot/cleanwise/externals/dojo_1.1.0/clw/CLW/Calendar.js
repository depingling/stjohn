if(!dojo._hasResource["clw.CLW.Calendar"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["clw.CLW.Calendar"] = true;
 dojo.provide("clw.CLW.Calendar");

    dojo.require("dijit._Calendar");

    dojo.requireLocalization("dijit", "common", null, "ROOT,cs,de,es,fr,gr,hu,it,ja,ko,pl,pt,ru,sv,zh,zh-tw", "ROOT,cs,de,es,fr,gr,hu,it,ja,ko,pl,pt,ru,sv,zh,zh-tw");
