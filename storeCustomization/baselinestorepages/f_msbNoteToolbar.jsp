...
<%
    ...
    String toolLink01 = "/" + rootDir + "/userportal/msbNotes.do";
%>
...
<jsp:include flush='true' page="<%=t_templatorToolBar%>" >
   ...
   <jsp:param name="color02" value="#d0e47e"/>
   <jsp:param name="color03" value="#335cbc"/>

   <jsp:param name="headerLabel" value="shop.header.text.messagesHeader"/>
</jsp:include>
