...
public class Outbound810_JCP_v4030 extends Outbound810Super
{
   ...
   /** builds segment BIG that is part of the Header
	...
	if ( null != currOrder.getRequestPoNum() ) {
	    String t = currOrder.getRequestPoNum();
            System.out.println("STARTING EPRO PO NUMBER t=" + t
		+ " orderid=" + currOrder.getOrderId()
		);
      ...
      throws OBOEException
    {
      ...
      if (code.equals("RE")){
        ...
        String sname ;
        if(Utility.isSet(currEDIRequestD.getCustomerBillingUnit())){
            sname = currEDIRequestD.getCustomerBillingUnit();
        }else{
    ...
    throws OBOEException, RemoteException
  {
    ...
    for (int i = 0; i < invoiceReqDV.size(); i++){
      ...
      //this shouldn't be necessary anymore as this was moved to the OutboundTranslator
      //class.  Implementing transaction should need to worry about this; however it is
