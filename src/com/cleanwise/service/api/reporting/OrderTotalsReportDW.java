...
public class OrderTotalsReportDW implements  GenericReportMulti {

    private static final Logger log = Logger.getLogger(OrderTotalsReportDW.class);
...
//    protected static final String SUB_TOTAL ="Sub Total";
 ...
 //          --       (select site_dist_ref_cd  from dw_site_dim  where site_dim_id = g.site_DIM_ID) site_dist_ref,
    ...
    public ArrayList getTab2QueryResult(Connection pCon, String filterCond, String dateCond) throws Exception {
      ...
      String sql =
          ...
          "           f.ITEM_DIM_ID = i.ITEM_DIM_ID \n"+
          "      AND  f.DATE_DIM_ID in ( \n"+ dateCond + ") \n"+
          filterCond + " \n"+
          "ORDER BY  account_name, site_name, confirm_num ";
    ...
    protected HashMap createReportStyleDescriptor(){
        ...
        */
         ...
         GenericReportStyleView colAddress = new GenericReportStyleView("COL_ADDRESS","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[2],0 );
         GenericReportStyleView colBudgetRef = new GenericReportStyleView("COL_BUDGET_REF","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[3],0 );
         ...
         GenericReportStyleView colConfirm = new GenericReportStyleView("COL_CONFIRM_NUM","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[5],0 );
         ...
         GenericReportStyleView colSaleType = new GenericReportStyleView("COL_SALE_TYPE","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[8],0 );

         GenericReportStyleView colTotal = new GenericReportStyleView("COL_TOTAL",null,null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[9],0 );
         ...
         GenericReportStyleView colManufSku = new GenericReportStyleView("COL_MANUF_SKU","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[14],0 );
         GenericReportStyleView colManufName = new GenericReportStyleView("COL_MANUF_NAME","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[15],0 );
         GenericReportStyleView colCateg = new GenericReportStyleView("COL_CATEG","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[16],0 );
         GenericReportStyleView colDistSku = new GenericReportStyleView("COL_DIST_SKU","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[17],0 );
         GenericReportStyleView colProdName = new GenericReportStyleView("COL_PROD_NAME","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[18],0 );
         GenericReportStyleView colPack = new GenericReportStyleView("COL_PACK","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[19],0 );
         GenericReportStyleView colUom = new GenericReportStyleView("COL_UOM","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[20],0 );
         GenericReportStyleView colSize = new GenericReportStyleView("COL_SIZE","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[21],0 );
         GenericReportStyleView colDistName = new GenericReportStyleView("COL_DIST_NAME","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[22],0 );
         GenericReportStyleView colQuantity = new GenericReportStyleView("COL_QUANTITY",null,null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[23],0 );
 //        GenericReportStyleView colPrice = new GenericReportStyleView("COL_PRICE",null,null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[24],0 );
         GenericReportStyleView colSysSku = new GenericReportStyleView("COL_SYS_SKU","TEXT",null,FONT_NAME,FONT_SIZE,"BOLD",null,null,"CENTER",true, null,null,COL_WIDTH[24],0 );
...
//         reportDesc.setUserStyle(typeDateD.getStyleName(), typeDateD);
    ...
    private GenericReportColumnViewVector getReportHeader1() {
          ...
          header.add(ReportingUtils.createGenericReportColumnView("Address1", "COL_ADDRESS", null,COL_WIDTH[2]));
          header.add(ReportingUtils.createGenericReportColumnView("Site Budget Reference Code", "COL_BUDGET_REF", null,COL_WIDTH[3]));
          header.add(ReportingUtils.createGenericReportColumnView("Distributor Reference Code",  "COL_DISTR_REF", null,COL_WIDTH[4]));
          header.add(ReportingUtils.createGenericReportColumnView("Confirmation Number", "COL_CONFIRM_NUM", null,COL_WIDTH[5]));
          ...
          header.add(ReportingUtils.createGenericReportColumnView("Sale Type", "COL_SALE_TYPE", null,COL_WIDTH[8]));

          header.add(ReportingUtils.createGenericReportColumnView("Order Sub-Total", "COL_TOTAL","TYPE_AMOUNT_DATA",COL_WIDTH[9]));
    ...
    private GenericReportColumnViewVector getReportHeader2() {
          ...
          header.add(ReportingUtils.createGenericReportColumnView("PO Number", "COL_PO_NUM", null,COL_WIDTH[6]));
          header.add(ReportingUtils.createGenericReportColumnView("Order Date", "COL_DATE",  ReportingUtils.DATE_STYLE,COL_WIDTH[7]));
          header.add(ReportingUtils.createGenericReportColumnView("Manufacturer SKU", "COL_MANUF_SKU", null,COL_WIDTH[14]));
          header.add(ReportingUtils.createGenericReportColumnView("Manufacturer", "COL_MANUF_NAME", null,COL_WIDTH[15]));
          header.add(ReportingUtils.createGenericReportColumnView("Category", "COL_CATEG", null,COL_WIDTH[16]));
          header.add(ReportingUtils.createGenericReportColumnView("Distributor SKU", "COL_DIST_SKU", null,COL_WIDTH[17]));
          header.add(ReportingUtils.createGenericReportColumnView("Product Description", "COL_PROD_NAME", null,COL_WIDTH[18]));
          header.add(ReportingUtils.createGenericReportColumnView("Dist UOM", "COL_UOM", null,COL_WIDTH[19]));
          header.add(ReportingUtils.createGenericReportColumnView("Dist Pack", "COL_PACK", null,COL_WIDTH[20]));
          header.add(ReportingUtils.createGenericReportColumnView("Item Size", "COL_SIZE", null,COL_WIDTH[21]));
          header.add(ReportingUtils.createGenericReportColumnView("Distributor", "COL_DIST_NAME", null,COL_WIDTH[22]));
          header.add(ReportingUtils.createGenericReportColumnView("Sale Type", "COL_SALE_TYPE", null,COL_WIDTH[8]));

          header.add(ReportingUtils.createGenericReportColumnView("Quantity", "COL_QUANTITY","TYPE_QTY_DATA",COL_WIDTH[23]));
          header.add(ReportingUtils.createGenericReportColumnView("Line Total", "COL_TOTAL","TYPE_AMOUNT_DATA",COL_WIDTH[9]));
          header.add(ReportingUtils.createGenericReportColumnView("Currency Code","COL_CURR",null,COL_WIDTH[13]));
          header.add(ReportingUtils.createGenericReportColumnView("System SKU","COL_SYS_SKU","TYPE_PERCENT_DATA",COL_WIDTH[24]));
