...
<app:defineProdColumnCount id="colCountInt" viewOptionEditCartItems="<%=editCartItems%>" viewOptionQuickOrderView="<%=quickOrderView%>" viewOptionAddToCartList="false" viewOptionOrderGuide="false"/>
        ...
        if(itemCenterName.compareTo(centerName) == 0) {
          ...
          if(itemCenterName.compareTo(centerName) > 0) {
            ...
            if ( (wrk == null) ||((wrk != null) && (centerName.compareTo(wrk.getShortDesc()) > 0))){
              ...
              <%@ include file="f_groupTitleInvInc.jsp"  %>
...
<app:displayProd viewOptionEditCartItems="<%=editCartItems%>" updateAutoDistro="<%=updateAutoDistro%>" viewOptionQuickOrderView="<%=quickOrderView%>" viewOptionAddToCartList="false" viewOptionOrderGuide="false"
