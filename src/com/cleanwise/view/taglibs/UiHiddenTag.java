...
public class UiHiddenTag extends org.apache.struts.taglib.html.HiddenTag{

    private static final Logger log = Logger.getLogger(UiMultiboxTag.class);
    ...
    public int doStartTag() throws JspException {
        ...
        if (ancestorTag == null) {
            String message = " UiHiddenTag tag must be nested within a UiControlElementConfigTag tag.";
