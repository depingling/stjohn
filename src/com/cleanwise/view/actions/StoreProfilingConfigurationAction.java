/*
 * ProfilingConfigurationAction.java
 *
 ...
 * @author  bstevens
 */
public class StoreProfilingConfigurationAction extends ActionSuper {
    ...
    throws IOException, ServletException {
        ...
        try {
            ...
            if (action.equals(initStr)) {
                ...
                ae = StoreProfilingMgrLogic.getConfig(request, form);
            }else if (action.equals(updateStr)){
                ae = StoreProfilingMgrLogic.updateConfig(request, form);
            }else {
                StoreProfilingMgrLogic.init(request, form);
            }
