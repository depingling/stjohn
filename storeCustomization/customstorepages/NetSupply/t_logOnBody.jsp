            ...
            <tr>
              <td  width="100%" align="right" colspan="2">
				  <table>
					  <tr>
						<td width="10%"></td>
						<td width="90%" class="netsupplylink" align="right"  border="0" cellspacing="0" cellpadding="0" >
							<a class="netsupplylink" href="http://www.nsconline.com/netsupply/" target="AboutNetSupply" tabIndex="4">About NetSupply</a>
						</td>
					  </tr>
				  </table>
			  </td>
