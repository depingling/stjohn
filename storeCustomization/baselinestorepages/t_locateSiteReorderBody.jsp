...
<a href="msbsites.do?action=sort_sites_reorder&sortField=name"><app:storeMessage key="msbSites.text.siteName"/></a></div></td>
<td class="shopcharthead"><div class="fivemargin">
<a href="msbsites.do?action=sort_sites_reorder&sortField=address"><app:storeMessage key="msbSites.text.streetAddress"/></a></div></td>
<td class="shopcharthead"><div class="fivemargin">
<a href="msbsites.do?action=sort_sites_reorder&sortField=city"><app:storeMessage key="msbSites.text.city"/></a></div></td>
<% if (appUser.getUserStore().isStateProvinceRequired()) { %>
<td class="shopcharthead"><div class="fivemargin">
<a href="msbsites.do?action=sort_sites_reorder&sortField=state"><app:storeMessage key="msbSites.text.stateProvince"/></a></div></td>
<%} %>
</tr>
    ...
    --%>
      <%--------------------------------- HEADER -----------------------------------------%>
        ...
        <app:commonDisplayProdHeader
                ...
                viewOptionConfirmCheckout="false"
                viewOptionReorder="true"
...
<% int rowIdx = 0; %>
  ...
  <tr>
  <td colspan="<%=(colCount-2)%>" class="tableoutline"><img src="/images/cw_spacer.gif" height="1"></td>
  </tr>
