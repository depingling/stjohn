...
public class ProductCatalogItemsColumnCountTag extends DisplayProductCatalogItemsTag {
	private static final Logger log = Logger.getLogger(ProductCatalogItemsColumnCountTag.class);
	private String id;
