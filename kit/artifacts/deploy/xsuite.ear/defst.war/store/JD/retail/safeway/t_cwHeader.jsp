...
<td align="right">
        <a class="headernavlinkstart" href="../userportal/customerAccountManagement.do"><app:storeMessage key="shop.header.text.accountManagement"/></a>
</td>
<td align="right">
<a class="headernavlinkstart" href="../userportal/templator.do?display=t_contactUsBody.jsp&tabs=contactUsToolBar"><app:storeMessage key="shop.header.text.contactUs"/></a>
</td>
<%
            ...
            <table align="right" border="0" cellpadding="2" cellspacing="0">
              <% if (ShopTool.hasDiscretionaryCartAccessOpen(request)) { %>
                ...
                <tr>
                    ...
                    <td align="left">
                        <a class="linkButton" style="font-size:12px" href="../store/scheduledCart.do?action=showScheduledCart">
                            <img src='<%=ClwCustomizer.getSIP(request,"b_viewcart.gif")%>' border="0">
							<%--<app:storeMessage key="global.label.inventoryShoppingCart"/>--%>
							scheduled / inventory cart
