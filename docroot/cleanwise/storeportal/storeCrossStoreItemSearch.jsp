...
<html:form styleId="993" action="storeportal/crossStoreItems-submit.do" focus="skuTempl">
...
<% } %>
    ...
    <% String linkHref = new String("crossStoreItemLinkEdit.do?action=edit&retaction=searchItems&useItemsLinksForAllStores=true&itemId=" + key);%>
