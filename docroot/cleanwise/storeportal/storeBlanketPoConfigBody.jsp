...
<html:form action="/storeportal/blanketPoConfig.do">
 <table>
  <tr> <td><b>Find</b></td>
       <td> 
          <html:select name="STORE_BLANKET_PO_FORM" property="configType">
	         <html:option value="Account">Account</html:option>
             <html:option value="Site">Site</html:option>
          </html:select>
       </td>
       <td colspan="2"> 
	  <html:text name="STORE_BLANKET_PO_FORM" property="searchField"/>	
       </td>
  </tr>
  
  <tr> <td colspan="2">&nbsp;</td>
       <td colspan="3">
         <html:radio name="STORE_BLANKET_PO_FORM" property="searchType" value="nameBegins" />
         Name(starts with)
         <html:radio name="STORE_BLANKET_PO_FORM" property="searchType" value="nameContains" />
         Name(contains)
         </td>
  </tr>  
  ...
  <tr> <td colspan="2">&nbsp;</td>
       <td colspan="3">
	      ...
	      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          Show Configured Only<html:checkbox name="STORE_BLANKET_PO_FORM"  property="confShowConfguredOnlyFl"/>  
       </td>
  </tr>
...
<logic:present name="STORE_BLANKET_PO_FORM" property="results">
<bean:size id="rescount"  name="STORE_BLANKET_PO_FORM" property="results.values"/>
...
<%-- display the sites --%>
<logic:equal name="STORE_BLANKET_PO_FORM" property="resultsType" value="Site">
<logic:iterate id="arrele" indexId="i" name="STORE_BLANKET_PO_FORM" property="results.values" type="com.cleanwise.service.api.value.SiteData">
<tr>
    ...
    <td>
      ...
      <html:multibox  name="STORE_BLANKET_PO_FORM" property="<%=prop%>" value="true"/>
    </td>
...
<logic:equal name="STORE_BLANKET_PO_FORM" property="resultsType" value="Account">
<logic:iterate id="arrele" indexId="i" name="STORE_BLANKET_PO_FORM" property="results.values" type="com.cleanwise.service.api.value.AccountSearchResultView">
<tr>
    
    <td><bean:write name="arrele" property="accountId"/></td>
    <td>
      <bean:define id="eleid" name="arrele" property="accountId"/>
      <a href="storeAccountDetail.do?action=accountdetail&accountId=<%=eleid%>">
...
<%-- display the stores --%>
<logic:equal name="STORE_BLANKET_PO_FORM" property="resultsType" value="Store">
<logic:iterate id="arrele" indexId="i" name="STORE_BLANKET_PO_FORM" property="results.values" type="com.cleanwise.service.api.value.StoreData">
<tr>
    
    <td><bean:write name="arrele" property="busEntity.busEntityId"/></td>
    <td>
      <bean:define id="eleid" name="arrele" property="busEntity.busEntityId"/>
      <!-- next line below changed by SVC 11/24/08 -->
      <a href="storeStoreMgr.do?action=storedetail&searchType=id&searchField=<%=eleid%>">
      <bean:write name="arrele" property="busEntity.shortDesc"/>
      </a>
    </td>
