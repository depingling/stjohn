...
<html:html>
<head>
<title>Search for Site Notes</title>
...
<a href="sitemgrNote.do?action=selectTopic">[Change Topic]</a>
</td>
</tr>
<tr>
...
%>
<tr>
<td class="tableheader"><a href='sitemgrNote.do?action=sortNotes&field=noteTitle'>Note Title</a></td>
<td class="tableheader"><a href='sitemgrNote.do?action=sortNotes&field=modifyDate'>Modify Date</a></td>
<td class="tableheader"><a href='sitemgrNote.do?action=sortNotes&field=searchRating'>Search Rating</a></td>
...
<% 
   ...
   String noteLink = "sitemgrNote.do?action=readNote&noteId="+note.getNoteId();
%>
<tr>
