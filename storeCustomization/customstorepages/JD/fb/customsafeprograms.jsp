...
<li><a target="_blank" href='<%=ClwCustomizer.getRootFilePath(request, "content/hazardousMaterials.pdf")%>'>Hazardous Materials Identification System</a></li>

<li><a target="_blank" href='<%=ClwCustomizer.getRootFilePath(request, "content/msdsRefGuide.pdf")%>'>MSDS Reference Guide</a></li>

<li><a target="_blank" href='<%=ClwCustomizer.getRootFilePath(request, "content/sanitationChemicalSafety.pdf")%>'>Sanitation Chemical Safety Manual</a></li>
