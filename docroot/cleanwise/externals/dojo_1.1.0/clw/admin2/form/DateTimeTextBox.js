if(!dojo._hasResource["clw.admin2.form.DateTimeTextBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["clw.admin2.form.DateTimeTextBox"] = true;
 dojo.provide("clw.admin2.form.DateTimeTextBox");
    ...
    dojo.declare("clw.admin2.form.DateTimeTextBox",
            dijit._Widget, {
        ...
        postCreate: function() {
            ...
            if (this.targetNodeIds &&
                ...
                if (this.targetNodeIds.length > 1) {
                    console.warn("[clw.admin2.form.DateTimeTextBox.postCreate] => Multiple targets found.Targets: " + this.targetNodeIds)
                    console.warn("[clw.admin2.form.DateTimeTextBox.postCreate] => Targets will be corrected to : " + this.targetNodeIds[0])
        ...
        _onKeyPress: function(/*Event*/e) {
            if (clw.admin2.form.DateTimeTextBox.superclass._onKeyPress.apply(this, arguments)) {
