  ...
  throws OBOEException
{
  ...
  log("  buildHeaderAK1, groupType=" + groupType
...
// YR OBOE    Segment ak5Segment = ak2Segment.getSegment("AK5");
  ...
  public void buildTransactions(int incomingProfileId)
    ...
    {
      OutboundTranslate translator = new OutboundTranslate();
      translator.setUp("",0, "997", "out997.txt");
      translator.openOutputStream();
      TradingProfileData lProfile = translator.getTradingProfile(2);
      Outbound997 ediDoc = new Outbound997();
      ediDoc.buildDocumentHeader(lProfile);
      ediDoc.buildTransactionHeader();
      ediDoc.setParameter(translator);
      ediDoc.buildHeaderAK1("PO", 1001);
      ediDoc.buildHeaderAK2("850", 1001001);
      ediDoc.buildHeaderAK2AK5("A", new Vector());
      ediDoc.buildHeaderAK9("A", 1, new Vector());
      ediDoc.buildTransactionTrailer();
      ediDoc.buildDocumentTrailer();
      translator.closeOutputStream();
      System.out.println(ediDoc.getTranslationReport());
