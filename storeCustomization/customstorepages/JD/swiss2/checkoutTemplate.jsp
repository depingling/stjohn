...
<table cellpadding="0" cellspacing="0" class="tbstd" width="<%=Constants.TABLEWIDTH%>" align=center>
<tr>
<td class="redwarning"><br>&nbsp;<app:storeMessage key="shop.message.vocNotIncluded"/><br>&nbsp;</td>
</tr>
</table>
...
<% //commented out for bug 5066 requirement 1.34 %>
<%  if ( null != theForm.getSalesTax()) { %>
...
<% if ( !ShopTool.isAnOCISession(request.getSession()) ) { %>
            ...
            <table>
<tr><td>  <b><app:storeMessage key="shop.checkout.text.siteName"/></b></td>
    <td>  <%=siteName %></td>
</tr>
<tr><td>  <b><app:storeMessage key="shop.checkout.text.address1"/></b></td>
