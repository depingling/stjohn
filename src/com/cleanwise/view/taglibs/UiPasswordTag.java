...
public class UiPasswordTag extends PasswordTag {

    private static final Logger log = Logger.getLogger(UiPasswordTag.class);
    ...
    public int doStartTag() throws JspException {
        ...
        if (ancestorTag == null) {
            String message = "UiPasswordTag tag must be nested within a UiControlElementConfigTag tag.";
