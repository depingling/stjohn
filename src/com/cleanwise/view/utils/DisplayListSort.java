...
/**
 *  <code>DisplayListSort</code> Sort display lists of value object vectors
 *
 *@author     tbesser
 *@created    October 15, 2001
 */
public class DisplayListSort {
	...
	public static void setRequestObject(HttpServletRequest pRequest){
		...
		collator=(RuleBasedCollator)java.text.Collator.getInstance(appUser.getPrefLocale());
	}
	...
	static final Comparator  ASSET_SHORT_DESC_COMPARE = new Comparator() {
        ...
        static final Comparator  ASSET_MODEL_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String model1 = ((AssetView)o1).getModelNumber();
			String model2 = ((AssetView)o2).getModelNumber();
			return Utility.compareToIgnoreCase(model1, model2);
		}
	};
        static final Comparator  ASSET_MANUFACTURER_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String manuf1 = ((AssetView)o1).getManufName();
			String manuf2 = ((AssetView)o2).getManufName();
			return Utility.compareToIgnoreCase(manuf1, manuf2);
		}
	};
        static final Comparator  ASSET_MANUFACTURER_SKU_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String manuf_sku1 = ((AssetView)o1).getManufSku();
			String manuf_sku2 = ((AssetView)o2).getManufSku();
			return Utility.compareToIgnoreCase(manuf_sku1, manuf_sku2);
		}
	};        
        static final Comparator  ASSET_STATUS_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String status1 = ((AssetView)o1).getStatus();
			String status2 = ((AssetView)o2).getStatus();
			return Utility.compareToIgnoreCase(status1, status2);
		}
	};
        
        static final Comparator ASSET_CONTENT_NAME_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String name1 = ((AssetContentView)o1).getContent().getShortDesc();
			String name2 = ((AssetContentView)o2).getContent().getShortDesc();
			return Utility.compareToIgnoreCase(name1, name2);
		}
	};
	...
	static final Comparator ACCOUNT_ID_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			...
			if(o1 instanceof AccountSearchResultView){
				...
				id2 = ((AccountSearchResultView)o2).getAccountId();
			}else{
				id1 = ((AccountData)o1).getBusEntity().getBusEntityId();
				id2 = ((AccountData)o2).getBusEntity().getBusEntityId();
			}
			return id1 - id2;
		}
	};
	...
	static final Comparator ACCOUNT_NAME_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			...
			String name2;
			if(o1 instanceof AccountSearchResultView){
				name1 = ((AccountSearchResultView)o1).getShortDesc();
				name2 = ((AccountSearchResultView)o2).getShortDesc();
			}else{
				name1 = ((AccountData)o1).getBusEntity().getShortDesc();
				name2 = ((AccountData)o2).getBusEntity().getShortDesc();
			}
				return Utility.compareToIgnoreCase(name1, name2);
		}
	};

	static final Comparator ACCOUNT_ADDRESS_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String address1;
			String address2;
			if(o1 instanceof AccountSearchResultView){
				address1 = ((AccountSearchResultView)o1).getAddress1();
				address2 = ((AccountSearchResultView)o2).getAddress1();
			}else{
				address1 = ((AccountData)o1).getPrimaryAddress().getAddress1();
				address2 = ((AccountData)o2).getPrimaryAddress().getAddress1();
			}
				return Utility.compareToIgnoreCase(address1, address2);
		}
	};
	...
	static final Comparator ACCOUNT_CITY_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			...
			String city2;
			if(o1 instanceof AccountSearchResultView){
				city1 = ((AccountSearchResultView)o1).getCity();
				city2 = ((AccountSearchResultView)o2).getCity();
			}else{
				city1 = ((AccountData)o1).getPrimaryAddress().getCity();
				city2 = ((AccountData)o2).getPrimaryAddress().getCity();
			}
			return Utility.compareToIgnoreCase(city1, city2);
		}
	};
	...
	static final Comparator ACCOUNT_STATE_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			...
			String state2;
			if(o1 instanceof AccountSearchResultView){
				state1 = ((AccountSearchResultView)o1).getStateProvinceCd();
				state2 = ((AccountSearchResultView)o2).getStateProvinceCd();
			}else{
				state1 =
	...
	static final Comparator ACCOUNT_ZIP_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			...
			String zip2;
			if(o1 instanceof AccountSearchResultView){
				zip1 = ((AccountSearchResultView)o1).getPostalCode();
				zip2 = ((AccountSearchResultView)o2).getPostalCode();
			}else{
				zip1 =
	...
	static final Comparator ACCOUNT_TYPE_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			...
			String type2;
			if(o1 instanceof AccountSearchResultView){
				type1 = ((AccountSearchResultView)o1).getValue();
				type2 = ((AccountSearchResultView)o2).getValue();
			}else{
				type1 = ((AccountData)o1).getAccountType().getValue();
				type2 = ((AccountData)o2).getAccountType().getValue();
			}
	...
	static final Comparator ACCOUNT_STATUS_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			...
			String status2;
			if(o1 instanceof AccountSearchResultView){
				status1 = ((AccountSearchResultView)o1).getBusEntityStatusCd();
				status2 = ((AccountSearchResultView)o2).getBusEntityStatusCd();
			}else{
				status1 =
	...
	static final Comparator ORDER_GUIDE_ITEM_QUANTITY_COMPARE = new Comparator() {
        ...
        static final Comparator STAGED_ITEM_ID_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			int id1 =
				((StagedItemData)o1).getStagedItemId();
			int id2 =
				((StagedItemData)o2).getStagedItemId();
			return id1 - id2;
		}
	};
        
        static final Comparator STAGED_ITEM_NAME_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String name1 =
				((StagedItemData)o1).getShortDescription();
			String name2 =
				((StagedItemData)o2).getShortDescription();
			return Utility.compareToIgnoreCase(name1, name2);
		}
	};
        
        static final Comparator STAGED_ITEM_CATEGORY_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String name1 =
				((StagedItemData)o1).getCategoryName();
			String name2 =
				((StagedItemData)o2).getCategoryName();
			return Utility.compareToIgnoreCase(name1, name2);
		}
	};
        
        static final Comparator STAGED_ITEM_MANUFACTURER_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String manuf1 =
				((StagedItemData)o1).getManufacturer();
			String manuf2 =
				((StagedItemData)o2).getManufacturer();
			return Utility.compareToIgnoreCase(manuf1, manuf2);
		}
	};
        
        static final Comparator STAGED_ITEM_SKU_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String sku1 =
				((StagedItemData)o1).getMfgSku();
			String sku2 =
				((StagedItemData)o2).getMfgSku();
			return Utility.compareToIgnoreCase(sku1, sku2);
		}
	};
        
        static final Comparator ITEM_ID_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			int id1 =
				((ItemView)o1).getItemId();
			int id2 =
				((ItemView)o2).getItemId();
			return id1 - id2;
		}
	};
        
        static final Comparator ITEM_NAME_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String name1 =
				((ItemView)o1).getName();
        ...
        static final Comparator ITEM_CATEGORY_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String name1 =
				((ItemView)o1).getCategory();
			String name2 =
				((ItemView)o2).getCategory();
			return Utility.compareToIgnoreCase(name1, name2);
		}
	};
        
        static final Comparator ITEM_MANUFACTURER_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String manuf1 =
				((ItemView)o1).getManufName();
			String manuf2 =
				((ItemView)o2).getManufName();
			return Utility.compareToIgnoreCase(manuf1, manuf2);
		}
	};
        
        static final Comparator ITEM_SKU_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String sku1 =
				((ItemView)o1).getManufSku();
			String sku2 =
				((ItemView)o2).getManufSku();
			return Utility.compareToIgnoreCase(sku1, sku2);
		}
	};
        
        static final Comparator ITEM_STATUS_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String status1 =
				((ItemView)o1).getStatusCd();
			String status2 =
				((ItemView)o2).getStatusCd();
			return Utility.compareToIgnoreCase(status1, status2);
		}
	};
    ...
    static final Comparator COST_CENTER_DISCOUNT_COMPARE = new Comparator() {
        public int compare(Object o1, Object o2) {
            String discount1 = ((CostCenterData) o1).getAllocateDiscount();
            String discount2 = ((CostCenterData) o2).getAllocateDiscount();
            return Utility.compareToIgnoreCase(discount1, discount2);
        }
    };
		...
		static final Comparator ORDER_ITEM_ACTION_DATE_COMPARE = new Comparator() {
			public int compare(Object o1, Object o2)
			{
				Date orderDate1 = ((OrderItemActionData)o1).getActionDate();
				Date orderDate2 = ((OrderItemActionData)o2).getActionDate();
		...
		static final Comparator ORDER_STATUS_DESC_PLACEDBY_COMPARE = new Comparator() {
			...
			{
				String addBy1 = null;
				UserData placedBy1 = ((OrderStatusDescData)o1).getPlacedBy();
				if (placedBy1 != null) {
        	       			addBy1 = (placedBy1.getLastName() != null ? placedBy1.getLastName() + " " : "") +
	        	                (placedBy1.getFirstName() != null ? placedBy1.getFirstName() : "");
                		}
				UserData placedBy2 = ((OrderStatusDescData)o2).getPlacedBy();
				String addBy2 = null;
				if (placedBy2 != null ) {
          			        addBy2 = (placedBy2.getLastName() != null ? placedBy2.getLastName() + " " : "") +
                             		(placedBy2.getFirstName() != null ? placedBy2.getFirstName() : "");
		                }
		...
		static final Comparator BUS_ENTITY_SHORT_DESC_COMPARE = new Comparator() {
			public int compare(Object o1, Object o2) {
                ...
                static final Comparator NOTE_VIEW_DATE_COMPARE = new Comparator() {
            		public int compare(Object o1, Object o2)
            		{
            			Date d1 = ((NoteView)o1).getModDate();
            			Date d2 = ((NoteView)o2).getModDate();
            			if (d1 == null ) {
            				d1 = new Date(0);
            			}
            			if (d2 == null ) {
	...
	static final Comparator LANGUAGE_CODE_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String code1 = ((LanguageData)o1).getLanguageCode();
			String code2 = ((LanguageData)o2).getLanguageCode();
			return  Utility.compareToIgnoreCase(code1, code2);
		}
	};

	static final Comparator LANGUAGE_SHORT_DESC_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String code1 = ((LanguageData)o1).getShortDesc();
			String code2 = ((LanguageData)o2).getShortDesc();
			return  Utility.compareToIgnoreCase(code1, code2);
		}
	};

	static final Comparator LANGUAGE_UI_NAME_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String code1 = ((LanguageData)o1).getUiName();
			String code2 = ((LanguageData)o2).getUiName();
			return  Utility.compareToIgnoreCase(code1, code2);
		}
	};

	static final Comparator LANGUAGE_TRANSLATED_NAME_COMPARE = new Comparator() {
		public int compare(Object o1, Object o2)
		{
			String code1 = ((LanguageData)o1).getTranslatedName();
			String code2 = ((LanguageData)o2).getTranslatedName();
			return  Utility.compareToIgnoreCase(code1, code2);
		}
	};
		 ...
		 *  <code>sort</code>
		 *
		 *@param  accounts     an <code>AccountSearchResultViewVector</code> list
		 *@param  sortField    String specifying field to sort on
		 *@exception  Exception  if an error occurs
		 */
		public static void sort(AccountSearchResultViewVector accounts, String sortField)
		{
			...
			if (sortField.equals("name")) {
				...
				Collections.sort(accounts, ACCOUNT_ADDRESS_COMPARE);
			} else if (sortField.equals("city")) {
				Collections.sort(accounts, ACCOUNT_CITY_COMPARE);
			} else if (sortField.equals("state")) {
				Collections.sort(accounts, ACCOUNT_STATE_COMPARE);
		 ...
		 *@exception  Exception  if an error occurs
		 */
		public static void sort(OrderGuideDataVector orderguides, String sortField) {
		 ...
		 *  <code>sort</code>
		 *
		 *@param  contractItems a <code>StagedItemDataVector</code> list
		 *@param  sortField  String specifying field to sort on
		 *@exception  Exception  if an error occurs
		 */
		public static void sort(StagedItemDataVector stagedItems, String sortField)
		throws Exception {
			...
			if (sortField.equals("itemid")) {
				Collections.sort(stagedItems, STAGED_ITEM_ID_COMPARE);
			} else if(sortField.equals("itemname")) {
				Collections.sort(stagedItems, STAGED_ITEM_NAME_COMPARE);
			} else if(sortField.equals("itemcategory")) {
				Collections.sort(stagedItems, STAGED_ITEM_CATEGORY_COMPARE);
			} else if(sortField.equals("itemmanufacturer")) {
				Collections.sort(stagedItems, STAGED_ITEM_MANUFACTURER_COMPARE);
			} else if(sortField.equals("itemskunum")) {
				Collections.sort(stagedItems, STAGED_ITEM_SKU_COMPARE);
			}
		}

                public static void sort(ItemViewVector stagedItems, String sortField)
		throws Exception {
			...
			if (sortField.equals("itemid")) {
				Collections.sort(stagedItems, ITEM_ID_COMPARE);
			} else if(sortField.equals("itemname")) {
				Collections.sort(stagedItems, ITEM_NAME_COMPARE);
			} else if(sortField.equals("itemcategory")) {
				Collections.sort(stagedItems, ITEM_CATEGORY_COMPARE);
			} else if(sortField.equals("itemmanufacturer")) {
				Collections.sort(stagedItems, ITEM_MANUFACTURER_COMPARE);
			} else if(sortField.equals("itemskunum")) {
				Collections.sort(stagedItems, ITEM_SKU_COMPARE);
			} else if(sortField.equals("itemstatus")) {
				Collections.sort(stagedItems, ITEM_STATUS_COMPARE);
			}
		}
		...
		throws Exception {
			...
			} else if (sortField.equals("discount")) {
				Collections.sort(costcenters, COST_CENTER_DISCOUNT_COMPARE);
			}
		}
		...
		public static void sort(ShoppingCartItemDataVector shopItems,
				String sortField)
		throws Exception {
			DisplayListSort dls = new DisplayListSort();
...
//				*//	    Collections.sort(orderStatusList, ORDER_STATUS_ZIP_COMPARE);
			...
			if (sortField.equals("acctname")) {
                ...
                throws Exception {
                        ...
                        if (sortField.equals("status")) {
                                DisplayListSort.setRequestObject(request);
		...
		public static void sort(OrderItemActionDataVector orderItemActionList, String sortField)
		{
			...
			if (sortField.equals("actionDate")) {
				Collections.sort(orderItemActionList, ORDER_ITEM_ACTION_DATE_COMPARE);
			} 
		}
	  ...
	  if (sortField.equals("dateordered")) {
		...
		public static void sort(AssetViewVector v, String sortField) {
			...
			} else if (sortField.equals("assetid")) {
				Collections.sort(v, ASSET_ID_COMPARE);
			} else if (sortField.equals("assetmodel")) {
				Collections.sort(v, ASSET_MODEL_COMPARE);
			} else if (sortField.equals("assetmanufacturer")) {
				Collections.sort(v, ASSET_MANUFACTURER_COMPARE);
			} else if (sortField.equals("assetmanufacturersku")) {
				Collections.sort(v, ASSET_MANUFACTURER_SKU_COMPARE);
			} else if (sortField.equals("assetstatus")) {
				Collections.sort(v, ASSET_STATUS_COMPARE);
			}
		}
                
                public static void sort(AssetContentViewVector v, String sortField) {
			if (sortField == null) {
				return;
			}
			if (sortField.equals("contentdescription")) {
				Collections.sort(v, ASSET_CONTENT_NAME_COMPARE);
			}
		}
                
                public static void sortAssetView (HashMap map, String sortField) {
			if (sortField == null) {
                            return;
			}
                        ArrayList mapValues = new ArrayList(map.values());
                        
			if (sortField.equals("assetname")) {
				Collections.sort(mapValues, ASSET_NAME_COMPARE);
			} else if (sortField.equals("assetserial")) {
				Collections.sort(mapValues, ASSET_SERIAL_COMPARE);
			} else if (sortField.equals("assetnumber")) {
				Collections.sort(mapValues, ASSET_NUMBER_COMPARE);
			} else if (sortField.equals("assetcategory")) {
				Collections.sort(mapValues, ASSET_CATEGORY_COMPARE);
			} else if (sortField.equals("assetdateinservice")) {
				Collections.sort(mapValues, ASSET_DATE_IN_SERVICE_COMPARE);
			} else if (sortField.equals("assetsitename")) {
				Collections.sort(mapValues, ASSET_SITE_NAME_COMPARE);
			} else if (sortField.equals("assetid")) {
				Collections.sort(mapValues, ASSET_ID_COMPARE);
			} else if (sortField.equals("assetmodel")) {
				Collections.sort(mapValues, ASSET_MODEL_COMPARE);
			} else if (sortField.equals("assetmanufacturer")) {
				Collections.sort(mapValues, ASSET_MANUFACTURER_COMPARE);
			} else if (sortField.equals("assetmanufacturersku")) {
				Collections.sort(mapValues, ASSET_MANUFACTURER_SKU_COMPARE);
			} else if (sortField.equals("assetstatus")) {
				Collections.sort(mapValues, ASSET_STATUS_COMPARE);
			}
		}
        ...
        //New UI : All Orders Search Results
        public static String SORT_ORDER = Constants.ORDERS_SORT_ORDER_DESCENDING;
                
        /**
         * Order Number Comparator.
         */
         static final Comparator ALL_ORDERS_SEARCH_RESULTS_ORDER_NUM_COMPARE = new Comparator() {
    		public int compare(Object o1, Object o2) {
    			
    			String oNum1 = "";
    			String oNum2 = "";
    			try {
    				oNum1 = ((OrderStatusDescData)o1).getOrderDetail().getOrderNum();
    				if(oNum1==null) {
    					oNum1 = "";
    				}
    			} catch (Exception e) {
    			...
    			try {
    				oNum2 = ((OrderStatusDescData)o2).getOrderDetail().getOrderNum();
    				if(oNum2==null) {
    					oNum2 = "";
    				}
    			} catch (Exception e){
    			...
    			int returnValue = 0;
    			if(Constants.ORDERS_SORT_ORDER_DESCENDING.equals(SORT_ORDER)){
    				returnValue = oNum2.compareTo(oNum1);
    			} else {
    				returnValue = oNum1.compareTo(oNum2);
    			}
    			return returnValue;
    		}
    	};
    	...
    	/**
    	 * PO Number Comparator
    	 */
    	static final Comparator ALL_ORDERS_SEARCH_RESULTS_PO_NUM_COMPARE = new Comparator() {
    		public int compare(Object o1, Object o2) {
    			
    			String poNum1 = "";
    			String poNum2 = "";
    			try {
    				poNum1 = ((OrderStatusDescData)o1).getOrderDetail().getRequestPoNum();
    				if(poNum1==null) {
    					poNum1 = "";
    				}
    			} catch (Exception e) {
    			...
    			try {
    				poNum2 = ((OrderStatusDescData)o2).getOrderDetail().getRequestPoNum();
    				if (poNum2==null) {
    					poNum2 = "";
    				}
    			} catch (Exception e){
    			...
    			if(Constants.ORDERS_SORT_ORDER_DESCENDING.equals(SORT_ORDER)){
    				//returnValue = poNum2.compareTo(poNum1);
    	    		//collator follows the language natural order of the characters.
    				//returnValue = collator.compare(poNum2, poNum1);
    				// STJ-6367 Changed to general type sorting for PO# sorting
    				returnValue = poNum2.compareTo(poNum1);
    			} else {
    				//returnValue = poNum1.compareTo(poNum2);
    				//returnValue = collator.compare(poNum1, poNum2);
    				// STJ-6367 Changed to general type sorting for PO# sorting
    				returnValue = poNum1.compareTo(poNum2);
    			}
    			return returnValue;
    	...
    	/**
    	 * Order Date Comparator
    	 */
    	static final Comparator ALL_ORDERS_SEARCH_RESULTS_ORDER_DATE_COMPARE = new Comparator() {
    		public int compare(Object o1, Object o2) {
    			
    			Date oDate1 = null;
    			Date oDate2 = null;
    			try {
    				oDate1 = ((OrderStatusDescData)o1).getOrderDetail().getOriginalOrderDate();
    			} catch (Exception e) {
    			}
    			try {
    				oDate2 = ((OrderStatusDescData)o2).getOrderDetail().getOriginalOrderDate();
    			} catch (Exception e){
    			}
    			...
    			if(oDate1!=null && oDate2!=null) {
	    			if(Constants.ORDERS_SORT_ORDER_DESCENDING.equals(SORT_ORDER)){
	    				returnValue = oDate2.compareTo(oDate1);
	    			} else {
	    				returnValue = oDate1.compareTo(oDate2);
	    			}
    			}
    			return returnValue;
    		}
    	 ...
    	 * Status Comparator
    	 */
    	static final Comparator ALL_ORDERS_SEARCH_RESULTS_STATUS_COMPARE = new Comparator() {
    		public int compare(Object o1, Object o2) {
    			
    			String status1 = "";
    			String status2 = "";
    			try {
    				status1 = ((OrderStatusDescData)o1).getOrderDetail().getOrderStatusCd();
    				if(status1==null) {
    					status1 = "";
    				}
    			} catch (Exception e) {
    			...
    			try {
    				status2 = ((OrderStatusDescData)o2).getOrderDetail().getOrderStatusCd();
    				if(status2==null) {
    					status2 = "";
    				}
    			} catch (Exception e){
    			...
    			int returnValue = 0;
    			if(Constants.ORDERS_SORT_ORDER_DESCENDING.equals(SORT_ORDER)){
    				//returnValue = status2.compareTo(status1);
    	    		//collator follows the language natural order of the characters.
    				returnValue = collator.compare(status2,status1);
    			} else {
    				//returnValue = status1.compareTo(status2);
    				returnValue = collator.compare(status1,status2);
    			}
    			return returnValue;
    		}
    	};
    	 ...
    	 */
    	static final Comparator ALL_ORDERS_SEARCH_RESULTS_LOCATION_NAME_COMPARE = new Comparator() {
    		public int compare(Object o1, Object o2) {
    			
    			String locationName1 = "";
    			String locationName2 = "";
    			try {
    				locationName1 = ((OrderStatusDescData)o1).getOrderDetail().getOrderSiteName();
    			...
    			try {
    				locationName2 = ((OrderStatusDescData)o2).getOrderDetail().getOrderSiteName();
    			...
    			int returnValue = 0;
    			if(Constants.ORDERS_SORT_ORDER_DESCENDING.equals(SORT_ORDER)){
    				//returnValue = locationName2.compareTo(locationName1);
    	    		//collator follows the language natural order of the characters.
    				returnValue = collator.compare(locationName2, locationName1);
    			} else {
    				//returnValue = locationName1.compareTo(locationName2);
    				returnValue = collator.compare(locationName1, locationName2);
    			}
    			return returnValue;
    		}
    	};
    	...
    	/**
    	 * Placed By Comparator
    	 */
    	static final Comparator ALL_ORDERS_SEARCH_RESULTS_PLACED_BY_COMPARE = new Comparator() {
    		public int compare(Object o1, Object o2) {
    			
    			StringBuilder placedBy1 = new StringBuilder();
    			StringBuilder placedBy2 = new StringBuilder();
    			
    			String firstName1 = "";
    			String lastName1 = "";
    			try {
    				firstName1 = ((OrderStatusDescData)o1).getPlacedBy().getFirstName();
    				if(firstName1==null) {
    					firstName1 = "";
    				}
    			} catch (Exception e){
    			...
    			try {
    				lastName1 = ((OrderStatusDescData)o1).getPlacedBy().getLastName();
    				if(lastName1==null) {
    					lastName1 = "";
    				}
    			} catch (Exception e){
    			}
    			placedBy1.append(firstName1);
    			placedBy1.append(" ");
    			placedBy1.append(lastName1);
    			
    			String firstName2 = "";
    			String lastName2 = "";
    			try{
    				firstName2 = ((OrderStatusDescData)o2).getPlacedBy().getFirstName();
    				if(firstName2==null) {
    					firstName2 = "";
    				}
    			} catch (Exception e) {
    			...
    			try {
    				lastName2 = ((OrderStatusDescData)o2).getPlacedBy().getLastName();
    				if(lastName2==null) {
    					lastName2 = "";
    				}
    			} catch (Exception e) {
    			}
    			placedBy2.append(firstName2);
    			placedBy2.append(" ");
    			placedBy2.append(lastName2);
    			
    			int returnValue = 0;
    			if(placedBy1!=null && placedBy2!=null) {
	    			if(Constants.ORDERS_SORT_ORDER_DESCENDING.equals(SORT_ORDER)){
	    				//returnValue = placedBy2.toString().compareTo(placedBy1.toString());
	    	    		//collator follows the language natural order of the characters.
	    				returnValue = collator.compare(placedBy2.toString(), placedBy1.toString());
	    			} else {
	    				//returnValue = placedBy1.toString().compareTo(placedBy2.toString());
	    				returnValue = collator.compare(placedBy1.toString(), placedBy2.toString());
	    			}
    			}
    			return returnValue;
    		}
    	 ...
    	 * Price Comparator
    	 */
    	static final Comparator ALL_ORDERS_SEARCH_RESULTS_PRICE_COMPARE = new Comparator() {
    		public int compare(Object o1, Object o2) {
    			
    			java.math.BigDecimal price1 = null;
    			java.math.BigDecimal price2 = null;
    			try {
    				price1 = ((OrderStatusDescData)o1).getEstimatedTotal();
    			} catch (Exception e) {
    				price1 = new BigDecimal(0);
    			}
    			try {
    				price2 =  ((OrderStatusDescData)o2).getEstimatedTotal();
    			} catch (Exception e){
    	...
    	/**
    	 * Sort the all orders search results based on the specified sort field and order.
    	 * @param orderStatusList - List that needs to be sorted.
    	 * @param sortField - Field that needs to be sorted.
    	 * @param sortOrder - Sort Orders.
    	 */
    	public static synchronized void sort(HttpServletRequest request, OrderStatusDescDataVector orderStatusList, String sortField, String sortOrder) {
    		//STJ-5421
    		setRequestObject(request);
    		SORT_ORDER = sortOrder;
    		if (sortField.equals(Constants.ORDERS_SORT_FIELD_ORDER_NUMBER)) {
				Collections.sort(orderStatusList, ALL_ORDERS_SEARCH_RESULTS_ORDER_NUM_COMPARE);
			}
    		else if(sortField.equals(Constants.ORDERS_SORT_FIELD_PO_NUMBER)) {
    			Collections.sort(orderStatusList, ALL_ORDERS_SEARCH_RESULTS_PO_NUM_COMPARE);
    		}
    		else if(sortField.equals(Constants.ORDERS_SORT_FIELD_ORDER_DATE)) {
    			Collections.sort(orderStatusList, ALL_ORDERS_SEARCH_RESULTS_ORDER_DATE_COMPARE);
    		}
    		else if(sortField.equals(Constants.ORDERS_SORT_FIELD_STATUS)) {
    			Collections.sort(orderStatusList, ALL_ORDERS_SEARCH_RESULTS_STATUS_COMPARE);
    		}
    		else if(sortField.equals(Constants.ORDERS_SORT_FIELD_LOCATION_NAME)) {
    			Collections.sort(orderStatusList, ALL_ORDERS_SEARCH_RESULTS_LOCATION_NAME_COMPARE);
    		}
    		else if(sortField.equals(Constants.ORDERS_SORT_FIELD_PLACED_BY)) {
    			Collections.sort(orderStatusList, ALL_ORDERS_SEARCH_RESULTS_PLACED_BY_COMPARE);
    		}
    		else if(sortField.equals(Constants.ORDERS_SORT_FIELD_PRICE)) {
    			Collections.sort(orderStatusList, ALL_ORDERS_SEARCH_RESULTS_PRICE_COMPARE);
    		}
    	}
    	    
    	public static void sort(NoteViewVector noteViewV, String sortField, String sortOrder) {
    		SORT_ORDER = sortOrder;
    		if (sortField.equals(Constants.NOTES_SORT_EFF_DATE)) {
				Collections.sort(noteViewV, NOTE_VIEW_DATE_COMPARE);
			}
    	}


    	public static void sort(LanguageDataVector langVector, String sortField) {
    		if (sortField.equals("languageCode")) {
				Collections.sort(langVector, LANGUAGE_CODE_COMPARE);
			} else if (sortField.equals("shortDesc")) {
				Collections.sort(langVector, LANGUAGE_SHORT_DESC_COMPARE);
			} else if (sortField.equals("uiName")) {
				Collections.sort(langVector, LANGUAGE_UI_NAME_COMPARE);
			} else if (sortField.equals("translatedName")) {
				Collections.sort(langVector, LANGUAGE_TRANSLATED_NAME_COMPARE);
            }
    	}
}
