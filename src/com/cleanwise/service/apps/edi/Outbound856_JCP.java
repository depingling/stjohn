...
public class Outbound856_JCP extends Outbound856
{
	...
	throws OBOEException
	{
		...
		String vItemUom = Utility.getActualUom(currOutboundReq.getStoreType(), currItem);
	...
	throws Exception
	{
		...
		mTotalItemsWeight = 0;
		if ( currOutboundReq.getManifestItemView() != null) {
			mTotalItemsWeight = ProductData.extractWeightValueInLbs
			(currOutboundReq.getManifestItemView().getWeightString());
		}
