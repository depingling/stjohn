...
if ( null != appUser && null != appUser.getSite() &&
  ...
  if ( null != address ) {
    ...
    if(shippingAddress!=null && addr2!=null && addr2.trim().length()>0 ) shippingAddress+=" "+addr2;
    String addr3 = address.getAddress3();
    if(shippingAddress!=null && addr3!=null && addr3.trim().length()>0 ) shippingAddress+=" "+addr3;
    String addr4 = address.getAddress4();
    if(shippingAddress!=null && addr4!=null && addr4.trim().length()>0 ) shippingAddress+=" "+addr4;
...
<td width="<%=Constants.HEADER_LAST_LOGIN_WIDTH%>" align="right">
<jsp:include flush='true' page="f_siteProps.jsp"/>
...
<td align="right" colspan="4">
    <table cellpadding="0" cellspacing="0" class="headernavtable" style="border-collapse: collapse;">
        ...
        <td align="right">
            <a class="headernavlinkstart" href="../userportal/customerAccountManagementProfile.do?action=customer_profile">
                <app:storeMessage key="shop.header.text.myaccount"/></a>
        </td>
<%
