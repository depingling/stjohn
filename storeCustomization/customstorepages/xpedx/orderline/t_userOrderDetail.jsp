     ...
     <tr bgcolor="<%=ClwCustomizer.getEvenRowColor(session,(Integer)oidx)%>">
      ...
      <td colspan="4">
        <b><app:storeMessage key="shop.orderStatus.text.purchaseOrder"/></b>
            <logic:present name="item" property="orderItem.erpPoNum">
...
%>
<%String fileName="replacedOrders.jsp";%>

<jsp:include page="<%=ClwCustomizer.getRootFilePath(request, fileName)%>" flush="true" />
<% }} %>
</td></tr>
</table>
</td></tr>
