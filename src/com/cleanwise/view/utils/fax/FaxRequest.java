...
public class FaxRequest {
    ...
    public Object clone(){
        FaxRequest clone = new FaxRequest(this.receiverFaxNum, this.receiverName, this.receiverCompany);
    ...
    /**
     *Creates a new instance of FaxRequest with a set of default values to be used for each fax
     ...
     */
    public FaxRequest(String pReceiverFaxNum, String pReceiverName, String pReceiverCompany) {
        //for testing
    ...
    /** Creates a new instance of FaxRequest */
    public FaxRequest() {
    }
