...
<head>
<title>Operations Store Admin Home: Order Status</title>
...
<html:form name="ORDER_OP_DETAIL_FORM" action="/storeportal/storeOrderOpDetailPrint.do"
...
<tr><td colspan="18" class="mainbody">&nbsp;</td></tr>
    <tr>
        <td><b>Line&nbsp;#</b></td>
        <td class="resultscolumna"><b>Dist Order#</b></td>
        <td><b>Outbound PO#</b></td>
        <td class="resultscolumna"><b>CW SKU#</b></td>
        <td><b>Dist SKU#</b></td>
...
<logic:iterate id="itemele" indexId="i" name="ORDER_OP_DETAIL_FORM" property="orderItemDescList" scope="session" type="com.cleanwise.service.api.value.OrderItemDescData">
 ...
 <% String linkHref = new String("storeOrderOpItemDetail.do?action=view&id=" + key);%>
