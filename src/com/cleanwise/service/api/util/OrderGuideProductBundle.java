...
public class OrderGuideProductBundle extends DefaultProductBundle {

    public OrderGuideProductBundle(String pStoreType, int pSiteId, ProductDataVector pProducts) {
