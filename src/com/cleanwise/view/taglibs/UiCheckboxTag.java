...
public class UiCheckboxTag extends CheckboxTag {

    private static final Logger log = Logger.getLogger(UiCheckboxTag.class);
    ...
    public int doStartTag() throws JspException {
        ...
        if (ancestorTag == null) {
            String message = "UiCheckboxTag tag must be nested within a UiControlElementConfigTag tag.";
