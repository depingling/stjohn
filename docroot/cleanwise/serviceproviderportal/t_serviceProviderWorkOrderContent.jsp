...
<tr>
    ...
    <html:form name="USER_WORK_ORDER_CONTENT_MGR_FORM" action="/serviceproviderportal/workOrderContent.do" scope="session"  enctype="multipart/form-data">
                            ...
                            <tr class="customerltbkground" valign="top">
                                <div align="center" class="itemheadmargin">
                                    <span class="shopitemhead">
                                         <td width="3%">&nbsp;</td>
                                         <td align="center">
                                             <b><app:storeMessage key="userWorkOrder.text.assocDocs.longDesc"/></b>
                                         </td>
                                         <td width="3%">&nbsp;</td>
                                    </span>
                                </div>
                ...
                <tr>
                    <td align="center" colspan="6">
                        ...
                        <logic:greaterThan name="wrkcId" value="0">
                            <html:button property="action" styleClass="store_fb" onclick="actionSubmit(0, 'remove');">
    ...
    <html:hidden property="display" value="t_serviceProviderWorkOrderDetail"/>
