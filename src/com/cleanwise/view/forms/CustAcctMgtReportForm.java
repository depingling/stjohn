 ...
 * @author Tim Besser
 */
public final class CustAcctMgtReportForm extends StorePortalBaseForm {

    private String mReportTypeCd = new String("");
    private String mReportDbName = new String("");
    ...
    private String[] mSelectedDistributors = new String[0];
    private DistributorDataVector mSelectedDistList = new DistributorDataVector();
    ...
    private boolean mSelectLocationFlag = true;
    ...
    DistributorDataVector mDistFilter = new DistributorDataVector();
    private AccountUIViewVector mAccountFilter = new AccountUIViewVector();

    private ItemViewVector itemFilter;

    private ReportingDto _genericReportingInfo;   

	/**
	 * @return the _genericReportingInfo
	 */
	public final ReportingDto getGenericReportingInfo() {
		if(_genericReportingInfo==null) {
			_genericReportingInfo = new ReportingDto();
		}
		return _genericReportingInfo;
	}

	/**
	 * @param reportingInfo the _genericReportingInfo to set
	 */
	public final void setGenericReportingInfo(ReportingDto genericReportingInfo) {
		_genericReportingInfo = genericReportingInfo;
	}
    ...
    public ArrayList getDistIdList() {
        if (null == this.mDistIdList) {
            this.mDistIdList = new ArrayList();
        }
	return this.mDistIdList;
    }


    public void setDistIdList(ArrayList argDistIdList){
	this.mDistIdList = argDistIdList;
    }
    ...
    /**
     * Gets the value of mReportDbName
     *
     * @return the value of mReportDbName
     */
    public String getReportDbName() {
	return this.mReportDbName;
    }

    /**
     * Sets the value of mReportDbName
     *
     * @param argReportDbName Value to assign to this.mReportDbName
     */
    public void setReportDbName(String argReportDbName){
	this.mReportDbName = argReportDbName;
    }
    ...
    public String [] getSelectedDistributors() {
        return mSelectedDistributors;
    }

    public void setSelectedDistributors(String[] pDistIds) {
        mSelectedDistributors = pDistIds;
    }
    ...
    public DistributorDataVector getSelectedDistList() {
        if (null == this.mSelectedDistList) {
            this.mSelectedDistList = new DistributorDataVector();
        }
	return this.mSelectedDistList;
    }
     ...
     * @param arg Value to assign to this.mSelectedSiteList
     */
    public void setSelectedDistList(DistributorDataVector arg){
	this.mSelectedDistList = arg;
    }
    /**
    ...
    public void setDistFilter(DistributorDataVector pDistFilter) {
        this.mDistFilter = pDistFilter;
    }
