...
<html:form name="PROFILING_MGR_FORM" action="adminportal/profilingSurveyMgr.do" type="com.cleanwise.view.forms.ProfilingMgrSurveyForm" enctype="multipart/form-data">
<tr>
        <td><b>Survey Id:</b></td>
        <td><bean:write name="PROFILING_MGR_FORM" property="profile.profileView.profileData.profileId"/></td>
        <td><b>Survey Name:</b></td>
        <td colspan="2"><html:text name="PROFILING_MGR_FORM" property="profile.profileView.profileData.shortDesc" size="30"/></td>
        <td><b>Help Text:</b></td>
        <td colspan="2"><html:text name="PROFILING_MGR_FORM" property="profile.profileView.profileData.helpText" size="30"/></td>
</tr>
<tr>
        <td><b>Add By:</b></td><td><bean:write name="PROFILING_MGR_FORM" property="profile.profileView.profileData.addBy"/></td>
        <td><b>Add Date:</b></td>
        <td>
            <logic:present name="PROFILING_MGR_FORM" property="profile.profileView.profileData.addDate">
                <bean:define id="addDate" name="PROFILING_MGR_FORM" property="profile.profileView.profileData.addDate"/>
                <i18n:formatDate value="<%=addDate%>" pattern="MM/dd/yyyy" locale="<%=Locale.US%>"/>
            </logic:present>
        </td>
        <td><b>Mod By:</b></td><td><bean:write name="PROFILING_MGR_FORM" property="profile.profileView.profileData.modBy"/></td>
        <td><b>Mod Date:</b></td>
        <td>
            <logic:present name="PROFILING_MGR_FORM" property="profile.profileView.profileData.modDate">
                <bean:define id="modDate" name="PROFILING_MGR_FORM" property="profile.profileView.profileData.modDate"/>
...
<tr>
        <td colspan="8" align="center">
                ...
                onclick="popWindow('profilingSurveyMgrPreview.do?action=preview','profiling');"
                value="Preview" />
        </td>
</tr>
<tr>
...
<tr>
        <td colspan="8">
           <table border=1>
                ...
                %>
               <app:ProfilingSurvey form="PROFILING_MGR_FORM" name="profile"
