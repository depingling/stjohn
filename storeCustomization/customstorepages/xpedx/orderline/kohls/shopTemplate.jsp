...
function viewExcelFormat() {
  var loc = "printerFriendlyOrderGuide.do?action=excelPrintCatalog&showMfg=n&showMfgSku=n";
...
<% String itemsStampS = ""+theForm.getItemsStamp(); %>
<bean:define id="numCols" value="12"/>
<%
...
<html:hidden name="SHOP_FORM" property="itemsSubmitStamp" value="<%=itemsStampS%>" />
  ...
  <table border="0" cellpadding="3" cellspacing="0" align="right">
    ...
    <tr>
      ...
      <td colspan="2" align="right">
       <b><app:storeMessage key="shop.catalog.text.ourSku#"/></b>&nbsp;
...
/>
    ...
    <tr>
      <td>&nbsp</td>
      <td colspan="2" align="right">
        <app:storeMessage key="shop.catalog.text.certifiedCompany"/>
  ...
  <logic:iterate id="item" name="SHOP_FORM" property="cartItems"
   ...
   type="com.cleanwise.service.api.value.ShoppingCartItemData">
     ...
     <% if(theForm.isCategoryChanged(((Integer)kkk).intValue())) { %>
       <tr>
       <td class="shopcategory" colspan="12"><bean:write name="item" property="categoryPath"/>
</td>
       </tr>
     <% } %>
     <% } %>
