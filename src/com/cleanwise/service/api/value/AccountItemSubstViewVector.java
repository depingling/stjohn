...
/**
 * Title:        AccountItemSubstViewVector
 * Description:  Container object for AccountItemSubstView objects
 * Purpose:      Provides container storage for AccountItemSubstView objects.
...
/**
 * <code>AccountItemSubstViewVector</code>
 */
public class AccountItemSubstViewVector extends java.util.ArrayList implements Comparator
{
    private static final long serialVersionUID = -369432397847640629L;
    /**
     * Constructor.
     */
    public AccountItemSubstViewVector () {}
    ...
    */
    ...
    {
      int retcode = -1;
      AccountItemSubstView obj1 = (AccountItemSubstView)o1;
      AccountItemSubstView obj2 = (AccountItemSubstView)o2;
      ...
      if("SubstStatusCd".equalsIgnoreCase(_sortField)) {
        String i1 = obj1.getSubstStatusCd();
        String i2 = obj2.getSubstStatusCd();
        if(i1==null) if(i2==null) retcode = 0; else  retcode = -1;
        else if(i2==null) retcode = 1; else retcode = i1.compareTo(i2);
      }
