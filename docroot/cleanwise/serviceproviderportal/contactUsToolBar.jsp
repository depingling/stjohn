...
String toolLink01 = "/"+rootDir+"/serviceproviderportal/contactus_address.do";
String toolLink02 = "/"+rootDir+"/serviceproviderportal/contactus_email.do?action=compose_email_contact_msg";
%>
