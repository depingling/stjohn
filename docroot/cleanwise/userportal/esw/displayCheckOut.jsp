...
String content = ClwCustomizer.getStoreFilePath(request, Constants.PORTAL_ESW, "contentShowCheckOut.jsp");
String footer = ClwCustomizer.getStoreFilePath(request, Constants.PORTAL_ESW, "footer.jsp");

if (theForm.getCheckOutForm().getConfirmationFlag()) { 
	content = ClwCustomizer.getStoreFilePath(request, Constants.PORTAL_ESW, "contentViewOrderConfirmation.jsp");
}
