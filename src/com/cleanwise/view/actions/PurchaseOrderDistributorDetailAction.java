...
public final class PurchaseOrderDistributorDetailAction extends ActionSuper {
    ...
    throws IOException, ServletException {
        ...
        String viewStr = "view";
        String setAllQuantitiesStr = "Set All Quantities";
        ...
        try {
            ...
            if (action.equals(viewStr)) {
                ...
                ae = PurchaseOrderOpLogic.note(request, form);
            ...
            }else if (action.equals(setAllQuantitiesStr)){
                ae = PurchaseOrderOpLogic.updateItemsQtyForAction(request, form);
