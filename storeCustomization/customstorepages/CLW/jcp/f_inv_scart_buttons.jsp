...
-->
<td>
    <a href="#" class="linkButton" onclick="actionMultiSubmit('submitQty','saveJcpInventoryCart');">
        <img src='<%=IPTH + "/b_save.gif"%>' border="0"/>
...
<td>
    <a href="#" class="linkButton" onclick="actionMultiSubmit('submitQty','removeInvAll');">
        <img src='<%=IPTH + "/b_remove.gif"%>' border="0"/>
        <app:storeMessage key="global.label.removeNonInventory"/>
    </a>
</td>
