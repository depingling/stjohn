...
<html:form name="KNOWLEDGE_OP_NOTE_DETAIL_FORM" action="console/knowledgeOpNoteDetail.do"
scope="session" type="com.cleanwise.view.forms.KnowledgeOpDetailForm">

<tr> 
	<td colspan="6" class="largeheader">Knowledge Note Detail</td>	
</tr>	
...
<% if (! "view".equals(action) ) {  %>	
	<td colspan="5">
		<html:text name="KNOWLEDGE_OP_NOTE_DETAIL_FORM" property="noteDetail.shortDesc" size="60" maxlength="255" />
		<span class="reqind">*</span>
	</td>
<%  } else if ("view".equals(action)) {  %>
	<td colspan="5"><bean:write name="KNOWLEDGE_OP_NOTE_DETAIL_FORM" property="noteDetail.shortDesc" /></td>
<% }  %>	
</tr>	
...
<% if ( "edit".equals(action) || "view".equals(action) ) {  %>	
	<td colspan="2">
		<bean:define id="addDate" name="KNOWLEDGE_OP_NOTE_DETAIL_FORM" property="noteDetail.addDate" />
		<bean:define id="addTime" name="KNOWLEDGE_OP_NOTE_DETAIL_FORM" property="noteDetail.addTime" />
...
<% if ("edit".equals(action) ) {  %>	
	<td><bean:write name="KNOWLEDGE_OP_NOTE_DETAIL_FORM" property="noteDetail.addBy" scope="session"/></td>	
<% } else { %>	
...
<tr>
	<td colspan="6">
<% if ( ! "view".equals(action)  ) {  %>	
		<html:textarea name="KNOWLEDGE_OP_NOTE_DETAIL_FORM" cols="60" property="noteDetail.value"/>
		<span class="reqind" valign="top">*</span>		
<%  } else if ("view".equals(action)) {  %>
		<bean:define id="comments" name="KNOWLEDGE_OP_NOTE_DETAIL_FORM" property="noteDetail.value" type="java.lang.String"/>
