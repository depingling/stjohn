/*
 * DistrPerfByAccRegDsrJDGrowthReport.java
 *
 ...
 * @param pEndDate end of the period,
  */
public class DistrPerfByAccRegDsrJDGrowthReport  extends DistrPerfByAccRegDsrJDReport implements GenericReportMulti {
 ...
 protected String getTitle() {
   String title = "Performance by Account by Region by DSR with growth" ;
 return title;
}
...
protected DistrPerfJPReportViewVector getResultOfQuery(Connection conn, Map pParams ) throws Exception{
  ...
  String selectSql =
     ...
     " union  \n" +
       selectSqlPriorY +
     ") g \n" +
     " order by BRANCH,  nvl(NET_SALES_GROWTH,0) desc \n";
