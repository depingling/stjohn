...
<tr>
    <td width="10">&nbsp;</td>
    <td>
        <b><app:storeMessage key="newxpdex.storeProfile.specialItems.header"/></b><br>
        <app:storeMessage key="newxpdex.storeProfile.lable.header"/>
    </td>
</tr>
...
<tbody id="questions">
<%
String childPrefix = "<td><div align=right>";
String childPostfix = "";
...
String allPostfix = "</tr>";
%>



<app:ProfilingSurvey form="SITE_SHOPPING_CONTROL_FORM" name="profile"
  ...
  profileStatusCdPrefix=" <b>Status:</b>" readOnlyPrefix=""
  profileMetaPrefix="" metaHelpPrefix="<%=metaHelpPrefix%>"
  errorMessgePrefix="<font color=red>" errorMessgePostfix="</font>"
  otherStyle="display:none" useClone="false"
  admin="false" readOnly="false" debug="false"
  datePromptText="<%=datePromptText%>"
  inputTextPostfix="</td>"
  inputTextPrefix="</div></td><td width=10>&nbsp;</td><td>"
  showModDate="true"
  textInputWidth="8"
/>
</tbody>
    ...
    function updateSpecialItems() {
        document.forms['SITE_SHOPPING_CONTROL_FORM'].action.value = "update_surveys";
...
<tr>
        <td colspan="2" align="center">
            ...
            <app:xpedxButton label='newxpdex.storeProfile.lable.updateSpecialItems'
                url="#"  onClick='updateSpecialItems(); return false;' />
            </tr></table>
        </td>
</tr>

<logic:equal name="lastAction" scope="request" value="update_surveys">
<tr><td align="center" colspan="2"><font color="red"><html:errors/></font></td></tr>
</logic:equal>
<logic:notEmpty name="surveySuccessMessage" scope="request">
    <tr><td align="center" colspan="2"><font color="blue"><b><bean:write name="surveySuccessMessage" scope="request"/></b></font></td></tr>
</logic:notEmpty>
