  ...
  <table border="0" cellpadding="3" cellspacing="0" align="right">
    ...
    <tr>
      ...
      <% if (theForm.getAppUser().getUserAccount().isHideItemMfg()) { %>
        ...
        <td><html:text name="SHOP_FORM" property="searchSku" size="16" onchange="javascript: f_cf();" onblur="javascript: f_cf();" /></td>
      <% } else { %>
      <td colspan="2" align="right">
        ...
        <html:text name="SHOP_FORM" property="searchSku" size="16" onchange="javascript: f_cf();" onblur="javascript: f_cf();" />
      </td>
      <% } %>
    </tr>
    <tr>
  ...
  <img src="<%=IMGPath%>/cw_spacer.gif" height="1">
    ...
    <tr>
      <jsp:include flush="true" page="<%=ClwCustomizer.getStoreFilePath(request,\"f_addtocart_buttons.jsp\")%>">
        ...
        <jsp:param name="formId" value="items"/>
        <jsp:param name="shopAction" value="addToCart"/>
        <jsp:param name="invShopAction" value="sc_addToModInvCart"/>
     </jsp:include>
        <td>
...
%>
  ...
  <logic:iterate id="item" name="SHOP_FORM" property="cartItems"
   ...
   type="com.cleanwise.service.api.value.ShoppingCartItemData">
     ...
     <% CatalogCategoryDataVector categories = item.getProduct().getCatalogCategories();
        CatalogCategoryData cat = (CatalogCategoryData)categories.get(0);
