...
function actionMultiSubmit1(actionDef, action) {
...
<% if(!toBeConsolidatedFl) { %>
<html:button styleClass="store_fb" property="action" onclick="this.disabled=true;actionMultiSubmit1('BBBBBBB', 'Approve');">
...
<br><html:button styleClass="store_fb" property="action"
  onclick="this.disabled=true;actionMultiSubmit1('BBBBBBB', 'ApproveOn');" >
