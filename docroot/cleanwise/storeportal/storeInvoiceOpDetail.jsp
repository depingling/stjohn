...
<html:html>
<head>
<title>Operations Store Admin Home: Invoice</title>
...
<html:form name="INVOICE_OP_DETAIL_FORM" action="/storeportal/storeInvoiceOpDetail.do"
        ...
        <tr>
          <td colspan="6" align="center">
            <input type="button" onclick="popLinkGlobal('storeOrderOpNote.do?action=view&orderid=<%=orderId%>');" value="View All Order Detail Notes" >
            &nbsp;<input type="button" onclick="popLinkGlobal('storeOrderOpNote.do?action=add&orderid=<%=orderId%>');" value="Add Order Detail Note" >
            &nbsp;<input type="button" onclick="popPrintGlobal('storeOrderOpDetailPrint.do?action=view&amp;id=<%=orderId%>');" value="Print Order Detail">
            &nbsp;<input type="button" onclick="popPrintGlobal('storeInvoiceOpDetail.do?action=print&amp;id=<%=orderId%>');" value="Print PO Detail">
          </td>
        </tr>
...
<jsp:include flush='true' page="storeInvoiceOpDetailItemInc.jsp"/>
</logic:present>
</table>
