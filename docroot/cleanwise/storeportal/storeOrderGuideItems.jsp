...
<bean:define id="theForm" name="STORE_ITEM_ORDER_GUIDE_FORM" type="com.cleanwise.view.forms.StoreItemOrderGuideMgrForm"/>
<%
    OrderGuideDescDataVector orderGuideVector = null;
    int colQty = 0;
    int rowQty = 0;
    int rowNum = 0;
...
<jsp:include flush='true' page="locateStoreItem.jsp">
   <jsp:param name="jspFormAction"  value="/storeportal/orderguide-item.do" />
   <jsp:param name="jspFormName"    value="STORE_ITEM_ORDER_GUIDE_FORM" />
   <jsp:param name="jspSubmitIdent"     value="" />
   <jsp:param name="jspReturnFilterProperty" value="itemFilter"/>
   <jsp:param name="jspCatalogListProperty" value="orderGuideCatalogListSelectedCatItems"/>
</jsp:include>
...
<jsp:include flush='true' page="locateStoreOrderGuide.jsp">
   <jsp:param name="jspFormAction"  value="/storeportal/orderguide-item.do" />
   <jsp:param name="jspFormName"    value="STORE_ITEM_ORDER_GUIDE_FORM" />
   <jsp:param name="jspSubmitIdent"     value="" />
   <jsp:param name="jspReturnFilterProperty" value="orderGuideFilter"/>
</jsp:include>
...
<jsp:include flush='true' page="locateUploadItem.jsp">
  ...
  <html:form styleId="596" action="/storeportal/orderguide-item.do" scope="session">
...
<% } %>
        <tr> 
            <td colspan='4'>
                <b>Order Guide Filter:&nbsp;</b>
                <%
                orderGuideVector = theForm.getOrderGuideFilter();
                if (orderGuideVector != null && orderGuideVector.size() > 0) {
                    filterFl = true;
                    for (int i = 0; i < orderGuideVector.size(); ++i) {
                        OrderGuideDescData orderGuide = (OrderGuideDescData) orderGuideVector.get(i);
                %>
                &lt;<%=orderGuide.getOrderGuideName()%>&gt;
                <% 
                    } 
                %>
                <html:submit property="action" value="<%=LocatePropertyNames.CLEAR_ORDER_GUIDE_FILTER_ACTION%>" styleClass='text'/>
                <% 
                } 
                %>
                <html:submit property="action" value="<%=LocatePropertyNames.LOCATE_ORDER_GUIDE_ACTION%>" styleClass='text' />
            </td>
        </tr>
    </table>
...
<% 
if (orderGuideVector != null && orderGuideVector.size() > 0) {
    OrderGuideDescData firstOrderGuide = (OrderGuideDescData) orderGuideVector.get(0);
%>
<table ID=597 border="0" width="769" class="mainbody">
<%
    if (firstOrderGuide != null) {
%>
    <tr class="results">
        <td>&nbsp;</td>
        <td colspan="4">
            <b>Id:</b>&nbsp;<%=firstOrderGuide.getOrderGuideId()%>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b>Name:</b>&nbsp;<%=firstOrderGuide.getOrderGuideName()%>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b>Catalog Id:</b>&nbsp;<%=firstOrderGuide.getCatalogId()%>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b>Catalog:</b>&nbsp;<%=firstOrderGuide.getCatalogName()%>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b>Type:</b>&nbsp;<%=firstOrderGuide.getOrderGuideTypeCd()%>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b>Status:</b>&nbsp;<%=firstOrderGuide.getStatus()%>
        </td>
    </tr>
...
%>      
   <tr>
        ...
        <td colspan='4'>
          <b>Distr.:</b>
      <logic:present name="STORE_ITEM_ORDER_GUIDE_FORM" property="distDummy">
                <bean:write  name="STORE_ITEM_ORDER_GUIDE_FORM" property="distDummy.busEntity.shortDesc"/>(<bean:write  name="STORE_ITEM_ORDER_GUIDE_FORM" property="distDummy.busEntity.busEntityId"/>)
      </logic:present>
 ...
 <tr>
        ...
        <td colspan='4'>
          <b>Gen. Manuf:</b>
         <html:select name="STORE_ITEM_ORDER_GUIDE_FORM" property="genManufIdDummy">
                <html:option value="0">&nbsp;</html:option>
                <logic:iterate id="manuf" name="STORE_ITEM_ORDER_GUIDE_FORM" property="storeManufacturers"
 ...
 <tr>
        ...
        <td colspan='4'>
          <b>Multi Product:</b>
         <html:select name="STORE_ITEM_ORDER_GUIDE_FORM" property="multiproductIdDummy">
                <html:option value="0"><app:storeMessage  key="admin.select"/></html:option>
                <logic:iterate id="m" name="STORE_ITEM_ORDER_GUIDE_FORM" property="storeMultiproducts"
        ...
        <table ID=598><tr>
          ...
          <table ID=601>
             <tr>
                ...
                <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="tickItemsToCatalog" value="true"/></td>
             </tr>
             <tr>
                 <td><b>Items - Price:</b></td>
                 <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="tickItemsToContract" value="true"/></td>
             </tr>
             <tr>
                 <td><b>Items - Order Guide:</b></td>
                 <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="tickItemsToOrderGuide" value="true"/></td>
             </tr>
          </table>
          </td><td>
          <table ID=602>
          ...
          <table ID=604>
             <tr>
                <td><b>Dist Sku#:</b></td>
                <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="showDistSkuNumFl" value="true"/></td>
             </tr>
             <tr>
                 <td><b>Dist Uom & Pack:</b></td>
                 <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="showDistUomPackFl" value="true"/></td>
             </tr>
             <tr>
                 <td><b>Tax Exempt:</b></td>
                 <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="showTaxExemptFl" value="true"/></td>
             </tr>

             <tr>
                 <td><b>Cust Sku#:</b></td>
                 <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="showCustSkuNumFl" value="true"/></td>
             </tr>
          </table>
          </td><td>
          <table ID=605>
             <tr>
                 ...
                 <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="showDistSplFl" value="true"/></td>
             </tr>
             <tr>
                <td><b>Multi Product:</b></td>
                <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="showMultiproductsFl" value="true"/></td>
                </tr>
             <tr>
                 <td><b>Base Cost:</b></td>
                 <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="showBaseCostFl" value="true"/></td>
            </tr>
            
             <!--STJ-3785<tr>
                 <td><b>Generic Manuf:</b></td>
                 <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="showGenManufFl" value="true"/></td>
             </tr>
             <tr>
                 <td><b>Gen Manuf Sku#</b></td>
                 <td><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="showGenManufSkuNumFl" value="true"/></td>
             </tr>
             -->
             <tr>
                 <td>&nbsp;</td>
...
<logic:present name="STORE_ITEM_ORDER_GUIDE_FORM" property="itemAggrVector">
<%
...
<tbody id="resTblBdy">
   <logic:iterate id="elle" name="STORE_ITEM_ORDER_GUIDE_FORM" property="itemAggrVector" indexId="ii" type="ItemCatalogAggrView">
   <%
   ...
   <% String distIdChange = "requestDistSkuInfo("+itemId+","+ii+","+rowNum+")"; %>
    ...
    <td align="center"><html:multibox name="STORE_ITEM_ORDER_GUIDE_FORM" property="<%=prop%>" value="true"/></td>
    <td><%=skuNum%></td>
    <td><%=skuName%></td>
...
function requestDistSkuInfo(pItemId, pIndex,pRowNum) {
   ...
   var url = "orderguide-item.do?action=DistSkuInfo&distId="+distId+"&itemId="+pItemId+"&index="+pIndex;
