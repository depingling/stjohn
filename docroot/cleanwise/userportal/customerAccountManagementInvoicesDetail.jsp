...
if(appUser.isNoReporting()){
  ...
  cs = ClwCustomizer.getStoreFilePath(request, "t_custAcctMgtInvoicesDetail.jsp");
}

%>

<bean:define id="toolBarTab" type="java.lang.String" value="invoice" toScope="request"/>
