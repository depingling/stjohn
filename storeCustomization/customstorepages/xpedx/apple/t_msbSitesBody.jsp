...
<table border="0" align=center CELLSPACING=0 CELLPADDING=5 width="<%=Constants.TABLEWIDTH%>" class="tbstd">
...
<a class="shopchartheadlink" href="msbsites.do?action=sort_sites&sortField=name"><app:storeMessage key="msbSites.text.siteName"/></a></div></td>
<td class="shopcharthead"><div class="fivemargin">
<a class="shopchartheadlink" href="msbsites.do?action=sort_sites&sortField=address"><app:storeMessage key="msbSites.text.streetAddress"/></a></div></td>
<td class="shopcharthead"><div class="fivemargin">
<a class="shopchartheadlink" href="msbsites.do?action=sort_sites&sortField=city"><app:storeMessage key="msbSites.text.city"/></a></div></td>
<% if (userStore.isStateProvinceRequired())  { %>
<td class="shopcharthead"><div class="fivemargin">
<a class="shopchartheadlink" href="msbsites.do?action=sort_sites&sortField=state"><app:storeMessage key="msbSites.text.stateProvince"/></a></div></td>
<%} %>
</tr>
