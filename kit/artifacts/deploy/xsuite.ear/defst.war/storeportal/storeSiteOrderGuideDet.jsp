...
<jsp:include flush='true' page="locateStoreItem.jsp">
   <jsp:param name="jspFormAction" 	value="/storeportal/orderguidedet.do" />
   <jsp:param name="jspFormName" 	value="STORE_SITE_ORDER_GUIDE_FORM" />
...
<td>
  <html:radio name="STORE_SITE_ORDER_GUIDE_FORM"
    property="shareBuyerOrderGuides" value="true"
    disabled="true" /> Yes  <html:radio name="STORE_SITE_ORDER_GUIDE_FORM"
      property="shareBuyerOrderGuides" value="false"  disabled="true" /> No<br />
      Click <b>Detail</b> to configure this property
</td>
...
<tr>
<td><a ID=1245 class="tableheader" href="orderguidedet.do?action=sortitems&sortField=quantity">Quantity</td>
<td><a ID=1246 class="tableheader" href="orderguidedet.do?action=sortitems&sortField=amount">Extended Price</td>
<td><a ID=1247 class="tableheader" href="orderguidedet.do?action=sortitems&sortField=cwSKU">SKU</td>
<td><a ID=1248 class="tableheader" href="orderguidedet.do?action=sortitems&sortField=name">Product&nbsp;Name</td>
<td><a ID=1249 class="tableheader" href="orderguidedet.do?action=sortitems&sortField=size">Item&nbsp;Size</td>
<td><a ID=1250 class="tableheader" href="orderguidedet.do?action=sortitems&sortField=pack">Pack</td>
<td><a ID=1251 class="tableheader" href="orderguidedet.do?action=sortitems&sortField=uom">UOM</td>
<td><a ID=1252 class="tableheader" href="orderguidedet.do?action=sortitems&sortField=manufacturer">Mfg.</td>
<td><a ID=1253 class="tableheader" href="orderguidedet.do?action=sortitems&sortField=manufSKU"></b>Mfg.&nbsp;SKU</td>
<td><a ID=1254 class="tableheader" href="orderguidedet.do?action=sortitems&sortField=category">Category</td>
<td><a ID=1255 class="tableheader" href="orderguidedet.do?action=sortitems&sortField=price">MSRP</td>

<td class="tableheader">
<a ID=1256 href="javascript:SetChecked(1);">[Check&nbsp;All]</a>
<a ID=1257 href="javascript:SetChecked(0);">[Clear]</a>
<br>
Select</td>
</tr>
...
<td>
<html:multibox name="STORE_SITE_ORDER_GUIDE_FORM" property="selectItems">
...
<td align=center colspan=13>
      ...
      <html:submit property="action" value="Locate Item"/>
      <html:submit property="action">
