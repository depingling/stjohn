    ...
    <tr>
        ...
        <td>
            <html:form  action="/store/shop.do?action=orderGuideSelect">
                ...
                <html:select name="SHOP_FORM" property="templateOrderGuideId" onchange="javascript:  document.forms[0].submit();"  >
                    ...
                    <html:options  name="SHOP_FORM" property="templateOrderGuideIds" labelName="SHOP_FORM"
                                   labelProperty="templateOrderGuideNames"/>
        ...
        <td align=center width="300px">
            ...
            <form name="Personalized">
				...
				<a class="linkButton" style="font-size:12px" onclick="viewPrinterFriendly();" href="#">
				...
				<a class="linkButton" style="font-size:12px" onclick="viewExcelFormat();" href="#">
