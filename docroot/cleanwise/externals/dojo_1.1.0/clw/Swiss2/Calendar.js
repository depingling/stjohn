if(!dojo._hasResource["clw.Swiss2.Calendar"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["clw.Swiss2.Calendar"] = true;
 dojo.provide("clw.Swiss2.Calendar");

    dojo.require("dijit._Calendar");

    dojo.requireLocalization("dijit", "common", null, "ROOT,cs,de,de-ch,es,fr,fr-ch,gr,hu,it,ja,ko,pl,pt,ru,sv,zh,zh-tw", "ROOT,cs,de,de-ch,es,fr,fr-ch,gr,hu,it,ja,ko,pl,pt,ru,sv,zh,zh-tw");
