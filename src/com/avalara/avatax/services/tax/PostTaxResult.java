...
/**
 * Result data returned from {@link TaxSvcSoap#postTax}.
 * @see PostTaxRequest
 * @author greggr
 * Copyright (c) 2005, Avalara.  All rights reserved.
 */
public class PostTaxResult  extends com.avalara.avatax.services.tax.BaseResult  implements java.io.Serializable {

    /**
     *  A unique document ID created by the service and returned to the client in
     * the {@link GetTaxResult#getDocId} property.
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(PostTaxResult.class, true);
