...
<bean:define id="theForm" name="ADMIN2_BUDGET_LOADER_MGR_FORM" type="com.cleanwise.view.forms.Admin2BudgetLoaderMgrForm"/>
<%
...
<div class="text">
  ...
  <html:form styleId="1016"  action="/admin2.0/budgetloader.do"
            scope="session">
...
<table ID=1010 cellspacing="0" border="0" width="769" class="mainbody">
    ...
    <td colspan='4'><b>Select File:</b>
        <html:file name="ADMIN2_BUDGET_LOADER_MGR_FORM" property="xlsFile" size='80'/>
...
<jsp:include flush='true' page="locateStoreAccount.jsp">
   <jsp:param name="jspFormAction" 	value="/admin2.0/budgetloader.do" />
   <jsp:param name="jspFormName" 	value="ADMIN2_BUDGET_LOADER_MGR_FORM" />
   ...
   <jsp:param name="fiscalYearColumnRequied" 	value="true" />
</jsp:include>
