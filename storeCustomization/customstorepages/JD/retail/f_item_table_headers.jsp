...
<td class="shopcharthead"><app:storeMessage key="shoppingItems.text.manufacturer"/></td>
<td class="shopcharthead"><app:storeMessage key="shoppingItems.text.mfgSkuNum"/></td>
