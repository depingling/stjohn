...
<html:form styleId='lot' action="/store/lastOrder.do?action=lastOrderSubmit">
  ...
  <tr>
  <td colspan="9" class="tableoutline"><img src="/images/cw_spacer.gif" height="3"></td>  </tr>
  </tr>
  <!-- page contral bar -->
  ...
  <tr>
  <!-- Column heanders -->
  <td colspan="9" class="tableoutline"><img src="/images/cw_spacer.gif" height="1"></td>  </tr>
  </tr>
  <tr>
  ...
  <logic:iterate id="item" name="LAST_ORDER_FORM" property="cartItems"
   indexId="IDX"   type="com.cleanwise.service.api.value.ShoppingCartItemData">
     ...
     <% if(theForm.isCategoryChanged(((Integer)IDX).intValue())) { %>
       <tr>
       <td class="shopcategory" colspan = "9"><bean:write name="item" property="categoryPath"/></td>
       </tr>
     <% } %>
     <% } %>
