 ...
 * @author  bstevens
 */
public class ProfilingSurveyMgrAction extends ActionSuper {
    ...
    throws IOException, ServletException {
        ...
        try {
            ...
            if (action.equals(initStr)) {
                ...
                ae = ProfilingMgrLogic.getSurveyDetail(request,form,false,false);
            }else if (action.equals(createStr)) {
                ProfilingMgrLogic.setProfile(form, ProfileViewContainer.getProfileViewContainer(ProfilingMgrLogic.createEmptySurvey(request)));
