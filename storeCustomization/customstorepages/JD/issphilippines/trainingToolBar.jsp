...
<jsp:include flush="true" page="<%=t_templatorToolBar%>" >
    ...
    <jsp:param name="display01" value="customflashlanding"/>
    ...
    <jsp:param name="display02" value="customtraining"/>
    <jsp:param name="toolLable02" value="template.jd.bsc.menu.trainingContent"/>
