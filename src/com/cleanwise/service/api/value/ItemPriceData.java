...
/**
 * Title:        ItemPriceData
 * Description:  Value object extension for marshalling item price attribute value pairs.
 * Purpose:      Obtains and marshals item price information among session components.
...
/**
 * <code>ItemPriceData</code>
 */
public class ItemPriceData extends ValueObject
{
  //Do not remove or modify next line. It would break object DB saving 
  private static final long serialVersionUID = 5156861829661238776L;
  ...
  /**
   * Gets the itemId (item identifier) property
   * return int
   */
  ...
  /**
   * Sets the itemId (item identifier) property
   * @param pValue  the value we want to set
   * return none
   */
  public void setItemId(int pValue) {
    this.itemId = pValue;
  }
  ...
  /**
   * Gets the priceAmt (item list price) property
   * return int
   */
  ...
  /**
   * Sets the priceAmt (item list price) property
   * @param pValue  the value we want to set
   * return none
   */
  ...
  /**
   * Gets the discountAmt (item discount price) property
   * return int
   */
  ...
  /**
   * Sets the discountAmt (item discount price) property
   * @param pValue  the value we want to set
   * return none
   */
  ...
  /**
   * Gets the qty (item quantity) property
   * return int
   */
  public int getQty() {
    return this.qty;
  ...
  /**
   * Sets the qty (item quantity) property
   * @param pValue  the value we want to set
   * return none
   */
