  <div id="sitesConfig">
  <html:form styleId="1454" name="STORE_SVCPROV_DETAIL_FORM"  action="<%=f1sub%>" scope="session" 
  ...
  this service provider.</td>
	  ...
	  <tr> <td align="right"><b>Reference Number</b></td>
        <td>
          <html:text name="STORE_SVCPROV_DETAIL_FORM" property="searchRefNum" 
          onfocus="javascript:f_check_search();" />
          <html:radio name="STORE_SVCPROV_DETAIL_FORM" property="searchRefNumType" 
      ...
      <tr> 
        ...
        <td><html:text name="STORE_SVCPROV_DETAIL_FORM" property="confCity"/> </td>
      </tr>

      <tr> 
        <td align="right"><b>State</b></td>
        <td><html:text name="STORE_SVCPROV_DETAIL_FORM" property="confState"/> </td>
      </tr>
      ...
      <logic:iterate id="arrele" name="user.siteview.vector" 
        ...
        <tr>
          ...
          <td>
            <html:multibox name="STORE_SVCPROV_DETAIL_FORM" property="confSelectIds" 
            value="<%=eleid%>" />
          </td>
      ...
      <td>
        <html:submit property="action">
          <app:storeMessage  key="admin.button.saveServiceProviderSites"/>
        </html:submit>
      </td>
    </tr>
