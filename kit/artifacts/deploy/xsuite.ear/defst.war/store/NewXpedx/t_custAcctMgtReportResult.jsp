...
<html:form name="CUSTOMER_REPORT_FORM" 
  action="/userportal/custAcctMgtReportResult.do"
  type="com.cleanwise.view.forms.CustAcctMgtReportForm">
	  

<TABLE cellSpacing=0 cellPadding=0 border=0 width=769 align=center border=0>
<TBODY>
<tr><td>
<table class="breadcrumb"><tr class="breadcrumb">
    ...
    <td class="breadcrumb"><span class="breadcrumb">&nbsp;&gt;&nbsp;</span></td>
    <td class="breadcrumb">
	<%--<a class="breadcrumb" href="customerAccountManagement.do?action=next&reportTypeCd=<%=thisReportCd%>"><%=thisReportCd%></a>--%>
	<div class="breadcrumbCurrent"><%=thisReportCd%></div>
	</td>
</tr></table>
</td></tr>


<logic:equal name="CUSTOMER_REPORT_FORM" property="reportTypeCd" value="<%=RefCodeNames.CUSTOMER_REPORT_TYPE_CD.TOTAL_VOLUME%>">									
...
<bean:write name="CUSTOMER_REPORT_FORM" property="reportTypeCd" filter="true"/>					
</div>
<%=printMsg%>
...
<bean:define id="beginDateBefore" name="CUSTOMER_REPORT_FORM" property="beginDateBefore" />
<bean:define id="endDateBefore" name="CUSTOMER_REPORT_FORM" property="endDateBefore" />
...
<logic:iterate id="result" name="CUSTOMER_REPORT_FORM" 
...
<td class="rtext">
<bean:define id="totalAmount" name="CUSTOMER_REPORT_FORM" property="totalAmount" />
<i18n:formatCurrency value="<%=totalAmount%>" locale="<%=Locale.US%>"/>
</td>
<td class="rtext">
<bean:define id="totalAmountBefore" name="CUSTOMER_REPORT_FORM" property="totalAmountBefore" />
<i18n:formatCurrency value="<%=totalAmountBefore%>" locale="<%=Locale.US%>"/>
</td>
<td class="rtext">
<bean:define id="totalAmountChange" name="CUSTOMER_REPORT_FORM" property="totalAmountChange" />
...
<logic:equal name="CUSTOMER_REPORT_FORM" property="reportTypeCd" value="<%=RefCodeNames.CUSTOMER_REPORT_TYPE_CD.TOTAL_VOLUME_BY_LOCATION%>">									
<% genericReportFl = false; %>
<tr>
<td width="757" valign="top" class="text">
<div class="fivemargin"><img src="<%=IMGPath%>/cw_spacer.gif" height="5"><br>
...
<logic:equal name="CUSTOMER_REPORT_FORM" property="reportTypeCd" value="<%=RefCodeNames.CUSTOMER_REPORT_TYPE_CD.AVERAGE_ORDER_SIZE%>">									
<% genericReportFl = false; %>
<tr>
<td width="757" valign="top" class="text">
<div class="fivemargin"><img src="<%=IMGPath%>/cw_spacer.gif" height="5"><br>
...
<% String formerSiteName = new String(""); %> 												
<logic:iterate id="result" name="CUSTOMER_REPORT_FORM" property="resultList" scope="session" type="com.cleanwise.service.api.value.CustomerReportResultData">
<bean:define id="siteName" name="result" property="siteName" type="String"/>
<% 
if (! siteName.equals(formerSiteName)) {
formerSiteName = siteName;
...
<td class="rtext">
<bean:write name="CUSTOMER_REPORT_FORM" property="totalOrderNum" filter="true"/>
</td>
<td class="rtext">
<bean:write name="CUSTOMER_REPORT_FORM" property="totalOrderNumBefore" filter="true"/>
</td>
<td class="rtext">
<bean:write name="CUSTOMER_REPORT_FORM" property="totalOrderNumChange" filter="true"/>
</td>
</tr>
<tr class="top3dk">
<td colspan="5"><img src="<%=IMGPath%>/cw_spacer.gif" height="1" width="1"></td>
...
<td class="rtext">
<bean:define id="totalSizeNow" name="CUSTOMER_REPORT_FORM" property="avgOrderSize" />
<i18n:formatCurrency value="<%=totalSizeNow%>" locale="<%=Locale.US%>"/><br>
</td>
<td class="rtext">
<bean:define id="totalSizeBefore" name="CUSTOMER_REPORT_FORM" property="avgOrderSizeBefore" />
<i18n:formatCurrency value="<%=totalSizeBefore%>" locale="<%=Locale.US%>"/><br>							
</td>
<td class="rtext">
<bean:define id="totalSizeChange" name="CUSTOMER_REPORT_FORM" property="avgOrderSizeChange" />
...
<logic:match name="CUSTOMER_REPORT_FORM" property="reportTypeCd" 
...
<% if(genericReportFl) { %>
<jsp:include flush='true' page="f_customerGenericReport.jsp"/>
<% } %>
