...
if ( appU.isaCustServiceRep() || crcManagerFl ) {
%>
...
<%-- Order Contact fields ------------------------ --%>
    ...
    <tr>
    <td>
    <a href="#" class="linkButton" onclick="setAndSubmit('command','placeOrderForSelected');"
...
%>
     ...
     <td class="text"><div class="fivemargin">
         <bean:write name="scartItem" property="product.manufacturerName"/>&nbsp;
     </div></td>
     <td class="text"><div class="fivemargin">
       <bean:write name="scartItem" property="product.manufacturerSku"/>&nbsp;
     </div></td>
     <% } %>
