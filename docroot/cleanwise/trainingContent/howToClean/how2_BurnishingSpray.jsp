...
<p><span class="trainingsubhead"><b>Burnishing with Spray-On Maintainer</b></span></p>
...
<span class="trainingsubhead"><b>Procedures:</b></span>
	...
	<li class="trainingbullet"><span class="text">Make sure the auto scrubber’s onboard spray attachment is filled with the maintainer. If the machine has an onboard spray attachment, make sure the maintainer solution is dispensed in a fine mist<br>
	If you do not have an onboard spray attachment, apply the spray buffing solution in a fine mist with a <u>labeled</u> spray bottle. Do not use excessive amounts of the buffing solution. Spraying too much solution on the floor will result in a hazy appearance instead of a glossy shine.<br>
	Make a smooth and steady pass over the floor. Do not let the burnisher sit in one place while it is running. </span></li>
	<li class="trainingbullet"><span class="text">Check your pad frequently. If you notice finish, dirt or other particles on the pad, it is time to flip it over or get a clean pad. Failure to change your pad could result in scratching the finish.
