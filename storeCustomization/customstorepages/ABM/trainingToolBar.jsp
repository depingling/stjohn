...
<bean:define id="toolLink01"  value="../userportal/msdsTemplate.do?tabs=trainingToolBar&display=customsupervisortools"/>
<bean:define id="toolLable01" value="template.jd.bsc.menu.toolsForSupervisor"/>
<bean:define id="toolSecondaryToolBar01" value=""/>

<bean:define id="toolLink02"  value="../userportal/templator.do?tabs=trainingToolBar&display=customcleanertools"/>
<bean:define id="toolLable02" value="template.jd.bsc.menu.toolsForCleaners"/>
<bean:define id="toolSecondaryToolBar02" value=""/>

<bean:define id="toolLink03"  value="../userportal/templator.do?tabs=trainingToolBar&display=customtrainingprograms"/>
<bean:define id="toolLable03" value="template.jd.bsc.menu.programs"/>
