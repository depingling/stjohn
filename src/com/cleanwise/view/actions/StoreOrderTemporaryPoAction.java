 ...
 */
public final class StoreOrderTemporaryPoAction extends ActionSuper {
  ...
  public ActionForward performSub(
    ...
    try {
      ...
      if (action.equals("view")) {
        StoreOrderLogic.initTempPo(request, form, orderId);
        return (mapping.findForward("display"));
      }

      else if (action.equals("select")) {
        StoreOrderLogic.setTempPoDist(request, form);
        ActionErrors ae = StoreOrderLogic.printTemporaryPo(response,request, form);
        if (ae.size() > 0) {
