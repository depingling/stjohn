...
<table id="TopHeaderTable" align="center" border="0" cellpadding="0" cellspacing="0" height="100%" valign="top">
<tr valign="top">
...
<div>
<table width="<%=Constants.TABLEWIDTH800%>" border="0" cellspacing="0" cellpadding="0" align="center">
