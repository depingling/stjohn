...
<body>
  ...
  <table ID=1124 border="0" cellpadding="1" cellspacing="0" width="730" class="mainbody">
  <html:form styleId="1125" name="STORE_ORDER_DETAIL_FORM" action="/storeportal/storeOrderDetail.do"
                              type="com.cleanwise.view.forms.StoreOrderDetailForm">
    <% if(!addNoteFl) { %>
        <tr><td colspan='2' class='mediumheader'>
         <a ID=1126 href='storeOrderDetail.do?action=addSiteNote'>[Add Note]</a>
        </td>
        </tr>
    <% } else {
    ...
    <tr><td class="results">
      <html:textarea cols='77' rows='2' property='siteNoteLine' value=''/></td>
    </tr>
    </table>
    </td>
    ...
    <%
     ...
     String addRef = "storeOrderDetail.do?action=addSiteNoteLine&noteId="+noteId;
    %>
    <tr><td colspan='2' class='mediumheader'><%=nD.getTitle()%>
     <a ID=1128 href='<%=addRef%>'>[Add Line]</a>
    </td>
    </tr>
    <% int sch =0;
    ...
    <tr><td><html:textarea cols='77' rows='2' property='siteNoteLine' value=''/></td>
