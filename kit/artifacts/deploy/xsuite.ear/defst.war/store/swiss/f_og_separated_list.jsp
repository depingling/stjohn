...
<td class="shopcharthead" align="center"><%COL_COUNT++;%><app:storeMessage key="shop.og.table.header.par"/></td>
<td class="shopcharthead" align="center"><%COL_COUNT++;%><app:storeMessage key="shop.og.table.header.onHand"/></td>

<logic:equal name="SHOP_FORM" property="allowPurchase" value="true">
<td class="shopcharthead" align="center"><%COL_COUNT++;%><app:storeMessage key="shop.og.table.header.orderQty"/></td>
</logic:equal>

<logic:equal name="SHOP_FORM" property="allowPurchase" value="false">
<%COL_COUNT++;%><td class="shopcharthead">    &nbsp;</td>
</logic:equal>

<td class="shopcharthead" align="center"><%COL_COUNT++;%>&nbsp;</td>
  <td class="shopcharthead" align="center"><%COL_COUNT++;%><app:storeMessage key="shop.og.table.header.ourSkuNum"/></td>
  <td class="shopcharthead"><%COL_COUNT++;%><center><app:storeMessage key="shop.og.table.header.productName"/></center></td>
  <td class="shopcharthead" align="center"><%COL_COUNT++;%><app:storeMessage key="shop.og.table.header.size"/></td>
  <td class="shopcharthead" align="center"><%COL_COUNT++;%><app:storeMessage key="shop.og.table.header.pack"/></td>
  <td class="shopcharthead" align="center"><%COL_COUNT++;%><app:storeMessage key="shop.og.table.header.uom"/></td>
<% if (!theForm.getAppUser().getUserAccount().isHideItemMfg()) { %>
  ...
  <td class="shopcharthead" align="center"><%COL_COUNT++;%><app:storeMessage key="shop.og.table.header.manufSkuNum"/></td>
<% } %>
  <logic:equal name="SHOP_FORM" property="showPrice" value="true">
     <td class="shopcharthead" align="center"><%COL_COUNT++;%><app:storeMessage key="shop.og.table.header.price"/></td>
     <td class="shopcharthead" align="center"><%COL_COUNT++;%><app:storeMessage key="shop.og.table.header.amount"/></td>
  </logic:equal>
...
%>
 <% if (firstrow) { %>
<tr>
<td colspan="<%=numCols%>" class="shopcategory">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<% } %>
    ...
    <app:commonDisplayProd
      ...
      link="<%=itemLink1%>"
      index="<%=kidx%>"
      inputNameOnHand="<%= \"cartLine[\" + kidx + \"].inventoryQtyOnHandString\"%>"
      inputNameQuantity="<%= \"cartLine[\" + kidx + \"].inventoryQtyOnHandString\" %>"/>
    </tr>
...
<tr>
  ...
  <b><app:storeMessage key="shop.og.text.totalExcludingVOC"/><b>
     </div></td>
     <td class="text"><div class="fivemargin">
