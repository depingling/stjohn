...
<head>
<title>Operations Store Admin Home: Order Item Status</title>
...
<html:form name="ORDER_OP_ITEM_DETAIL_FORM" action="/storeportal/storeOrderOpItemDetail.do"
    type="com.cleanwise.view.forms.OrderOpItemDetailForm">
...
<table width="769" border="0" class="results">
    ...
    <tr>
        <td><b>Line #:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.orderLineNum" filter="true"/></td>
        <td><b>CW SKU #:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.itemSkuNum" filter="true"/></td>
        <td><b>Distributor Sku #:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.distItemSkuNum" filter="true"/></td>
        <td><b>Manufacturer Sku #:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.manuItemSkuNum" filter="true"/></td>
    </tr>
    <tr>
        <td><b>Dist Order #:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.distOrderNum" filter="true"/></td>
        <td><b>Product Name:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.itemShortDesc" filter="true"/></td>
        <td><b>Customer Price:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.custContractPrice" filter="true"/></td>
        <td><b>Manufacturer:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.manuItemShortDesc" filter="true"/></td>
    </tr>   
    <tr>
        <td><b>ERP Order #:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.erpOrderNum" filter="true"/></td>
        <td><b>Item Size:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.itemSize" filter="true"/></td>
        <td><b>CW Cost:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.distItemCost" filter="true"/></td>
    </tr>
    <tr>
        <td><b>Outbound PO #:</b></td>
        <td>
            <logic:present  name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.outboundPoNum">
                <bean:write  name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.outboundPoNum" filter="true"/>
            </logic:present>
            <logic:notPresent   name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.outboundPoNum">
                N/A
            </logic:notPresent>
        </td>
        <td><b>UOM:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.itemUom" filter="true"/></td>
        <td><b>Quantity:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.totalQuantityOrdered" filter="true"/></td>
    </tr>
    <tr>
        <td><b>Distributor Name:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.distName" filter="true"/></td>
        <td><b>Pack:</b></td>
        <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItem.itemPack" filter="true"/></td>
        <td colspan="2">&nbsp;</td>
    </tr>   
</table>                
        </td>   
...
<bean:size id="itemCount" name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItemActionList" />
<bean:write name="itemCount" />
</td>
</tr>

<logic:present name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItemActionList">
<tr>
<td><b>Action ID</b></td>
...
<td><b>Action CD</b></td>
<td class="resultscolumna"><a href="storeOrderOpItemDetail.do?action=sortitemdetails&sortField=date"><b>Action Date</b></a></td>
</tr>

<logic:iterate id="itemele" indexId="i" name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItemActionList" scope="session" type="com.cleanwise.service.api.value.OrderItemActionData">
<tr>
...
<bean:size id="subCount" name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItemSubstitutionList" />
<bean:write name="subCount" />
</td>
</tr>

<logic:present name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItemSubstitutionList">
<tr>
...
<logic:iterate id="subele" indexId="j" name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.orderItemSubstitutionList" scope="session" type="com.cleanwise.service.api.value.ItemSubstitutionData">
<tr>
...
<logic:present name="ORDER_OP_ITEM_DETAIL_FORM" property="invoiceDistList">
<bean:define id="invDistDetailList" name="ORDER_OP_ITEM_DETAIL_FORM" property="orderItemDesc.invoiceDistDetailList" type="com.cleanwise.service.api.value.InvoiceDistDetailDataVector" />
<logic:iterate id="invdistele" indexId="k" name="ORDER_OP_ITEM_DETAIL_FORM" property="invoiceDistList" scope="session" type="com.cleanwise.service.api.value.InvoiceDistData">
        ...
        <td colspan="6">
            <table width="769" border="0" class="mainbody">
                ...
                <tr>
                    ...
                    <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="acceptedNum"/>&nbsp;</td>
                    <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="substitutedNum"/>&nbsp;</td>
                    <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="shippedNum"/>&nbsp;</td>
                    <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="backorderedNum"/>&nbsp;</td>
                    <td><bean:write name="ORDER_OP_ITEM_DETAIL_FORM" property="invoicedNum"/>&nbsp;</td>
                </tr>
            </table>
        </td>
    </tr>                                                   
