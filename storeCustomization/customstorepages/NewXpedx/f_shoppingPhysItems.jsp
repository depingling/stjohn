...
<html:form styleId="schItemsForm" action="/store/physicalCart.do">
<%
//String isGotoAnchor = (String)request.getAttribute("gotoAnchor");
if("true".equals(isGotoAnchor)){ %>
...
<table cellpadding="0" cellspacing="0" align="center"  width="100%">
     ...
     <tr><td nowrap="nowrap"><b><app:storeMessage key="shoppingCart.text.physicalCart"/></b></td></tr>
     <% itemFilter = "inventory"; %>
     <%@ include file="f_shoppingPhysHeader.jsp" %>
     <jsp:include flush='true' page='<%=ClwCustomizer.getStoreFilePath(request,"f_phys_cart_oitems.jsp")%>'>
...
<% visibilityVal = (submitParam != null && submitParam.equals("submitQty2")) ? "visible" : "hidden" ;%>
        <tr> <td>
        <div id="submitQty1" style="visibility:<%=visibilityVal%>">
