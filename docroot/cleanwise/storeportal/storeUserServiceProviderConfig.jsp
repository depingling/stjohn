<div id="spConfig">
    ...
    <html:hidden property="spconfig" value="true"/>
    <table ID=1419 width="769" class="results">
      ...
      <logic:present name="user.serviceprovider.vector">
      <bean:size id="rescount"  name="user.serviceprovider.vector"/>
        Search result count:  <bean:write name="rescount" />
      <logic:greaterThan name="rescount" value="0">
    <table ID=1420 width="769"  class="results">
        <tr align=left>
            <td><a ID=1421 class="tableheader" href="#pgsort" onclick="sortSubmit('id');">Service&nbsp;Provider&nbsp;Id</td>
        ...
        <logic:iterate id="arrele" name="user.serviceprovider.vector">
        <tr>
            ...
            <td>
                ...
                <a ID=1428 href="sprdet.do?action=serviceproviderdetail&amp;searchType=id&amp;searchField=<%=eleid%>">
