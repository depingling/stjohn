...
<script language="JavaScript" src="../externals/timePicker.js"></script>
...
<logic:notEmpty name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="displayCostCenters">
    <jsp:include flush='true' page='<%=ClwCustomizer.getStoreFilePath(request,"f_workOrderInfo.jsp")%>'/>
</logic:notEmpty>
...
<html:form name="USER_WORK_ORDER_DETAIL_MGR_FORM" action="/userportal/userWorkOrderDetail.do" scope="session">
			...
			<td colspan="3">
				...
				<tr align="center">
					<td width="53%" valign="top">
						...
						<logic:equal name="USER_WORK_ORDER_DETAIL_MGR_FORM"  property="displayDistributorAccountReferenceNumber" value="true">
							<tr>
							    <td>
									<span class="shopassetdetailtxt">
							    ...
							    <td>
							        <bean:write name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="distributorAccountNumber"/>
							    </td>
							</tr>
						</logic:equal>

						<logic:equal name="USER_WORK_ORDER_DETAIL_MGR_FORM"  property="displayDistributorSiteReferenceNumber" value="true">
							<tr>
							    <td>
									<span class="shopassetdetailtxt">
							    ...
							    <td>
							        <bean:write name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="distributorShipToLocationNumber"/>
							    </td>
							</tr>
						</logic:equal>
...
<%///////////////////////////////%>
							<td align="left">
                                                          <span class="shopassetdetailtxt">
                                                            <b>
                                                              <app:storeMessage key="userWorkOrder.text.receivedDate"/>:
                                                        ...
                                                        <td nowrap="nowrap" align="left">
                                                                <% if(editingAuthorized) { %>
                                                                <html:text size="8" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="receivedDate"/>
                                                                <% if ("Y".equals(isMSIE)) { %>
                                                                <a href="#"
                                                                   onClick="event.cancelBubble=true; return ShowCalendar(document.forms[0].RECEIVED_DATE, document.forms[0].receivedDate, null, -7300, 7300,null,-1);"
                                                                   title="Choose Date"><img name="RECEIVED_DATE" src="../externals/images/showCalendar.gif" width="19" height="19"
                                                                                                                        border="0"
                                                                                                                        style="position:relative"
                                                                                                                        onmouseover="window.status='Choose Date';return true"
                                                                                                                        onmouseout="window.status='';return true"></a>
                                                                <% } else { %>
                        <a href="#" onClick="showCalendar('receivedDate', event); return false;"
                            title="Choose Date">
                            <img name="RECEIVEDDATE" src="../externals/images/showCalendar.gif" width="19" height="19" border="0" align="absmiddle" style="position:relative"
                            onmouseover="window.status='Choose Date';return true"
                            onmouseout="window.status='';return true">
                        </a>
                                                                <% } %>
                                                                <% } else  { %>
                                                                <logic:present name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="receivedDate">
                                                                        <bean:define id="receivedDate" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="receivedDate" type="java.lang.String"/>
                                                                         <%if (Utility.isSet(receivedDate)) {%>
                                                                        <%=receivedDate%>
                                                                        <%//=ClwI18nUtil.formatDate(request,receivedDate,DateFormat.DEFAULT)%>
                                                                        <%}%>
                                                                </logic:present>
                                                                <% } %>
                                                        </td>
...
<%///////////////////////////////%>
							...
							<td align="left">
                                                          <span class="shopassetdetailtxt">
                                                            <b>
                                                              <app:storeMessage key="userWorkOrder.text.receivedTime"/>:
                                                              <small>(<%=ClwI18nUtil.getUITimeFormat(request)%>)</small>
                                                            </b>
                                                          </span>
                                                        </td>
<td >
  <% if(editingAuthorized) { %>
  <input id="receivedTime" name="receivedTime" value="<%=theForm.getReceivedTime()%>" type="text" size="8" maxlength="8" ONBLUR="">&nbsp;
  <IMG name="RECEIVEDTIME" SRC="../externals/images/showCalendar.gif" BORDER="0"  align="absmiddle" ONCLICK="selectTime(this,receivedTime)"
  onmouseover="window.status='Choose Date';return true"
  onmouseout="window.status='';return true" STYLE="position:relative">
  <% } else  { %>
      <logic:present name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="receivedTime">
              <bean:define id="receivedDate" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="receivedDate" type="java.lang.String"/>
              <bean:define id="receivedTime" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="receivedTime" type="java.lang.String"/>
               <%if (Utility.isSet(receivedTime)) {%>
              <%=receivedTime%>
              <%}%>
      </logic:present>
  <% } %>
                                ...
                                <td>
                                    <html:select name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="forceStatusChange">
                                            ...
                                            <html:option value="accept">
                                                <app:storeMessage  key="userWorkOrder.text.acceptWorkOrder"/>
                                            </html:option>
                                            <html:option value="reject">
                                                <app:storeMessage  key="userWorkOrder.text.rejectWorkOrder"/>
                                            </html:option>
                                    </html:select>
                                </td>
                            </tr>
				...
				<tr align="center">
					...
					<td width="33%" valign="top">
						...
						<tr>
							<td colspan="4">
								<% if(editingAuthorized) { %>
									<html:textarea rows="7" cols="36" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="longDesc"/>
								<% } else { %>
                                ...
                                <logic:greaterThan name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="workOrderId" value="0">
                                    <% if (!RefCodeNames.WORK_ORDER_STATUS_CD.COMPLETED.equals(workOrderStatus) &&
                                        ...
                                        <logic:equal name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="allowBuyWorkOrderParts" value="true">
                                            <%String redirectShop = "javascript:window.location='../userportal/userWorkOrderDetail.do?action=orderParts'";%>
                                            <html:button property="action" styleClass="store_fb" onclick='<%=redirectShop%>'>
                                                <app:storeMessage key="shop.menu.main.shopm"/>
                                            </html:button>
                                        </logic:equal>
                                    <% } %>
                                </logic:greaterThan>
                        ...
                        <logic:present name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="itemOrders">
                            <tr>
                                <td valign="top" style="padding-top: 5px;">
                                    <b><app:storeMessage key="userWorkOrder.text.webOrderNumber"/>:</b>
                                </td>
                                <td width="70%" colspan="3" align="left">
                                    <table>
                                        <logic:iterate id="itemOrder" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="itemOrders"
                                                           type="com.cleanwise.service.api.value.OrderData" indexId="j">
                                            <bean:define id="orderId" name="itemOrder" property="orderId"/>
                                            <logic:present name="itemOrder" property="orderNum">
                                                <tr id="itemOrder<%=((Integer)j).intValue()%>">
                                                    <td>

                                                        <%
                                                        String orderStatus = itemOrder.getOrderStatusCd();


                                                        if( orderStatus == null ||
                                                            orderStatus.equals(RefCodeNames.ORDER_STATUS_CD.RECEIVED) ||
                                                            orderStatus.equals(RefCodeNames.ORDER_STATUS_CD.PENDING_REVIEW) ||
                                                            orderStatus.equals(RefCodeNames.ORDER_STATUS_CD.PENDING_ORDER_REVIEW)) {%>
                                                            <bean:write name="itemOrder" property="orderNum"/>&nbsp;
                                                            (<app:storeMessage key="userWorkOrder.text.inProgress"/>)
                                                        <%} else {%>
                                                            <a href="../store/userOrderDetail.do?action=view&id=<%=orderId%>">
                                                                <bean:write name="itemOrder" property="orderNum"/>
                                                            </a>
                                                        <%}%>
                                                    </td>
...
<td align="left">
  <span class="shopassetdetailtxt">
    <b>
      <app:storeMessage key="userWorkOrder.text.quotationStartTime"/>:
      <small>(<%=ClwI18nUtil.getUITimeFormat(request)%>)</small>
    </b>
  </span>
</td>
...
<td>
 <% if(editingAuthorized) { %>
 <input id="quotedStartTime" name="quotedStartTime" value="<%=theForm.getQuotedStartTime()%>" type="text" size="8" ONBLUR="">&nbsp;
 <IMG name="QUOTEDSTARTTIME" SRC="../externals/images/showCalendar.gif" BORDER="0"  align="absmiddle" ONCLICK="selectTime(this,quotedStartTime)"
 onmouseover="window.status='Choose Date';return true"
 onmouseout="window.status='';return true" STYLE="position:relative">
 <% } else  { %>
      <logic:present name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="quotedStartTime">
              <bean:define id="quotedStartDate" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="quotedStartDate" type="java.lang.String"/>
              <bean:define id="quotedStartTime" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="quotedStartTime" type="java.lang.String"/>
               <%if (Utility.isSet(quotedStartTime)) {%>
              <%=quotedStartTime%>
              <%}%>
      </logic:present>
  <% } %>
...
<td align="left">
  <span class="shopassetdetailtxt">
    <b>
      <app:storeMessage key="userWorkOrder.text.poReceivedTime"/>:
      <small>(<%=ClwI18nUtil.getUITimeFormat(request)%>)</small>
    </b>
  </span>
</td>
...
<td nowrap="nowrap">
<% if(editingAuthorized) { %>
   <input id="quotedFinishTime" name="quotedFinishTime" type="text" value="<%=theForm.getQuotedFinishTime()%>" size="8" ONBLUR="">&nbsp;
   <IMG name="QUOTEDFINISHTIME" SRC="../externals/images/showCalendar.gif" BORDER="0"  align="absmiddle" ONCLICK="selectTime(this,quotedFinishTime)"
   onmouseover="window.status='Choose Date';return true"
   onmouseout="window.status='';return true" STYLE="position:relative">
<% } else  { %>
      <logic:present name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="quotedFinishTime">
              <bean:define id="quotedFinishDate" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="quotedFinishDate" type="java.lang.String"/>
              <bean:define id="quotedFinishTime" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="quotedFinishTime" type="java.lang.String"/>
               <%if (Utility.isSet(quotedFinishTime)) {%>
              <%=quotedFinishTime%>
              <%}%>
      </logic:present>
  <% } %>
...
<td align="left">
  <span class="shopassetdetailtxt">
    <b>
      <app:storeMessage key="userWorkOrder.text.actualStartTime"/>:
      <small>(<%=ClwI18nUtil.getUITimeFormat(request)%>)</small>
    </b>
  </span>
</td>
...
<td nowrap="nowrap">
<% if(editingAuthorized || isSendToProviderStatus) { %>
   <input id="actualStartTime" name="actualStartTime" value="<%=theForm.getActualStartTime()%>" type="text" size="8" ONBLUR="">&nbsp;
   <IMG name="ACTUALSTARTTIME" SRC="../externals/images/showCalendar.gif" BORDER="0"  align="absmiddle" ONCLICK="selectTime(this,actualStartTime)"
   onmouseover="window.status='Choose Date';return true"
   onmouseout="window.status='';return true" STYLE="position:relative">
   <% } else  { %>
      <logic:present name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="actualStartTime">
              <bean:define id="actualStartDate" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="actualStartDate" type="java.lang.String"/>
              <bean:define id="actualStartTime" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="actualStartTime" type="java.lang.String"/>
               <%if (Utility.isSet(actualStartTime)) {%>
              <%=actualStartTime%>
              <%}%>
      </logic:present>
  <% } %>
...
<td align="left">
  <span class="shopassetdetailtxt">
    <b>
      <app:storeMessage key="userWorkOrder.text.actualFinishTime"/>:
      <small>(<%=ClwI18nUtil.getUITimeFormat(request)%>)</small>
    </b>
  </span>
</td>
...
<td nowrap="nowrap">
  <% if(editingAuthorized || isSendToProviderStatus) { %>
   <input id="actualFinishTime"  name="actualFinishTime"  type="text" value="<%=theForm.getActualFinishTime()%>" size="8" ONBLUR="">&nbsp;
   <IMG name="ACTUALFINISHTIME" SRC="../externals/images/showCalendar.gif" BORDER="0"  align="absmiddle" ONCLICK="selectTime(this,actualFinishTime)"
   onmouseover="window.status='Choose Date';return true"
   onmouseout="window.status='';return true" STYLE="position:relative">
  <% } else  { %>
      <logic:present name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="actualFinishTime">
              <bean:define id="actualFinishDate" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="actualFinishDate" type="java.lang.String"/>
              <bean:define id="actualFinishTime" name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="actualFinishTime" type="java.lang.String"/>
               <%if (Utility.isSet(actualFinishTime)) {%>
              <%=actualFinishTime%>
              <%}%>
      </logic:present>
  <% } %>
				...
				<tr align="center">
					<td>
						...
						<tr align="center" class="itemizedservicecharthead">
							...
							<td>
                                <app:storeMessage key="userWorkOrder.text.note.modDate"/>
							</td>
							<td>
                            ...
                            <%
                                ...
                                if (RefCodeNames.STATUS_CD.ACTIVE.equals(itemizedServiceLine.getStatusCd())) { %>
                                    <tr align="center" style="background-color: <%=bgColor%>">
                                        ...
                                        <td>
                                            <%=sdFormat.format(itemizedServiceLine.getModDate())%><br>
											<%=itemizedServiceLine.getModBy()%>
                                        </td>
                                        <td>
                                            <% if (editingAuthorized || isSendToProviderStatus) { %>
								...
								<% } else if (RefCodeNames.STATUS_CD.DELETED.equals(itemizedServiceLine.getStatusCd())) { %>
									<tr align="center"  style="background-color: <%=bgColor%>">
                                        <td>
                                            <% if (previousLineNum != currentLineNum) {%>
                                                <bean:write name="itemizedServiceLine" property="lineNum"/>
                                        ...
                                        <td>
                                            <%=sdFormat.format(itemizedServiceLine.getModDate())%>
                                        </td>

										<td style="background-color: yellow"><b>D</b></td>
...
<TR>
    <td colspan="5" align="center">
        <table>
            <tr>
                <td>
                    <% if (workOrderStatus.equals(RefCodeNames.WORK_ORDER_STATUS_CD.NEW_REQUEST) ||
                           workOrderStatus.equals(RefCodeNames.WORK_ORDER_STATUS_CD.SENT_TO_PROVIDER) ||
                           workOrderStatus.equals(RefCodeNames.WORK_ORDER_STATUS_CD.ACCEPTED_BY_PROVIDER) ||
                           isWorkOrderApprover) { %>
	                    <html:button property="action" styleClass="store_fb" onclick="actionSubmit('0','save');">
	                        <app:storeMessage key="global.action.label.save"/>
	                    </html:button>
                    <% }
                    if (workOrderStatus.equals(RefCodeNames.WORK_ORDER_STATUS_CD.SENT_TO_PROVIDER) ||
                        workOrderStatus.equals(RefCodeNames.WORK_ORDER_STATUS_CD.ACCEPTED_BY_PROVIDER) ||
                        workOrderStatus.equals(RefCodeNames.WORK_ORDER_STATUS_CD.CANCELLED) ||
                        workOrderStatus.equals(RefCodeNames.WORK_ORDER_STATUS_CD.REJECTED_BY_PROVIDER) ||
                        workOrderStatus.equals(RefCodeNames.WORK_ORDER_STATUS_CD.COMPLETED) ||
                        workOrderStatus.equals(RefCodeNames.WORK_ORDER_STATUS_CD.CLOSED)) { %>
	                    <logic:greaterThan name="woid" value="0">
                            <html:button property="action" styleClass="store_fb" onclick="actionSubmit('0','copy');">
        	                    <app:storeMessage key="global.label.workOrderCopy"/>
        	                </html:button>
                        </logic:greaterThan>
                    <% } %>
                </td>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td rowspan="2">
                                    &nbsp;
                                    <b><app:storeMessage key="userWorkOrder.text.sendToProvider"/></b>
                                    &nbsp;
                                </td>
                                <td>
                                    <html:radio name="USER_WORK_ORDER_DETAIL_MGR_FORM"
                                                property="providerTradingType"
                                                value="<%=UserWorkOrderDetailMgrForm.EMAIL%>"/>
                                    <app:storeMessage key="userWorkOrder.text.email"/>
                                    <app:authorizedForFunction name="<%=RefCodeNames.APPLICATION_FUNCTIONS.WORK_ORDER_APPROVER%>">
                                        <% if (isWOworkflowConfigured) { %>
                                            <html:checkbox name="USER_WORK_ORDER_DETAIL_MGR_FORM" property="workflowProcessing" value="<%=Boolean.toString(true)%>"/>
                                            <app:storeMessage key="userWorkOrder.text.turnOnWorkflow"/>
                                        <% } %>
                                    </app:authorizedForFunction>
                                </td>
                                <td rowspan="2"> 
                                    <html:button property="action"
                                                 styleClass="store_fb"
                                                 onclick="actionSubmit('0','sendPdfToProvider');">

                                        <logic:notEqual name="USER_WORK_ORDER_DETAIL_MGR_FORM"
                                                        property="statusCd"
                                                        value="<%=RefCodeNames.WORK_ORDER_STATUS_CD.PENDING_APPROVAL%>">
                                            <app:storeMessage key="global.action.label.send"/>
                                        </logic:notEqual>
                                        <logic:equal name="USER_WORK_ORDER_DETAIL_MGR_FORM"
                                                        property="statusCd"
                                                        value="<%=RefCodeNames.WORK_ORDER_STATUS_CD.PENDING_APPROVAL%>">
                                            <app:storeMessage key="global.label.approveAndSend"/>
                                        </logic:equal>
                                    </html:button>
                                </td>
                            </tr>
