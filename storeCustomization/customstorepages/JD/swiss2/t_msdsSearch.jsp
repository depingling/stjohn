...
<table align="right" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td>&nbsp;</td>
    <html:hidden name="MSDS_FORM" property="docType" value="SPEC"/>
    <!--
    <td class="smalltext" colspan="2">
      <html:radio name="MSDS_FORM" property="docType" value="MSDS"/><b><app:storeMessage key="shop.msdsSpecs.text.msds"/></b>&nbsp;&nbsp;
      <html:radio name="MSDS_FORM" property="docType" value="SPEC"/><b><app:storeMessage key="shop.msdsSpecs.text.specs"/></b>&nbsp;&nbsp;
      <html:radio name="MSDS_FORM" property="docType" value="DED"/><b><app:storeMessage key="shop.msdsSpecs.text.disinfectantEfficacy"/></b>
    </td>
-->
  </tr>
  <tr>
