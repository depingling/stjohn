...
<jsp:include flush='true' page="<%=t_templatorToolBar%>" >
   ...
   <jsp:param name="display02"  value="f_educatorController"/>
   <jsp:param name="toolLable02" value="shop.menu.productSelector"/>
   <jsp:param name="toolSecondaryToolBar02" value=""/>

   <jsp:param name="toolLink03"  value=""/>
   <jsp:param name="tabs03"  value=""/>
   <jsp:param name="display03"  value=""/>
   <jsp:param name="toolLable03" value=""/>
   <jsp:param name="toolSecondaryToolBar03" value=""/>

   <jsp:param name="toolLink04"  value=""/>
   <jsp:param name="tabs04"  value=""/>
   <jsp:param name="display04"  value=""/>
   <jsp:param name="toolLable04" value=""/>
